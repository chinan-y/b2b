$(function(){
	...
	$("[nc_type='followbtn']").live('click',function(){
        ...
        $.getJSON('index.php?gct=member_snsfriend&gp=addfollow&mid='+data_str.mid, function(data){
        	if(data){
	...
	$("[nc_type='cancelbtn']").live('click',function(){
		var data_str = $(this).attr('data-param');
        eval( "data_str = "+data_str);
        $.getJSON('index.php?gct=member_snsfriend&gp=delfollow&mid='+data_str.mid, function(data){
        	if(data){
	...
	$('*[nctype="batchFollow"]').live('click', function(){
		...
		ajax_get_confirm('','index.php?gct=member_snsfriend&gp=batch_addfollow&ids='+data_str.ids);
	});
});