(function($) {
					...
					Timepicker.prototype,
					{
						...
						_parseTime : function(e, t) {
							...
							if (t || !this._defaults.timeOnly) {
								var i = $.datepicker._get(this.inst,
										"dateFormat");
								try {
						...
						_injectTimePicker : function() {
							...
							if (e.find("div.ui-timepicker-div").length === 0
									&& t.showTimepicker) {
								var m = ' style="display:none;"', d = '<div class="ui-timepicker-div'
								...
								for (c = 0, u = this.units.length; c < u; c++) {
									s = this.units[c];
									a = s.substr(0, 1).toUpperCase()
											+ s.substr(1);
									n = t["show" + a] !== null ? t["show" + a]
											: this.support[s];
									r[s] = parseInt(t[s + "Max"]
											- (t[s + "Max"] - t[s + "Min"])
											% t["step" + a], 10);
									l[s] = 0;
									d += '<dt class="ui_tpicker_' + s
											+ '_label"' + (n ? "" : m) + ">"
											+ t[s + "Text"] + "</dt>"
											+ '<dd class="ui_tpicker_' + s
											+ '"><div class="ui_tpicker_' + s
											+ '_slider"' + (n ? "" : m)
											+ "></div>";
									if (n && t[s + "Grid"] > 0) {
										d += '<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>';
										if (s === "hour") {
											for (var f = t[s + "Min"]; f <= r[s]; f += parseInt(
													t[s + "Grid"], 10)) {
												l[s]++;
												var p = $.datepicker
														.formatTime(
											...
											for (var h = t[s + "Min"]; h <= r[s]; h += parseInt(
													t[s + "Grid"], 10)) {
												l[s]++;
												d += '<td data-for="' + s
														+ '">'
								...
								var _ = t.showTimezone !== null ? t.showTimezone
										: this.support.timezone;
								d += '<dt class="ui_tpicker_timezone_label"'
										+ (_ ? "" : m) + ">" + t.timezoneText
										+ "</dt>";
								d += '<dd class="ui_tpicker_timezone" '
										+ (_ ? "" : m) + "></dd>";
								d += "</dl></div>";
								var g = $(d);
								if (t.timeOnly === true) {
								...
								for (c = 0, u = i.units.length; c < u; c++) {
									s = i.units[c];
									a = s.substr(0, 1).toUpperCase()
											+ s.substr(1);
									n = t["show" + a] !== null ? t["show" + a]
											: this.support[s];
									i[s + "_slider"] = i.control.create(i, g
											.find(".ui_tpicker_" + s
													+ "_slider"), s, i[s], t[s
											+ "Min"], r[s], t["step" + a]);
									if (n && t[s + "Grid"] > 0) {
								...
								i._limitMinMaxDateTime(this.inst, true)
							}
						},
						_limitMinMaxDateTime : function(e, t) {
							var i = this._defaults, s = new Date(
							...
							if ($.datepicker._get(e, "minDateTime") !== null
									...
									&& s) {
								var a = $.datepicker._get(e, "minDateTime"), n = new Date(
										a.getFullYear(), a.getMonth(), a
												.getDate(), 0, 0, 0, 0);
								...
								if (e.settings.timeOnly
									...
									if (this.hour <= this._defaults.hourMin) {
										...
										this._defaults.minuteMin = a
												.getMinutes();
										if (this.minute <= this._defaults.minuteMin) {
											this.minute = this._defaults.minuteMin;
											this._defaults.secondMin = a
													.getSeconds();
											if (this.second <= this._defaults.secondMin) {
												this.second = this._defaults.secondMin;
												this._defaults.millisecMin = a
														.getMilliseconds();
												if (this.millisec <= this._defaults.millisecMin) {
													this.millisec = this._defaults.millisecMin;
													this._defaults.microsecMin = a
															.getMicroseconds()
												} else {
							...
							if ($.datepicker._get(e, "maxDateTime") !== null
									...
									&& s) {
								var r = $.datepicker._get(e, "maxDateTime"), l = new Date(
										r.getFullYear(), r.getMonth(), r
												.getDate(), 0, 0, 0, 0);
								...
								if (e.settings.timeOnly
									...
									if (this.hour >= this._defaults.hourMax) {
										...
										this._defaults.minuteMax = r
												.getMinutes();
										if (this.minute >= this._defaults.minuteMax) {
											this.minute = this._defaults.minuteMax;
											this._defaults.secondMax = r
													.getSeconds();
											if (this.second >= this._defaults.secondMax) {
												this.second = this._defaults.secondMax;
												this._defaults.millisecMax = r
														.getMilliseconds();
												if (this.millisec >= this._defaults.millisecMax) {
													this.millisec = this._defaults.millisecMax;
													this._defaults.microsecMax = r
															.getMicroseconds()
												} else {
							...
							if (t !== undefined && t === true) {
								var o = parseInt(
										this._defaults.hourMax
												...
												% this._defaults.stepHour, 10), c = parseInt(
										this._defaults.minuteMax
												- (this._defaults.minuteMax - this._defaults.minuteMin)
												% this._defaults.stepMinute, 10), u = parseInt(
						...
						_onTimeChange : function() {
							...
							var e = this.hour_slider ? this.control.value(this,
									this.hour_slider, "hour") : false, t = this.minute_slider ? this.control
									.value(this, this.minute_slider, "minute")
									: false, i = this.second_slider ? this.control
									.value(this, this.second_slider, "second")
									: false, s = this.millisec_slider ? this.control
									.value(this, this.millisec_slider,
											"millisec")
									: false, a = this.microsec_slider ? this.control
									.value(this, this.microsec_slider,
											"microsec")
									: false, n = this.timezone_select ? this.timezone_select
									.val()
									: false, r = this._defaults, l = r.pickerTimeFormat
							...
							var c = r[e < 12 ? "amNames" : "pmNames"][0];
							var u = e !== this.hour
									|| t !== this.minute
									|| i !== this.second
									|| s !== this.millisec
						...
						_updateDateTime : function(e) {
							e = this.inst || e;
							var t = e.currentYear > 0 ? new Date(e.currentYear,
									e.currentMonth, e.currentDay) : new Date(
									e.selectedYear, e.selectedMonth,
									e.selectedDay), i = $.datepicker
									._daylightSavingAdjust(t), s = $.datepicker
									._get(e, "dateFormat"), a = $.datepicker
									._getFormatConfig(e), n = i !== null
									&& this.timeDefined;
							this.formattedDate = $.datepicker.formatDate(s,
									i === null ? new Date : i, a);
							...
							if (!this._defaults.showTimepicker) {
								...
								this.$input.val(r);
								var l = "", o = this._defaults.altSeparator ? this._defaults.altSeparator
										: this._defaults.separator, c = this._defaults.altTimeSuffix ? this._defaults.altTimeSuffix
										: this._defaults.timeSuffix;
								if (!this._defaults.timeOnly) {
									if (this._defaults.altFormat) {
										l = $.datepicker.formatDate(
								...
								if (this._defaults.altTimeFormat) {
									l += $.datepicker.formatTime(
											this._defaults.altTimeFormat, this,
											this._defaults)
											+ c
								} else {
									l += this.formattedTime + c
								}
								this.$altInput.val(l)
							} else {
								this.$input.val(r)
						...
						_controls : {
							slider : {
								...
								options : function(e, t, i, s, a) {
									if (e._defaults.isRTL) {
										if (typeof s === "string") {
											if (s === "min" || s === "max") {
												if (a !== undefined) {
													return t.slider(s, a * -1)
												}
												return Math.abs(t.slider(s))
											}
											return t.slider(s)
										}
										var n = s.min, r = s.max;
								...
								value : function(e, t, i, s) {
									if (e._defaults.isRTL) {
										if (s !== undefined) {
											return t.slider("value", s * -1)
										}
										return Math.abs(t.slider("value"))
									}
									if (s !== undefined) {
										return t.slider("value", s)
									}
							...
							select : {
								create : function(e, t, i, s, a, n, r) {
									var l = '<select class="ui-timepicker-select" data-unit="'
											+ i
											+ '" data-min="'
											+ a
											+ '" data-max="'
											+ n
											+ '" data-step="' + r + '">', o = e._defaults.pickerTimeFormat
									...
									$(l).appendTo(t).change(function(t) {
										e._onTimeChange();
										e._onSelectHandler()
									});
									return t
								...
								options : function(e, t, i, s, a) {
									...
									return e.control.create(e, t, r
											.data("unit"), r.val(), n.min
											|| r.data("min"), n.max
											|| r.data("max"), n.step
											|| r.data("step"))
								},
	...
	$.datepicker.parseTime = function(e, t, i) {
		var s = extendRemove(extendRemove({}, $.timepicker._defaults), i || {}), a = e
		...
		var n = function(e, t, i) {
			...
			var a = function(e) {
				var t = e.toLowerCase().match(
						/(h{1,2}|m{1,2}|s{1,2}|l{1}|c{1}|t{1,2}|z|'.*?')/g), i = {
					h : -1,
					m : -1,
					s : -1,
					l : -1,
			...
			if (o) {
				if (r.t !== -1) {
					if (o[r.t] === undefined || o[r.t].length === 0) {
						l = "";
						c.ampm = ""
					} else {
						l = $.inArray(o[r.t].toUpperCase(), i.amNames) !== -1 ? "AM"
								: "PM";
						c.ampm = i[l === "AM" ? "amNames" : "pmNames"][0]
					}
				}
				if (r.h !== -1) {
					if (l === "AM" && o[r.h] === "12") {
				...
				if (r.m !== -1) {
					c.minute = Number(o[r.m])
				}
				if (r.s !== -1) {
					c.second = Number(o[r.s])
				}
				if (r.l !== -1) {
					c.millisec = Number(o[r.l])
				}
				if (r.c !== -1) {
					c.microsec = Number(o[r.c])
				}
				if (r.z !== -1 && o[r.z] !== undefined) {
					c.timezone = $.timepicker.timezoneOffsetNumber(o[r.z])
				}
				return c
			}
			return false
	...
	$.datepicker.formatTime = function(e, t, i) {
		...
		s = s.replace(/(?:HH?|hh?|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,
				function(e) {
					switch (e) {
					case "HH":
						return ("0" + n).slice(-2);
					...
					case "z":
						return $.timepicker.timezoneOffsetString(
								t.timezone === null ? i.timezone : t.timezone,
								false);
					case "Z":
						return $.timepicker.timezoneOffsetString(
								t.timezone === null ? i.timezone : t.timezone,
	...
	$.datepicker._selectDate = function(e, t) {
		...
		if (s) {
			s._limitMinMaxDateTime(i, true);
			i.inline = i.stay_open = true;
			this._base_selectDate(e, t);
			i.inline = i.stay_open = false;
	...
	$.datepicker._doKeyPress = function(e) {
		var t = $.datepicker._getInst(e.target), i = $.datepicker._get(t,
				"timepicker");
		if (i) {
			if ($.datepicker._get(t, "constrainInput")) {
				var s = i.support.ampm, a = i._defaults.showTimezone !== null ? i._defaults.showTimezone
						: i.support.timezone, n = $.datepicker
						._possibleChars($.datepicker._get(t, "dateFormat")), r = i._defaults.timeFormat
						.toString().replace(/[hms]/g, "").replace(/TT/g,
								s ? "APM" : "").replace(/Tt/g,
								s ? "AaPpMm" : "").replace(/tT/g,
								s ? "AaPpMm" : "").replace(/T/g, s ? "AP" : "")
						.replace(/tt/g, s ? "apm" : "").replace(/t/g,
								s ? "ap" : "")
						+ " "
						...
						+ i._defaults.pmNames.join("") + n, l = String
	...
	$.datepicker._updateAlternate = function(e) {
		...
		if (t) {
			...
			if (i) {
				var s = t._defaults.altFormat || t._defaults.dateFormat, a = this
						._getDate(e), n = $.datepicker._getFormatConfig(e), r = "", l = t._defaults.altSeparator ? t._defaults.altSeparator
						: t._defaults.separator, o = t._defaults.altTimeSuffix ? t._defaults.altTimeSuffix
						: t._defaults.timeSuffix, c = t._defaults.altTimeFormat !== null ? t._defaults.altTimeFormat
						: t._defaults.timeFormat;
				r += $.datepicker.formatTime(c, t, t._defaults) + o;
				if (!t._defaults.timeOnly && !t._defaults.altFieldTimeOnly
						&& a !== null) {
					if (t._defaults.altFormat) {
						r = $.datepicker
								.formatDate(t._defaults.altFormat, a, n)
								+ l + r
					} else {
						r = t.formattedDate + l + r
					}
				}
				$(i).val(r)
			}
	...
	$.datepicker._doKeyUp = function(e) {
		var t = $.datepicker._getInst(e.target), i = $.datepicker._get(t,
				"timepicker");
		if (i) {
			if (i._defaults.timeOnly && t.input.val() !== t.lastVal) {
				try {
	...
	$.datepicker._disableTimepickerDatepicker = function(e) {
		...
		if (i) {
			t.settings.showTimepicker = false;
	...
	$.datepicker._enableTimepickerDatepicker = function(e) {
		...
		$(e).datepicker("getDate");
		if (i) {
			t.settings.showTimepicker = true;
	...
	$.datepicker._setDateDatepicker = function(e, t) {
		...
		if (s) {
			if (!s.support.timezone && s._defaults.timezone === null) {
				s.timezone = a.getTimezoneOffset() * -1
			}
			t = $.timepicker.timezoneAdjust(t, s.timezone);
			a = $.timepicker.timezoneAdjust(a, s.timezone)
		}
		this._updateDatepicker(i);
		this._base_setDateDatepicker.apply(this, arguments);
		this._setTimeDatepicker(e, a, true)
	};
	...
	$.datepicker._getDateDatepicker = function(e, t) {
		...
		var s = this._get(i, "timepicker");
		if (s) {
			if (i.lastVal === undefined) {
				this._setDateFromField(i, t)
			}
			var a = this._getDate(i);
			if (a && s._parseTime($(e).val(), s.timeOnly)) {
	...
	$.datepicker.parseDate = function(e, t, i) {
		...
		try {
			...
			if (a.indexOf(":") >= 0) {
				s = this._base_parseDate(e, t.substring(0, t.length
						- (a.length - a.indexOf(":") - 2)), i);
	...
	$.datepicker._optionDatepicker = function(e, t, i) {
		var s = this._getInst(e), a;
		if (!s) {
			return null
		}
		var n = this._get(s, "timepicker");
		if (n) {
			var r = null, l = null, o = null, c = n._defaults.evnts, u = {}, m;
			if (typeof t === "string") {
			...
			if (r) {
				...
				n._defaults.minDate = r;
				n._defaults.minDateTime = r
			} else if (l) {
				if (l === 0) {
					l = new Date
				} else {
				...
				n._defaults.maxDate = l;
				n._defaults.maxDateTime = l
			} else if (o) {
				n._defaults.onSelect = o
			}
		}
		if (i === undefined) {
			return this._base_optionDatepicker.call($.datepicker, e, t)
		}
		return this._base_optionDatepicker.call($.datepicker, e, a || t, i)
	};
	...
	var computeEffectiveSetting = function(e, t) {
		return e && e[t] ? e[t] : $.timepicker._defaults[t]
	};
	var splitDateTime = function(e, t) {
		var i = computeEffectiveSetting(t, "separator"), s = computeEffectiveSetting(
				t, "timeFormat"), a = s.split(i), n = a.length, r = e.split(i), l = r.length;
		if (l > 1) {
			return {
	...
	var parseDateTimeInternal = function(e, t, i, s, a) {
		var n, r, l;
		r = splitDateTime(i, a);
		...
		l = $.datepicker.parseTime(t, r.timeString, a);
		if (!l) {
	...
	$.timepicker.timezoneOffsetString = function(e, t) {
		if (isNaN(e) || e > 840 || e < -720) {
			return e
		}
		var i = e, s = i % 60, a = (i - s) / 60, n = t ? ":" : "", r = (i >= 0 ? "+"
				: "-")
	...
	$.timepicker.timezoneOffsetNumber = function(e) {
		...
		return (t.substr(0, 1) === "-" ? -1 : 1)
				* (parseInt(t.substr(1, 2), 10) * 60 + parseInt(t.substr(3, 2),
						10))
	};
	$.timepicker.timezoneAdjust = function(e, t) {
		var i = $.timepicker.timezoneOffsetNumber(t);
		if (!isNaN(i)) {
			e.setMinutes(e.getMinutes() + -e.getTimezoneOffset() - i)
		}
		return e
	};
	...
	$.timepicker.handleRange = function(e, t, i, s) {
		...
		function a(a, n) {
			...
			if (r !== null) {
				...
				if (s.minInterval > 0 && c > l) {
					i[e]("setDate", c)
				} else if (s.maxInterval > 0 && u < l) {
					i[e]("setDate", u)
				} else if (r > l) {
					n[e]("setDate", o)
				}
