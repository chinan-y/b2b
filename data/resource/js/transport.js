$(function(){
	...
	TransTpl += "默认运费：\n";
	TransTpl += "<input class=\"w30 mr5 text\" type=\"text\" aria-label=\"默认运费件/重数\" maxlength=\"4\" autocomplete=\"off\" data-field=\"start\" value=\"1\" name=\"default[TRANSTYPE][start]\">\n";
	TransTpl += "件/重内，\n";
	...
	TransTpl += "<\/em>， 每增加\n";
	TransTpl += "<input class=\"w30 ml5 mr5 text\" type=\"text\" aria-label=\"每加件/重\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"plus\" name=\"default[TRANSTYPE][plus]\">\n";
	TransTpl += "件/重， 增加运费\n";
	TransTpl += "<input class=\"w50 ml5 text\" type=\"text\" aria-label=\"加件/重运费\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postageplus\" name=\"default[TRANSTYPE][postageplus]\">";
	TransTpl += "<em class=\"add-on\">";
	TransTpl += "<i class=\"icon-renminbi\"><\/i>";
	TransTpl += "<\/em>\n";
	...
	SpecialMessage += "<span  error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>首件/重应输入1至9999的数字<\/span>\n";
	...
	SpecialMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>续件/重应输入1至9999的数字<\/span>\n";
	...
	DefaultMessage = '';
	DefaultMessage += "<span error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>首件/重应输入1至9999的数字<\/span>\n";
	...
	DefaultMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>续件/重应输入1至9999的数字<\/span>\n";
	...
	RuleHead += "<tr>\n";
	RuleHead += "<th>运送到<\/th>\n";
	RuleHead += "<th class=\"w60\">首件/重<\/th>\n";
	RuleHead += "<th class=\"w110\">首费(元)<\/th>\n";
	RuleHead += "<th class=\"w60\">续件/重<\/th>\n";
...
//	RuleCell += "<a class=\"ncu-btn2\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">编辑<\/a>\n";
	...
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w30\" type=\"text\" aria-label=\"首件/重\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"start\" name=\"special[TRANSTYPE][CurNum][start]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	...
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w30\" type=\"text\" aria-label=\"续件/重\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"plus\" name=\"special[TRANSTYPE][CurNum][plus]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
...
/*	市级地区单事件/重*/
	$('#dialog_areas').on('click','.J_City',function(){
		...
		//如果市级地区全部选中，则父级省份也选中，反之有一个/500g不选中,则省份和大区域也不选中
		if (!$(this).attr('checked')){
			//取消省份选择
...
//    			curTransType = $(this).parent().prev().find('input[type="hidden"]').eq(0).attr('name').substring(6,8);
	...
	$('#submit_tpl').on('click',function(){
		...
		isSubmit = true;	
		//首件/重跟续件/重由于有默认值，鼠标离开也有默认值，这里只需判断首费与续费即可
