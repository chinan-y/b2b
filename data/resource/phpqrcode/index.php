...
class PhpQRCode{
    ...
    public function init(){
	    ...
	    if ($this->date != 'gcwebshop') { 
	        ...
	        QRcode::png($this->date, $filename, $this->errorCorrectionLevel, $this->matrixPointSize, 3);    
	        
	    } else {    
	    
	        //default data
	        QRcode::png('http://www.qqbsmall.com', $filename, $this->errorCorrectionLevel, $this->matrixPointSize, 3);    
