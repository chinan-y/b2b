...
<div class="home-standard-layout index-width style-<?php echo $output['style_name'];?>">
  <div class="left-sidebar">
    <div class="title">
      	...
      	<?php }else { ?>
      	<div class="pic-type"><img src="<?php echo UPLOAD_SITE_URL.DS.$output['code_tit']['code_info']['pic'];?>"/></div>
      	<?php } ?>
    </div>
	...
	<div class="left-ads1">
    	<?php if(!empty($output['code_act']['code_info']['pic'])) { ?>
      	...
      	<img src="<?php  echo UPLOAD_SITE_URL.DS.$output['code_act']['code_info']['pic'];?>" alt="<?php echo $output['code_act']['code_info']['title']; ?>" />
      	</a>
      	<?php } ?>
    </div>
	<?php } ?>
                                    ...
                                    <?php foreach($val['goods_list'] as $k => $v){ ?>
                                      <li>
                                        <dl>
                                          ...
                                          <dd class="goods-price"><span class="original"><?php echo ncPriceFormatForList($v['market_price']); ?></span><em><?php echo ncPriceFormatForList($v['goods_price']); ?></em>
                                            </dd>
                                        </dl>
                                      </li>
                                    <?php } ?>
