...
class snstraceControl extends SystemControl{
	...
	public function tracedelOp(){
		$tid = $_POST['t_id'];
		if(empty($tid)){
			showMessage(Language::get('admin_snstrace_pleasechoose_del'),'index.php?gct=snstrace&gp=tracelist','','error');
		}
		$tid_str = implode("','",$tid);
		//删除动态
		$tracelog_model = Model('sns_tracelog');
		...
		if($result){
			...
			showMessage(Language::get('nc_common_del_succ'),'index.php?gct=snstrace&gp=tracelist','','succ');
		}else{
			showMessage(Language::get('nc_common_del_fail'),'index.php?gct=snstrace&gp=tracelist','','error');
		}
	}
	...
	public function traceeditOp(){
		$tid = $_POST['t_id'];
		if(empty($tid)){
			showMessage(Language::get('admin_snstrace_pleasechoose_edit'),'index.php?gct=snstrace&gp=tracelist','','error');
		}
		$tid_str = implode("','",$tid);
		$type = $_GET['type'];
		//删除动态
		...
		if($result){
			...
			showMessage(Language::get('nc_common_op_succ'),'index.php?gct=snstrace&gp=tracelist','','succ');
		}else{
			showMessage(Language::get('nc_common_op_fail'),'index.php?gct=snstrace&gp=tracelist','','error');
		}
	}
	...
	public function commentdelOp(){
		$cid = $_POST['c_id'];
		if(empty($cid)){
			showMessage(Language::get('admin_snstrace_pleasechoose_del'),'index.php?gct=snstrace&gp=commentlist','','error');
		}
		$cid_str = implode("','",$cid);
		//删除评论
		$comment_model = Model('sns_comment');
		...
		if($result){
			...
			showMessage(Language::get('nc_common_del_succ'),'index.php?gct=snstrace&gp=commentlist','','succ');
		}else{
			showMessage(Language::get('nc_common_del_fail'),'index.php?gct=snstrace&gp=commentlist','','error');
		}
	}
	...
	public function commenteditOp(){
		$cid = $_POST['c_id'];
		if(empty($cid)){
			showMessage(Language::get('admin_snstrace_pleasechoose_edit'),'index.php?gct=snstrace&gp=commentlist','','error');
		}
		$cid_str = implode("','",$cid);
		$type = $_GET['type'];
		//删除动态
		...
		if($result){
			...
			showMessage(Language::get('nc_common_op_succ'),'index.php?gct=snstrace&gp=commentlist','','succ');
		}else{
			showMessage(Language::get('nc_common_op_fail'),'index.php?gct=snstrace&gp=commentlist','','error');
		}
	}
}
?>
