	...
	public function pic_uploadOp(){
		if (chksubmit()){
			...
			if(C('OSS_IS_STORAGE') == 1){
				...
				$newname	= 'br_' . date('YmdHis') . rand(0,9999) . '.' . $extend;
