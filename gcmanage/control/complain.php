...
class complainControl extends SystemControl {
     ...
     * 获取投诉列表
     */
    private function get_complain_list($complain_state,$gp) {
        $page = new Page();
        $page->setEachNum(10) ;
        $page->setStyle('admin') ;
    ...
    public function complain_verifyOp() {
        ...
        if(intval($complain_info['complain_state']) === self::STATE_NEW) {
            ...
            if($model_complain->updateComplain($update_array,$where_array)) {
                ...
                showMessage(Language::get('complain_verify_success'),'index.php?gct=complain&gp=complain_new_list');
            } else {
                showMessage(Language::get('complain_verify_fail'),'index.php?gct=complain&gp=complain_new_list');
            }
        } else {
    ...
    public function complain_subject_saveOp() {
        ...
        if ($error != '') {
            ...
            showMessage(Language::get('complain_subject_add_success'),'index.php?gct=complain&gp=complain_subject_list');
        }
    }
    ...
    public function complain_subject_dropOp() {
        ...
        if(empty($complain_subject_id)) {
            showMessage(Language::get('param_error'),'index.php?gct=complain');
        }
        $model_complain_subject= Model('complain_subject');
        $update_array = array();
        ...
        if($model_complain_subject->updateComplainSubject($update_array,$where_array)) {
            ...
            showMessage(Language::get('complain_subject_delete_success'),'index.php?gct=complain&gp=complain_subject_list');
        } else {
            showMessage(Language::get('complain_subject_delete_fail'),'index.php?gct=complain&gp=complain_subject_list');
        }
    }
    ...
    private function get_complain_state_link($complain_state) {
        switch(intval($complain_state)) {
            case self::STATE_NEW:
                return 'index.php?gct=complain&gp=complain_new_list';
                break;
            case self::STATE_APPEAL:
                return 'index.php?gct=complain&gp=complain_appeal_list';
                break;
            case self::STATE_TALK:
                return 'index.php?gct=complain&gp=complain_talk_list';
                break;
            case self::STATE_HANDLE:
                return 'index.php?gct=complain&gp=complain_handle_list';
                break;
            case self::STATE_FINISH:
                return 'index.php?gct=complain&gp=complain_finish_list';
                break;
            default:
                showMessage(Language::get('param_error'));
        }
	...
	private function show_menu($menu_key) {
		$menu_array = array(
			'complain_new_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_new_list'),'menu_url'=>'index.php?gct=complain&gp=complain_new_list'),
			'complain_appeal_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_appeal_list'),'menu_url'=>'index.php?gct=complain&gp=complain_appeal_list'),
			'complain_talk_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_talk_list'),'menu_url'=>'index.php?gct=complain&gp=complain_talk_list'),
			'complain_handle_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_handle_list'),'menu_url'=>'index.php?gct=complain&gp=complain_handle_list'),
			'complain_finish_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_finish_list'),'menu_url'=>'index.php?gct=complain&gp=complain_finish_list'),
			'complain_subject_list'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_subject_list'),'menu_url'=>'index.php?gct=complain&gp=complain_subject_list'),
			'complain_subject_add'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_subject_add'),'menu_url'=>'index.php?gct=complain&gp=complain_subject_add'),
			'complain_setting'=>array('menu_type'=>'link','menu_name'=>Language::get('complain_setting'),'menu_url'=>'index.php?gct=complain&gp=complain_setting'),
