...
class stat_tradeControl extends SystemControl{
	private $links = array(
        array('url'=>'gct=stat_trade&gp=income','lang'=>'stat_sale_income'),
        array('url'=>'gct=stat_trade&gp=predeposit','lang'=>'stat_predeposit'),
        array('url'=>'gct=stat_trade&gp=sale','lang'=>'stat_sale')
    );
    ...
    public function predepositOp(){
		...
		if($_REQUEST['search_type'] == 'day'){
			...
			Tpl::output('actionurl','index.php?gct=stat_trade&gp=predeposit&search_type=day&search_time='.date('Y-m-d',$search_time));
		}
		...
		if($_REQUEST['search_type'] == 'week'){
			...
			Tpl::output('actionurl','index.php?gct=stat_trade&gp=predeposit&search_type=week&search_time_year='.$current_year.'&search_time_month='.$current_month.'&search_time_week='.$current_week);
		}
		...
		if($_REQUEST['search_type'] == 'month'){
			...
			Tpl::output('actionurl','index.php?gct=stat_trade&gp=predeposit&search_type=month&search_time_year='.$current_year.'&search_time_month='.$current_month);
		}
