...
class informControl extends SystemControl{
     ...
     * 获取举报列表
     */
    private function get_inform_list($type,$template,$gp){
    ...
    public function inform_subject_type_saveOp(){
        ...
        if ($error != ''){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?gct=inform&gp=inform_subject_type_list');
        }
    }
    ...
    public function inform_subject_type_dropOp(){
        ...
        if(empty($inform_type_id)) {
            showMessage(Language::get('param_error'),'index.php?gct=inform');
        }
        ...
        showMessage(Language::get('nc_common_del_succ'),'index.php?gct=inform&gp=inform_subject_type_list');
    ...
    public function inform_subject_saveOp(){
        ...
        if ($error != ''){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?gct=inform&gp=inform_subject_list');
        }
    }
    ...
    public function inform_subject_dropOp(){
        ...
        showMessage(Language::get('nc_common_del_succ'),'index.php?gct=inform&gp=inform_subject_list');
    }
    ...
    public function inform_handleOp(){
        ...
        if($model_inform->updateInform($update_array,$where_array)) {
            ...
            showMessage(Language::get('nc_common_op_succ'),'index.php?gct=inform&gp=inform_list');
        }
        else {
	...
	private function show_menu($menu_key) {
		$menu_array = array(
			'inform_list'=>array('menu_type'=>'link','menu_name'=>Language::get('inform_state_unhandle'),'menu_url'=>'index.php?gct=inform&gp=inform_list'),
			'inform_handled_list'=>array('menu_type'=>'link','menu_name'=>Language::get('inform_state_handled'),'menu_url'=>'index.php?gct=inform&gp=inform_handled_list'),
			'inform_subject_type_list'=>array('menu_type'=>'link','menu_name'=>Language::get('inform_type'),'menu_url'=>'index.php?gct=inform&gp=inform_subject_type_list'),
			'inform_subject_type_add'=>array('menu_type'=>'link','menu_name'=>Language::get('inform_type_add'),'menu_url'=>'index.php?gct=inform&gp=inform_subject_type_add'),
			'inform_subject_list'=>array('menu_type'=>'link','menu_name'=>Language::get('inform_subject'),'menu_url'=>'index.php?gct=inform&gp=inform_subject_list'),
			'inform_subject_add'=>array('menu_type'=>'link','menu_name'=>Language::get('inform_subject_add'),'menu_url'=>'index.php?gct=inform&gp=inform_subject_add'),
		);
