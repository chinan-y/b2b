...
class help_storeControl extends SystemControl{
	...
	public function add_helpOp() {
		...
		if (chksubmit()) {
			...
			if ($state) {
				...
				showMessage(Language::get('nc_common_save_succ'),'index.php?gct=help_store&gp=help_store');
			} else {
	...
	public function del_helpOp() {
		...
		if ($state) {
		    ...
		    showMessage(Language::get('nc_common_del_succ'),'index.php?gct=help_store&gp=help_store');
		} else {
	...
	public function add_typeOp() {
		...
		if (chksubmit()) {
			...
			if ($state) {
				...
				showMessage(Language::get('nc_common_save_succ'),'index.php?gct=help_store&gp=help_type');
			} else {
				showMessage(Language::get('nc_common_save_fail'));
			}
		}
	...
	public function del_typeOp() {
		...
		if ($state) {
		    ...
		    showMessage(Language::get('nc_common_del_succ'),'index.php?gct=help_store&gp=help_type');
		} else {
		    showMessage(Language::get('nc_common_del_fail'));
		}
	}
