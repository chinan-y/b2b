...
class cms_navigationControl extends SystemControl{
    ...
    public function cms_navigation_saveOp() {
        ...
        if($result) {
            ...
            showMessage(Language::get('navigation_add_success'),'index.php?gct=cms_navigation&gp=cms_navigation_list');
        } else {
            $this->log(Language::get('cms_log_navigation_save').$result, 0);
            showMessage(Language::get('navigation_add_fail'),'index.php?gct=cms_navigation&gp=cms_navigation_list','','error');
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_list'),'menu_url'=>'index.php?gct=cms_navigation&gp=cms_navigation_list'),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?gct=cms_navigation&gp=cms_navigation_add'),
        );
