...
class stat_generalControl extends SystemControl{
    private $links = array(
        array('url'=>'gct=stat_general&gp=general','lang'=>'stat_generalindex'),
        array('url'=>'gct=stat_general&gp=setting','lang'=>'stat_goodspricerange'),
        array('url'=>'gct=stat_general&gp=orderprange','lang'=>'stat_orderpricerange')
    );
