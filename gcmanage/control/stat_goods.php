...
class stat_goodsControl extends SystemControl{
    private $links = array(
        array('url'=>'gct=stat_goods&gp=pricerange','lang'=>'stat_goods_pricerange'),
        array('url'=>'gct=stat_goods&gp=hotgoods','lang'=>'stat_hotgoods'),
        array('url'=>'gct=stat_goods&gp=goods_sale','lang'=>'stat_goods_sale'),
    );
    ...
    public function __construct(){
		...
		//处理搜索时间
		if (in_array($this->search_arr['gp'],array('pricerange','hotgoods','goods_sale'))){
