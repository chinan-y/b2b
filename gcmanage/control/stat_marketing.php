...
class stat_marketingControl extends SystemControl{
    private $links = array(
        array('url'=>'gct=stat_marketing&gp=promotion','lang'=>'stat_promotion'),
        array('url'=>'gct=stat_marketing&gp=group','lang'=>'stat_group'),
    );
    ...
    public function __construct(){
		...
		//处理搜索时间
		if (in_array($this->search_arr['gp'],array('promotion','group'))){
