...
class live_classControl extends SystemControl{
	...
	public function add_classOp(){
		if(chksubmit()){//添加线下抢购分类
			...
			if($res){
				...
				showMessage('添加成功','index.php?gct=live_class','','succ');
			}else{
				showMessage('添加失败','index.php?gct=live_class','','error');
			}
		}
	...
	public function edit_classOp(){
		if(chksubmit()){
			...
			if($res){
				...
				showMessage('编辑成功','index.php?gct=live_class','','succ');
			}else{
				showMessage('编辑失败','index.php?gct=live_class','','error');
			}
		}
	...
	public function del_classOp(){
		...
		showMessage('删除成功','index.php?gct=live_class','','succ');
	}
