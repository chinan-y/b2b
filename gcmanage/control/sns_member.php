		...
		if(chksubmit()){
			...
			if($error != ''){
				...
				if ($result){
					$url = array(
							array(
									'url'=>'index.php?gct=sns_member&gp=tag_add',
									'msg'=>Language::get('sns_member_add_once_more'),
							),
							array(
									'url'=>'index.php?gct=sns_member&gp=member_tag',
		...
		if(chksubmit()){
			...
			if($error != ''){
				...
				if ($result){
					...
					showMessage(Language::get('nc_common_op_succ'),'index.php?gct=sns_member&gp=member_tag');
				}else {
					showMessage(Language::get('nc_common_op_fail'));
				}
			}
