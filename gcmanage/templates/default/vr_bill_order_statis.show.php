...
<div class="page">
  ...
  <form method="get" action="index.php" target="" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="vr_bill" />
    <input type="hidden" name="gp" value="show_statis" />
  ...
  <div style="text-align:right;"><a class="btns" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&gp=export_bill"><span><?php echo $lang['nc_export'];?>CSV</span></a></div>
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <a href="index.php?gct=vr_bill&gp=show_bill&ob_no=<?php echo $bill_info['ob_no'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php }?>
      <?php }else{?>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	...
    	$('input[name="gp"]').val('show_statis');$('#formSearch').submit();
    });
});
</script> 
