  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=promotion_bundling&gp=bundling_quota"><span><?php echo $lang['bundling_quota'];?></span></a></li>
        <li><a href="index.php?gct=promotion_bundling&gp=bundling_setting"><span><?php echo $lang['bundling_setting'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="promotion_bundling">
