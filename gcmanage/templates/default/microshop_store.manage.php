...
$(document).ready(function(){
    //行内ajax编辑
    $('span[nc_type="microshop_sort"]').inline_edit({gct: 'microshop',gp: 'store_sort_update'});
});
...
function submit_delete(id){
    if(confirm("<?php echo $lang['nc_ensure_del'];?>")) {
        ...
        $('#list_form').attr('action','index.php?gct=microshop&gp=store_drop_save');
        $('#store_id').val(id);
        $('#list_form').submit();
    }
}
...
<div class="page">
    ...
    <form method="get" name="formSearch">
        ...
        <input type="hidden" value="store_manage" name="gp">
        ...
        <table class="table tb-type2">
            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        <a href="<?php echo MICROSHOP_SITE_URL.DS.'index.php?gct=store&gp=detail&store_id='.$value['microshop_store_id'];?>" target="_blank">
                            <?php echo $value['store_name'];?>
                        </a>
                    </td>
                    <td>
                        <a href="<?php echo MICROSHOP_SITE_URL.DS.'index.php?gct=home&member_id='.$value['member_id'];?>" target="_blank">
