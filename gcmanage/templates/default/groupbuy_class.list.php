      ...
      <tbody>
        ...
        <tr class="hover edit <?php echo $val['class_parent_id']=='0'?'':'two';?> <?php echo 'parent'.$val['class_parent_id'];?>">
          ...
          <td class="name"><?php if($val['class_parent_id'] != '0'){ ?>
            ...
            <a href="index.php?gct=groupbuy&gp=class_add&parent_id=<?php echo $val['class_id'];?>" class="btn-add-nofloat marginleft"><span><?php echo $lang['nc_add_sub_class'];?></span></a>
            <?php } ?></td>
        <td class="w156 align-center">
            <!--
            <a href="index.php?gct=groupbuy&gp=class_edit&class_id=<?php echo $val['class_id'];?>"><?php echo $lang['nc_edit'];?></a> |
            -->
...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=groupbuy&gp=class_drop');
        $('#class_id').val(id);
        $('#list_form').submit();
    }
}
