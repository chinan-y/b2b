...
function submit_delete(id) {
    if (confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=vr_groupbuy&gp=area_drop');
        $('#area_id').val(id);
        $('#list_form').submit();
    }
}
...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>虚拟抢购</h3>
      <ul class="tab-base">
        <li><a href="index.php?gct=vr_groupbuy&gp=class_list"><span>分类管理</span></a></li>
        <li><a href="index.php?gct=vr_groupbuy&gp=class_add"><span>添加分类</span></a></li>
        <li><a href="javascript:;" class="current"><span>区域管理</span></a></li>
        <li><a href="index.php?gct=vr_groupbuy&gp=area_add"><span>添加区域</span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="vr_groupbuy">
    <input type="hidden" name="gp" value="area_list">
  ...
  <form id="list_form" method='post'>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td><?php echo $val['area_name']?>&nbsp;<a class="btn-add-nofloat marginleft" href="index.php?gct=vr_groupbuy&gp=area_add&area_id=<?php echo $val['area_id'];?>"><span>新增下级</span></a></td>
          ...
          <td class='align-center'>
            <a href="index.php?gct=vr_groupbuy&gp=area_view&parent_area_id=<?php echo $val['area_id'];?>">查看区域</a>
            |
            <a href="index.php?gct=vr_groupbuy&gp=area_edit&area_id=<?php echo $val['area_id'];?>"><?php echo $lang['nc_edit'];?></a>
            |
