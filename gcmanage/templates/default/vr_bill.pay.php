...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>虚拟订单结算</h3>
		<ul class="tab-base">
		<li><a href="index.php?gct=vr_bill&gp=index"><span>结算管理</span></a></li>
		<li><a class="current" href="JavaScript:void(0);"><span>账单付款</span></a></li>
		</ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="post" name="form1" id="form1" action="index.php?gct=vr_bill&gp=bill_pay&ob_no=<?php echo $_GET['ob_no'];?>">
