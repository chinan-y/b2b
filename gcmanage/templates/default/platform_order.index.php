...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span>平台合作方订单</span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="platform_order" />
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
		 ...
		 <th><label>平台合作方</label></th>
         <td><input class="txt-short" type="text" name="platform_name" value="<?php echo $_GET['platform_name'];?>" /></td>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <?php foreach($output['order_list'] as $order){  ?>
      <tr class="hover">
		...
		<?php if(C('three_rank_rebate') == 1) { ?> <td class="align-center"><?php echo $order['three_three'];?></td><td class="align-center"><?php echo $order['three_rebate'];?></td><?php } ?>
		
		<td class="align-center"><?php echo $order['platform_name'];?></td>
