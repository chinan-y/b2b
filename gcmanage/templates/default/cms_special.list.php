...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=cms_special&gp=cms_special_drop');
        $('#special_id').val(id);
        $('#list_form').submit();
    }
}
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w84 align-center">
              ...
              <?php } else { ?>
              <a href="index.php?gct=cms_special&gp=cms_special_detail&special_id=<?php echo $val['special_id'];?>" target="_blank"><?php echo $lang['cms_text_view'];?></a>
              <?php } ?>
              <a href="index.php?gct=cms_special&gp=cms_special_edit&special_id=<?php echo $val['special_id'];?>"><?php echo $lang['nc_edit'];?></a>
