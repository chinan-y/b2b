...
<div class="page">
  ...
  <form id="ship_form" method="post" name="ship_form" action="index.php?gct=pointorder&gp=order_ship&id=<?php echo $_GET['id']; ?>">
  ...
  <div class='msgdiv'> <?php echo $output['errormsg']; ?> <br>
    <br>
    <a class="forward" href="index.php?gct=pointorder&amp;gp=pointorder_list"><?php echo $lang['admin_pointorder_gobacklist']; ?></a> </div>
  <?php } ?>
</div>
