  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=goods_album&gp=pic_list" ><span><?php echo $lang['g_album_pic_list'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center"><a href="index.php?gct=goods_album&gp=pic_list&aclass_id=<?php echo $v['aclass_id'];?>"><?php echo $lang['d'];?><?php echo $lang['g_album_pic_one'];?></a>&nbsp;|&nbsp;<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=goods_album&gp=aclass_del&aclass_id=<?php echo $v['aclass_id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
