...
<div class="page">
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" name="gp" value="activity">
  ...
  <form id="listform" action="index.php" method='post'>
    <input type="hidden" name="gct" value="activity" />
    <input type="hidden" id="listop" name="gp" value="del" />
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover edit row">
          ...
          <td><div class="link-logo"><span class="thumb size-logo"><i></i><img height="31" width="88" src="<?php if(!empty($v['activity_banner'])){echo UPLOAD_SITE_URL."/".ATTACH_ACTIVITY."/".$v['activity_banner'];}else{echo ADMIN_SITE_URL."/templates/".TPL_NAME."/images/sale_banner.jpg";}?>" onload="javascript:DrawImage(this,88,31);" /></span></div></td>
          ...
          <td class="align-center">
          	<a href="index.php?gct=activity&gp=edit&activity_id=<?php echo $v['activity_id'];?>"><?php echo $lang['nc_edit'];?></a>&nbsp;|&nbsp;
          	<?php if ($v['activity_state'] == 0 || $v['activity_end_date']<time()){?>
          	<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=activity&gp=del&activity_id=<?php echo $v['activity_id'];?>';}"><?php echo $lang['nc_del'];?></a>&nbsp;|&nbsp;
          	<?php }?>
          	<a href="index.php?gct=activity&gp=detail&id=<?php echo $v['activity_id'];?>"><?php echo $lang['activity_index_deal_apply'];?></a>
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
