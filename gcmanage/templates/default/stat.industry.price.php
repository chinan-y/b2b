...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="stat_industry" />
    <input type="hidden" name="gp" value="price" />
  ...
  <table class="table tb-type2">
	<thead class="thead">
		<tr class="space">
			<th>行业价格分布（<a href="index.php?gct=stat_general&gp=setting" style="font-size:12px; font-weight:normal;">设置价格区间</a>）</th>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			<td>
				<div class="w100pre close_float align-center h36 mt10">查看行业价格分布情况前，请先设置价格区间。<a href="index.php?gct=stat_general&gp=setting" style="font-size:12px; font-weight:normal;">马上设置</a></div>
			</td>
		</tr>
		<?php } ?>
	</tbody>
