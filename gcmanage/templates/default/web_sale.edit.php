...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=web_api&gp=focus_edit"><span><?php echo '焦点区';?></span></a></li>
  ...
  <form id="sale_list_form" method="post" name="form1">
    ...
    <a href="index.php?gct=web_api&gp=html_update&web_id=<?php echo $output['code_sale_list']['web_id'];?>" class="btn"><span><?php echo $lang['web_config_web_html'];?></span></a>
  </form>
</div>
