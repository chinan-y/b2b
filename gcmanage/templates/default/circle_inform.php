...
<div class="page">
  ...
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="circle_inform">
    <input type="hidden" name="gp" value="inform_list">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?gct=group&c_id=<?php echo $val['circle_id'];?>" target="_blank"><?php echo $val['circle_name'];?></a></td>
          <td>
          ...
          <td class="handle">
            <a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=circle_inform&gp=inform_del&i_id=<?php echo $val['inform_id'];?>'}"><?php echo $lang['nc_del'];?></a>
          </td>
        </tr>
        <?php }?>
        <?php }else{?>
