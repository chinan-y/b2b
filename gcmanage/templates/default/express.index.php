...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current" ><span><?php echo $lang['express_name']?></span></a></li>
        <li><a href="index.php?gct=express&gp=acount_setting" ><span><?php echo $lang['acount_setting']?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
    <table class="tb-type1 noborder search">
      <tbody>
        ...
        <a href="index.php?gct=express&gp=index&letter=<?php echo $v;?>"><?php echo $v;?></a>&nbsp;&nbsp;
        <?php }?>
          </td>
        </tr>
      </tbody>
