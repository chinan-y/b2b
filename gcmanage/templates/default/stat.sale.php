...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="sale" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?gct=stat_trade&gp=sale_trend&search_type='+search_type+'&type='+type+'&order_type='+order_type+'&store_name='+store_name+'&t=<?php echo $output['searchtime'];?>');
}
</script>