...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=circle_memberlevel"><span><?php echo $lang['circle_defaultlevel'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['circle_memberlevelref'];?></span></a></li>
        <li><a href="index.php?gct=circle_memberlevel&gp=ref_add"><span><?php echo $lang['circle_memberleveladd'];?></span></a></li>
        <li><a href="index.php?gct=circle_memberlevel&gp=update_cache"><span><?php echo $lang['nc_circle_cache'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2 nomargin">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="index.php?gct=circle_memberlevel&gp=ref_edit&mlref_id=<?php echo $val['mlref_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=circle_memberlevel&gp=ref_del&mlref_id=<?php echo $val['mlref_id'];?>'}"><?php echo $lang['nc_del'];?></a></td>
          </tr>
          <?php } ?>
          <?php }else { ?>
          <tr class="no_data">
