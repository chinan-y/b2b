    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w156 align-center"><a href="index.php?gct=groupbuy&gp=price_edit&range_id=<?php echo $val['range_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="JavaScript:void(0);" onClick="submit_delete('<?php echo $val['range_id'];?>')"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=groupbuy&gp=price_drop');
        $('#range_id').val(id);
        $('#list_form').submit();
    }
}
