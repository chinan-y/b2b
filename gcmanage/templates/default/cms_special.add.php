...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?gct=cms_special&gp=cms_special_save">
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2" class="cms-special-uploadpic"><ul id="special_image_list" class="thumblists">
              ...
              <li class="picture">
                <div class="size-64x64"> <span class="thumb size-64x64"><i></i> <img alt="<?php echo $value['image_name']; ?>" src="<?php echo $image_url;?>"> </span></div>
  ...
  <!-- 插入商品对话框 -->
	  ...
	  <div id="_dialog_special_insert_goods" >
		<div class="upload_adv_dialog dialog-special-insert-goods">
		  ...
		  <table id="upload_adv_type" class="table tb-type2">
			<tbody>
			  ...
			  <tr class="noborder">
				<td class="vatop rowform"><input id="txt_goods_name" type="text" class="txt w200" name=""/>
			  ...
			  <tr class="noborder">
				<td colspan="2"><ul nctype="_special_goods_list" class="special-goods-list" id="mb_special_goods_list">
				  </ul></td>
			  </tr>
			</tbody>
...
function special_view_update() {
    ...
    $(document).ready(function(){
        $('#btn_mb_special_goods_search').on('click', function() {
            var url = '<?php echo urlAdmin('cms_special', 'goods_info');?>';
