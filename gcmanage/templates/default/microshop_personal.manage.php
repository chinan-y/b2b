...
$(document).ready(function(){
    //行内ajax编辑
    $('span[nc_type="microshop_sort"]').inline_edit({gct: 'microshop',gp: 'personal_sort_update'});
    //时间
...
function submit_delete(id){
    if(confirm("<?php echo $lang['nc_ensure_del'];?>")) {
        ...
        $('#list_form').attr('action','index.php?gct=microshop&gp=personal_drop');
        $('#personal_id').val(id);
        $('#list_form').submit();
    }
}
...
<div class="page">
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" value="personal_manage" name="gp">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td><?php $personal_image_array = getMicroshopPersonalImageUrl($value,'tiny');?>
            ...
            <a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?gct=personal&gp=detail&personal_id=<?php echo $value['personal_id'];?>" style="background:url(<?php echo $personal_image_array[$i];?>) no-repeat center center; width:60px; height:60px; float:left; margin-right:5px;" target="_blank"> 
            ...
            <?php } ?></td>
          <td>
            <a href="<?php echo MICROSHOP_SITE_URL.DS.'index.php?gct=personal&gp=detail&personal_id='.$value['personal_id'];?>" target="_blank"> <?php echo $value['personal_id'];?> </a>
            </td>
          <td>
            <a href="<?php echo MICROSHOP_SITE_URL.DS.'index.php?gct=home&member_id='.$value['commend_member_id'];?>" target="_blank"> <?php echo $value['member_name'];?> </a>
            </td>
