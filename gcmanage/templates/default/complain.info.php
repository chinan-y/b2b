...
<table class="table tb-type2 order mtw">
  ...
  <tr id="close_complain">
      <td>
          <form method='post' id="verify_form" action="index.php?gct=complain&gp=complain_verify">
  ...
  <form method='post' id="close_form" action="index.php?gct=complain&gp=complain_close">
