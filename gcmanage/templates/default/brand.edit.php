...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=brand&gp=brand"><span><?php echo $lang['nc_manage'];?></span></a></li>
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><?php echo $lang['brand_index_upload_tips'].$lang['brand_add_support_type'];?>gif,jpg,png；OSS存储不支持本地裁切图片</td>
        </tr>
        <tr>
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'index.php?gct=common&gp=pic_upload&form_submit=ok&uploadpath=<?php echo ATTACH_BRAND;?>',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['nc_cut'];?>','index.php?gct=common&gp=pic_cut&type=brand&x=150&y=50&resize=1&ratio=3&url='+data.url,690);
					}else{
						alert(data.msg);
					}
	...
	$("#brand_form").validate({
        ...
        rules : {
            brand_name : {
                required : true,
                remote   : {
                    url :'index.php?gct=brand&gp=ajax&branch=check_brand_name',
                    type:'get',
                    data:{
                        brand_name : function(){
