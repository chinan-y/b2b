...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=predeposit&gp=pd_log_list"><span><?php echo $lang['nc_member_predepositlog'];?></span></a></li>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="pd_cash_list">
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
		  ...
		  <th><?php echo $lang['admin_predeposit_paymtime']; ?></th>
          <td colspan="2"><input type="text" id="pstime" name="pstime" class="txt date" value="<?php echo $_GET['pstime'];?>">
            <label>~</label>
            <input type="text" id="petime" name="petime" class="txt date" value="<?php echo $_GET['petime'];?>"></td>
        </tr>
        <tr>
          ...
          <td>
            <select id="paystate_search" name="paystate_search">
              ...
              <option value="2" <?php if($_GET['paystate_search'] == '2' ) { ?>selected="selected"<?php } ?>>已审核</option>
            </select>
  ...
  <div style="text-align:right;"><a class="btns" target="_blank" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&gp=export_cash_step1"><span><?php echo $lang['nc_export'];?>Excel</span></a></div>
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead">
        ...
        <th class="align-center"><?php echo $lang['admin_predeposit_paymtime'];?></th>
        ...
        <th class="align-center"><?php echo $lang['admin_predeposit_remark']; ?></th>
    ...
    <tbody>
      ...
      <tr class="hover">
		...
		<?php if($v['pdc_payment_time']){ ?>
        <td class="nowrap align-center"><?php echo @date('Y-m-d H:i:s',$v['pdc_payment_time']);?></td>
		<?php }else{ ?>
        ...
        <td class="align-center"><?php echo $v['pdc_payment_admin']; ?></td>
        <td class="w90 align-center">
			<a href="index.php?gct=predeposit&gp=pd_cash_view&id=<?php echo $v['pdc_id']; ?>" class="edit"><?php echo $lang['nc_view']; ?></a> | 
          <?php if ($v['pdc_payment_state'] == '0'){ ?>
          <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del']; ?>')){window.location='index.php?gct=predeposit&gp=pd_cash_del&id=<?php echo $v['pdc_id']; ?>';}else{return false;}"><?php echo $lang['nc_del']; ?></a> 
          <?php } ?>
...
$(function(){
	...
	$('#pstime').datepicker({dateFormat: 'yy-mm-dd'});
	$('#petime').datepicker({dateFormat: 'yy-mm-dd'});
    $('#ncsubmit').click(function(){
    	$('input[name="gp"]').val('pd_cash_list');$('#formSearch').submit();
    });
});
</script>