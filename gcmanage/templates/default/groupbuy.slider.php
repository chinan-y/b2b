      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_GROUPBUY.DS.$output['list_setting']['live_pic1'];?>"></div>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_GROUPBUY.DS.$output['list_setting']['live_pic2'];?>"></div>
            </span><span class="type-file-box">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_GROUPBUY.DS.$output['list_setting']['live_pic3'];?>"></div>
            </span><span class="type-file-box">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_GROUPBUY.DS.$output['list_setting']['live_pic4'];?>"></div>
            </span><span class="type-file-box">
...
$(function(){
    ...
    $('#clearBtn').click(function(){
        ...
        $.ajax({
            type:'get',
            url:'index.php?gct=vr_groupbuy&gp=slider_clear',
            dataType:'json',
