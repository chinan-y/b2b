...
<div class="page">
  ...
  <form method='post' id="list_form" action="index.php?gct=voucher&gp=pricedrop">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w96 align-center">
          	<a href="index.php?gct=voucher&gp=priceedit&priceid=<?php echo $v['voucher_price_id'];?>"><?php echo $lang['nc_edit'];?></a>
