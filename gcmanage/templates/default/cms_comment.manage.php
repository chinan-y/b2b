...
function submit_delete(id){
    if(confirm("<?php echo $lang['nc_ensure_del'];?>")) {
        ...
        $('#list_form').attr('action','index.php?gct=cms_comment&gp=comment_drop');
        $('#comment_id').val(id);
        $('#list_form').submit();
    }
}
...
<div class="page">
    ...
    <form method="get" name="formSearch">
        <input type="hidden" value="cms_comment" name="gct">
            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        ...
                        <?php } else { ?>
                        <a href="<?php echo $cms_url.DS.'index.php?gct='.$output['type_array'][$value['comment_type']]['key'].'&gp='.$output['type_array'][$value['comment_type']]['key'].'_detail&'.$output['type_array'][$value['comment_type']]['key'].'_id='.$value['comment_object_id'];?>" target="_blank">
                            <?php echo $value['comment_object_id'];?>
                        </a>
                        <?php } ?>
                    </td>
