...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?gct=voucher&gp=templateedit">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" class="txt"  id="vtitle" name="vtitle" value="<?php echo $output['t_info']['voucher_t_title'];?>" ></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" class="txt" id="end_date" name="end_date" value="<?php echo @date('Y-m-d H:i:s',$output['t_info']['voucher_t_end_date']);?>" ></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" class="txt" id="vprice" name="vprice" value="<?php echo $output['t_info']['voucher_t_price'];?>" ></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" class="txt" id="vtotal" name="vtotal" value="<?php echo $output['t_info']['voucher_t_total'];?>" ></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" class="txt" id="eachlimit" name="eachlimit" value="<?php echo $output['t_info']['voucher_t_eachlimit'];?>" ></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" class="txt" id="vlimit" name="vlimit" value="<?php echo $output['t_info']['voucher_t_limit'];?>" ></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea rows="6" class="tarea" id="vdesc" name="vdesc" ><?php echo $output['t_info']['voucher_t_desc'];?></textarea></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
		...
		<tr class="noborder">
          <td colspan="2" class="required"><label><?php echo $lang['admin_voucher_template_sku'].$lang['nc_colon'];?></label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" class="txt" id="vsku" name="vsku" value="<?php echo $output['t_info']['voucher_t_sku'];?>"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
