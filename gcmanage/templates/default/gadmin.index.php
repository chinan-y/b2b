      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w150 align-center"><?php if($v['admin_is_super']){?>
            ...
            <?php }else{?>
            <a href="index.php?gct=admin&gp=gadmin_set&gid=<?php echo $v['gid'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['gadmin_del_confirm'];?>')){location.href='index.php?gct=admin&gp=gadmin_del&gid=<?php echo $v['gid']; ?>'}"><?php echo $lang['admin_index_del_admin'];?></a>
            <?php }?></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
