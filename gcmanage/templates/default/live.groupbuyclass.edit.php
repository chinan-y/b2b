...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>线下抢分类</h3>
      <ul class="tab-base">
        <li><a href="index.php?gct=live_class" ><span><?php echo $lang['nc_manage'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['nc_edit'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?gct=live_class&gp=edit_class">
