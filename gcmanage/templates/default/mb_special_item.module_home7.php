...
<div class="index_block home7">
  ...
  <div class="content">
    ...
    <div class="home7_1">
      <div class="home7_1_1">
        <div nctype="item_image" class="item"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_data['rectangle1_image']);?>" alt="">
          ...
          <a nctype="btn_edit_item_image" data-desc="64*64" href="javascript:;"><i class="icon-edit"></i>编辑</a>
          <?php } ?>
        </div>
        <div class="home7_1_1">
	...
	<div class="home7_1">
	    ...
	    <div class="home7_1_1">
          <div nctype="item_image" class="item"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_data['rectangle9_image']);?>" alt="">
            <?php if($item_edit_flag) { ?>
            <input nctype="image_name" name="item_data[rectangle9_image]" type="hidden" value="<?php echo $item_data['rectangle9_image'];?>">
            <input nctype="image_type" name="item_data[rectangle9_type]" type="hidden" value="<?php echo $item_data['rectangle9_type'];?>">
            <input nctype="image_data" name="item_data[rectangle9_data]" type="hidden" value="<?php echo $item_data['rectangle9_data'];?>">
            <a nctype="btn_edit_item_image" data-desc="64*64" href="javascript:;"><i class="icon-edit"></i>编辑</a>
            <?php } ?>
          </div>
        </div>
	    <div class="home7_1_1">
          <div nctype="item_image" class="item"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_data['rectangle10_image']);?>" alt="">
            <?php if($item_edit_flag) { ?>
            <input nctype="image_name" name="item_data[rectangle10_image]" type="hidden" value="<?php echo $item_data['rectangle10_image'];?>">
            <input nctype="image_type" name="item_data[rectangle10_type]" type="hidden" value="<?php echo $item_data['rectangle10_type'];?>">
            <input nctype="image_data" name="item_data[rectangle10_data]" type="hidden" value="<?php echo $item_data['rectangle10_data'];?>">
            <a nctype="btn_edit_item_image" data-desc="64*64" href="javascript:;"><i class="icon-edit"></i>编辑</a>
            <?php } ?>
          </div>
        </div>
