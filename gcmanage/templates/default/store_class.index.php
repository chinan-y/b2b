  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=store_class&gp=store_class_add" ><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w84"><span><a href="index.php?gct=store_class&gp=store_class_edit&sc_id=<?php echo $v['sc_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['del_store_class'];?>'))window.location = 'index.php?gct=store_class&gp=store_class_del&sc_id=<?php echo $v['sc_id'];?>';"><?php echo $lang['nc_del'];?></a> </span></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
