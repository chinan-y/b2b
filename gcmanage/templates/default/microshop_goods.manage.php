...
$(document).ready(function(){
    //行内ajax编辑
    $('span[nc_type="microshop_sort"]').inline_edit({gct: 'microshop',gp: 'goods_sort_update'});
    //时间
...
function submit_delete(id){
    if(confirm("<?php echo $lang['nc_ensure_del'];?>")) {
        ...
        $('#list_form').attr('action','index.php?gct=microshop&gp=goods_drop');
        $('#commend_id').val(id);
        $('#list_form').submit();
    }
}
...
<div class="page">
    ...
    <form method="get" name="formSearch">
        ...
        <input type="hidden" value="goods_manage" name="gp">
            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        ...
                        <a href="<?php echo MICROSHOP_SITE_URL.DS.'index.php?gct=goods&gp=detail&goods_id='.$value['commend_id'];?>" style="background:url(<?php echo $image_url;?>) no-repeat center center; width:60px; height:60px; float:left; margin-right:5px;" target="_blank">
                    ...
                    <td>
                        <a href="<?php echo MICROSHOP_SITE_URL.DS.'index.php?gct=goods&gp=detail&goods_id='.$value['commend_id'];?>" target="_blank">
                            <?php echo $value['commend_id'];?>
                        </a>
                    </td>
                    <td>
                        <a href="<?php echo MICROSHOP_SITE_URL.DS.'index.php?gct=home&member_id='.$value['commend_member_id'];?>" target="_blank">
