...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=pointorder&gp=pointorder_list" ><span><?php echo $lang['admin_pointorder_list_title'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="pointprod">
    <input type="hidden" name="gp" value="pointprod">
  ...
  <form method='post' id="form_prod" action="index.php">
    <input type="hidden" name="gct" value="pointprod">
    <input type="hidden" id="list_op" name="gp" value="prod_dropall">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center yes-onoff"><?php if($v['pgoods_commend'] == '0'){ ?>
            ...
            <?php } ?></td>
          <td class="w72 align-center"><a href="index.php?gct=pointprod&gp=prod_edit&pg_id=<?php echo $v['pgoods_id']; ?>" class="edit"><?php echo $lang['nc_edit']; ?></a> | <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del']; ?>')){window.location='index.php?gct=pointprod&gp=prod_drop&pg_id=<?php echo $v['pgoods_id']; ?>';}else{return false;}"><?php echo $lang['nc_del']; ?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
