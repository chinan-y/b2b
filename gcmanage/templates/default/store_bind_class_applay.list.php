...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=store&gp=store" ><span><?php echo $lang['manage'];?></span></a></li>
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['sale_class_application'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" value="store_bind_class_applay_list" name="gp">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <?php if ($v['state'] == '0') {?>
          <a href="javascript:if(confirm('确认审核吗？'))window.location = 'index.php?gct=store&gp=store_bind_class_applay_check&bid=<?php echo $v['bid'];?>&store_id=<?php echo $v['store_id'];?>';">审核</a> |
          <?php } ?>
          <a href="javascript:if(confirm('<?php echo $v['state'] == '1' ? '该类目已经审核通过，删除它可能影响到商家的使用，' : null;?>确认删除吗？'))window.location = 'index.php?gct=store&gp=store_bind_class_applay_del&bid=<?php echo $v['bid'];?>&store_id=<?php echo $v['store_id'];?>';"><?php echo $lang['nc_del'];?></a>
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
