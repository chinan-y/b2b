  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=link&gp=link_add" ><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
    <input type="hidden" value="link" name="gct">
    <input type="hidden" value="link" name="gp">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search tooltip" title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a href="index.php?gct=link&gp=link" class="btns tooltip" title="<?php echo $lang['nc_cancel_search'];?>"><span>撤销检索</span></a>
            <?php }?>
            <a href="JavaScript:void(0);" onclick="window.location.href='index.php?gct=link&gp=link'" class="btns tooltip" title="<?php echo $lang['link_all']; ?>"><span>全部</span></a> <a href="JavaScript:void(0);" onclick="window.location.href='index.php?gct=link&gp=link&type=0'" class="btns tooltip" title="<?php echo $lang['link_pic']; ?>"><span>图片连接</span></a> <a href="JavaScript:void(0);" onclick="window.location.href='index.php?gct=link&gp=link&type=1'" class="btns tooltip" title="<?php echo $lang['link_word']; ?>"><span>文字连接</span></a></td>
        </tr>
      </tbody>
    </table>
  </form>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w96 align-center"><a href="index.php?gct=link&gp=link_edit&link_id=<?php echo $v['link_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?gct=link&gp=link_del&link_id=<?php echo $v['link_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
