...
$(document).ready(function(){
    ...
    $("#goods_class").change(function(){
        ...
        $.getJSON('index.php?gct=microshop&gp=goodsclass_get',{class_id:$(this).val()},function(data){
            if(data != null)
            {
...
<form id="add_form" method="POST" action="index.php?gct=microshop&gp=goodsclass_binding_save">
