...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=circle_theme&gp=theme_list"><span><?php echo $lang['circle_theme_list'];?></span></a></li>
  ...
  <form id="pointprod_form" method="post" enctype="multipart/form-data" >
    ...
    <table class="table tb-type2">
      ...
      <tfoot>
        ...
        <tr class="tfoot">
          <td colspan="3">
            <a href="index.php?gct=circle_theme&gp=theme_reply&t_id=<?php echo $output['theme_info']['theme_id'];?>" class="btn"><span><?php echo $lang['circle_theme_check_reply'];?></span></a>
            <a href="JavaScript:void(0);" onclick="if(confirm('<?php echo $lang['circle_theme_del_confirm'];?>')){location.href='index.php?gct=circle_theme&gp=theme_del&c_id=<?php echo $output['theme_info']['circle_id'];?>&t_id=<?php echo $output['theme_info']['theme_id'];?>';}else{return false;}" class="btn" id="delTheme"><span><?php echo $lang['circle_theme_del'];?></span></a>
          </td>
        </tr>
      </tfoot>
    </table>
