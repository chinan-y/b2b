  ...
  <div class="fixed-empty"></div>
	...
	<tbody>
		<tr>
			...
			<a href="index.php?gct=perform&gp=perform&type=clear"><?php echo $lang['memory_set_cls'];?></a><?php }else{ echo '--';}?>
			</td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<a href="index.php?gct=perform&gp=perform&type=clear"><?php echo $lang['memory_set_cls'];?></a><?php }else{ echo '--';}?></td>
			<td></td>
		</tr>
		<tr>
			<td></td>
