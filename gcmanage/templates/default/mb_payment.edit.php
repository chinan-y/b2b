  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdmin('mb_payment', 'payment_save');?>">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <?php } ?>
        <?php if ($output['payment']['payment_code'] == 'wxpay' || $output['payment']['payment_code'] == 'wxapppay'  ) { ?>
        <tr>
		...
		<?php if ($output['payment']['payment_code'] == 'lakala') { ?>
        <tr>
          <td colspan="2" class="required"><label class="validation">拉卡拉自助服务平台账号:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
              <input name="lakala_account" id="lakala_account" value="<?php echo $output['payment']['payment_config']['lakala_account'];?>" class="txt" type="text">
          </td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                <input name="merchant_number" id="merchant_number" value="<?php echo $output['payment']['payment_config']['merchant_number'];?>" class="txt" type="text">
            </td>
          <td class="vatop tips"></td>
        </tr>
        <?php } ?>
		
		<?php if ($output['payment']['payment_code'] == 'gzbank') { ?>
        <tr>
          <td colspan="2" class="required"><label class="validation">贵州银行平台账号:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
              <input name="gz_account" id="gz_account" value="<?php echo $output['payment']['payment_config']['gz_account'];?>" class="txt" type="text">
          </td>
          <td class="vatop tips"></td>
        </tr>
