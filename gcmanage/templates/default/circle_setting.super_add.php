  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['circle_setting_supperadmin'];?></span></a></li>
        <li><a href="<?php echo urlAdmin('circle_setting', 'super_list');?>"><span><?php echo $lang['circle_supperadmin_list'];?></span></a></li>
      </ul>
    </div>
  </div>
...
$(function(){
	...
	$('#member_name').focus(function(){
		ajax_form('choose_master', '选择会员', 'index.php?gct=circle_setting&gp=choose_super', 320);
	});
});
