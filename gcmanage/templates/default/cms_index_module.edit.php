...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?gct=cms_index&gp=save_page_module">
  ...
  <div id="dialog_module_tag_edit" style="display:none;">
    ...
    <ul class="article-tag-list">
      ...
      <li nctype="btn_tag_select" data-tag-id="<?php echo $value['tag_id'];?>"><a href="<?php echo CMS_SITE_URL;?>/index.php?gct=article&gp=article_tag_search&tag_id=<?php echo $value['tag_id'];?>" ><?php echo $value['tag_name'];?></a><i></i></li>
      <?php } ?>
      <?php } ?>
    </ul>
  ...
  <div id="dialog_module_image_edit" style="display:none;">
    <form action="index.php?gct=cms_index&gp=image_upload" method="post">
