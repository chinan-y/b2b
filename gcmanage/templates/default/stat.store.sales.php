...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="stat_store" />
    <input type="hidden" name="gp" value="storesales" />
...
function getTrends(storeid){
	$('#stattrends').load('index.php?gct=stat_store&gp=storesales_trends&storeid='+storeid+'&search_type='+s_type+'&t=<?php echo $output['searchtime'];?>');
}
$(function () {
	//统计数据类型
    ...
    $('#statlist').load('index.php?gct=stat_store&gp=storesales_list&search_sclass='+search_sclass+'&search_sname='+search_sname+'&t=<?php echo $output['searchtime'];?>');
    //店铺销售走势
