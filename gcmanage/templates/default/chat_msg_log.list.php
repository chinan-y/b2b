...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>聊天内容</h3>
      <ul class="tab-base">
        <li><a href="index.php?gct=chat_log&gp=chat_log"><span>聊天记录</span></a></li>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="chat_log" />
    <input type="hidden" name="gp" value="msg_log" />
        ...
        <dl>
          <dt class="store_log">发消息会员：<?php echo $val['f_name']; ?> <span>(接收消息会员：<?php echo $val['t_name']; ?>)</span></span>
            ...
            <dd class="time"><?php echo date("Y-m-d H:i:s",$val['add_time']);?>
                <a href="index.php?gct=chat_log&gp=chat_log&f_name=<?php echo $val['f_name']; ?>&t_name=<?php echo $val['t_name']; ?>&add_time_from=<?php echo date("Y-m-d",$val['add_time']);?>&add_time_to=<?php echo date("Y-m-d",$val['add_time']);?>">详情</a></dd>
