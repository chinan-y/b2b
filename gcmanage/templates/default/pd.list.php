...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="predeposit">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="w90 align-center">
          ...
          <a href="JavaScript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){window.location ='index.php?gct=predeposit&gp=recharge_del&id=<?php echo $v['pdr_id']; ?>'}"><span><?php echo $lang['nc_del'];?></span></a>
          <?php } ?>
          <a href="index.php?gct=predeposit&gp=recharge_info&id=<?php echo $v['pdr_id']; ?>" class="edit"><?php echo $lang['nc_view']; ?></a>
          </td>
      </tr>
      <?php } ?>
      <?php }else { ?>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="gp"]').val('predeposit');$('#formSearch').submit();
    });	
});
</script>