...
<div class="page">
  ...
  <form method="get" name="formSearch">
    <input type="hidden" value="delivery" name="gct">
    <input type="hidden" value="order_list" name="gp">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a href="index.php?gct=delivery&gp=order_list&d_id=<?php echo $_GET['d_id'];?>" class="btns " title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td><?php echo $v['reciver_name'];?></td>
		   <td><?php echo $v['reciver_idnum'];?></td>
