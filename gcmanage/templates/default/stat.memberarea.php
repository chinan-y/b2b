...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="area" />
...
$(function () {
    ...
    //加载统计列表
    $('#statlist').load('index.php?gct=stat_member&gp=area_list&t=<?php echo $output['searchtime'];?>');
});
//加载统计地图
function getStatMap(type){
	$('#'+type+'_div').load('index.php?gct=stat_member&gp=area_map&type='+type+'&t=<?php echo $output['searchtime'];?>');
}
</script>