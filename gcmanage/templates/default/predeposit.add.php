    ...
    <div class="item-title">
      ...
      <ul class="tab-base">
       <li><a href="index.php?gct=predeposit&gp=predeposit"><span><?php echo $lang['admin_predeposit_rechargelist']?></span></a></li>
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['nc_member_predepositset'];?></span></a></li>
      </ul>
    </div>
  </div>
...
function checkmember(){
	...
	$.getJSON("index.php?gct=predeposit&gp=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
