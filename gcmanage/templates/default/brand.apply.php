    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w96 align-center"><a href="index.php?gct=brand&gp=brand_apply_set&state=pass&brand_id=<?php echo $v['brand_id']?>"><?php echo $lang['nc_pass'];?></a> | <a href="index.php?gct=brand&gp=brand_apply_set&state=refuse&brand_id=<?php echo $v['brand_id']?>"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
