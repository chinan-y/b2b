...
<div class="login-layout">
  <div class="top">
    <h4><?php echo $lang['login_index_title_01'];?><em></em></h4>
    <h1><?php echo $lang['login_index_title_02'];?></h1>
   ...
   <form method="post" id="form_login">
    ...
    <div class="avatar" style="display:none;"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/login/admin.png" alt=""></div>
...
<div class="code">
        ...
        <div class="code-img"><img src="index.php?gct=seccode&gp=makecode&admin=1&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage" border="0"/></div>

        <a href="JavaScript:void(0);" id="hide" class="close" title="<?php echo $lang['login_index_close_checkcode'];?>"><i></i></a><a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?gct=seccode&gp=makecode&admin=1&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="更换验证码"><i></i></a> </div>
...
$(function(){
        ...
        slides             : [    
								 ...
								 {image : '<?php echo ADMIN_TEMPLATES_URL;?>/images/login/6.jpg'},
                                 {image : '<?php echo ADMIN_TEMPLATES_URL;?>/images/login/7.jpg'},
                                 {image : '<?php echo ADMIN_TEMPLATES_URL;?>/images/login/8.jpg'},
								 {image : '<?php echo ADMIN_TEMPLATES_URL;?>/images/login/9.jpg'},
								 {image : '<?php echo ADMIN_TEMPLATES_URL;?>/images/login/10.jpg'}
