...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="stat_marketing" />
    <input type="hidden" name="gp" value="group" />
    <div class="w100pre">
...
$(function () {
	...
	//加载统计列表
    $('#glist').load('index.php?gct=stat_marketing&gp=grouplist&t=<?php echo $output['searchtime'];?>');
    $('#statlist').load('index.php?gct=stat_marketing&gp=groupgoods&t=<?php echo $output['searchtime'];?>');
