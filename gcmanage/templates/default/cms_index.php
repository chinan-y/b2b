...
$(document).ready(function(){
    ...
    $('#template_module_list').on('click', '[nctype="btn_add_page_module"]', function() {
        ...
        $.post("index.php?gct=cms_index&gp=add_page_module", { module_title: page_module.module_title, module_name: page_module.module_name, module_type: page_module.module_type }, function(data) {
            if(data.result) {
                ...
                $('.page-module').last().find('span[nc_type="module_title"]').inline_edit_confirm({gct: 'cms_index', gp:'update_page_module_title'});
    ...
    $('#template_module_list').on('click', '[nctype="btn_drop_module"]', function() {
        ...
        if(confirm('确认删除?')) {
            ...
            $.post("index.php?gct=cms_index&gp=drop_module", { module_id: module_id }, function(data) {
                if(data.result) {
    ...
    $('#page_view').on('click', "[nctype='btn_show_page_module']", function() {
        ...
        $.post("index.php?gct=cms_index&gp=update_page_module_show", { module_id: module_id }, function(data) {
            if(data.result) {
    ...
    $('#page_view').on('click', "[nctype='btn_hide_page_module']", function() {
        var $btn = $(this);
        var module_id = $btn.attr('data-module-id');
        $.post("index.php?gct=cms_index&gp=update_page_module_hide", { module_id: module_id }, function(data) {
            if(data.result) {
                var $page_module = $btn.parents('.page-module');
    ...
    $('#page_view').on('click', "[nctype='btn_drop_page_module']", function() {
        if(confirm('确认删除')) {
            ...
            $.post("index.php?gct=cms_index&gp=drop_page_module", { module_id: module_id }, function(data) {
                if(data.result) {
    ...
    $("#page_view").sortable({ 
        update: function(event, ui) {
            ...
            $.post("index.php?gct=cms_index&gp=update_page_module_index", {page_module_id_string: page_module_id_string}, function(data) {
                if(!data.result) {
                    showError(data.message);
                }
            }, 'json');
    ...
    $('span[nc_type="module_title"]').inline_edit_confirm({gct: 'cms_index', gp:'update_page_module_title'});

    //生成首页
    $("#btn_index_build").click(function() {
        $.getJSON('index.php?gct=cms_index&gp=cms_index_build', function(data) {
            if(data.result) {
    ...
    $('#btn_add_module').click(function() {
        ...
        if($module_frame_list.html() === '') {
            $.getJSON('index.php?gct=cms_index&gp=get_module_frame_list', function(data) {
                if(data.frame_list) {
                    var template_data = {};
    ...
    $('#btn_save_module').click(function() {
        ...
        $.post("index.php?gct=cms_index&gp=save_module", {module_title: module_title, frame_name: frame_name, frame_block: frame_block, module_display_title_state: module_display_title_state}, function(data) {
            if(data.result) {
    ...
    $('#page_view').on('click', "[nctype='btn_module_style_select']", function() {
        ...
        $.post("index.php?gct=cms_index&gp=update_page_module_style", {module_id: module_id, module_style: module_style}, function(data) {
            if(data.result) {
                var $page_module = $btn.parents('.page-module');
    ...
    $('#page_view').on('click', "[nctype='btn_module_view_change']", function() {
        ...
        $.post("index.php?gct=cms_index&gp=update_page_module_view", {module_id: module_id, module_view: module_view}, function(data) {
            if(!data.result) {
                showError(data.message);
            }
        }, 'json');
...
<div class="page">
  ...
  <a class="btn" href="index.php?gct=cms_index&gp=cms_index_preview" target="_blank"><span>预览</span></a> 
...
<div id="page_module_<%=module_id%>" data-module-id="<%=module_id%>" data-module-name="<%=module_name%>" class="page-module <%=module_css%> <%=module_state_css%> module-css-<%=module_type%> module-style-<%=module_style%>">
    ...
    <a href="index.php?gct=cms_index&gp=module_edit&module_id=<%=module_id%>" class="edit" title="<?php echo $lang['nc_edit'];?>"></a>
