  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=help_store&gp=help_type"><span><?php echo '帮助类型';?></span></a></li>
        <li><a href="index.php?gct=help_store&gp=add_help"><span><?php echo '新增内容';?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="help_store" />
    <input type="hidden" name="gp" value="help_store" />
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w150 align-center"><a href="index.php?gct=help_store&gp=edit_help&help_id=<?php echo $val['help_id'];?>"><?php echo $lang['nc_edit'];?></a> |
          	<a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>')) window.location = 'index.php?gct=help_store&gp=del_help&help_id=<?php echo $val['help_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
