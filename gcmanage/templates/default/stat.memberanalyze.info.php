<div style="text-align:right;">
	<input type="hidden" id="export_type_<?php echo $output['stat_field'];?>" name="export_type" data-param='{"url":"index.php?gct=stat_member&gp=analyzeinfo&type=<?php echo $output['stat_field'];?>&t=<?php echo $_GET['t'];?>&exporttype=excel"}' value="excel"/>
