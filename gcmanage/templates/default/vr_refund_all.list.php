...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>虚拟订单退款</h3>
      <ul class="tab-base">
        <li><a href="index.php?gct=vr_refund&gp=refund_manage"><span><?php echo '待审核';?></span></a></li>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="vr_refund" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        <td><a href="index.php?gct=vr_order&gp=show_order&order_id=<?php echo $val['order_id'];?>"><?php echo $val['order_sn'];?></a></td>
        ...
        <td class="align-center"><a href="index.php?gct=vr_refund&gp=view&refund_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
