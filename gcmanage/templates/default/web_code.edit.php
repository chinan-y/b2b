...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=web_config&gp=web_config"><span><?php echo '板块区';?></span></a></li>
        <li><a href="index.php?gct=web_config&gp=web_edit&web_id=<?php echo $_GET['web_id'];?>"><span><?php echo $lang['web_config_web_edit'];?></span></a></li>
  ...
  <table class="table tb-type2 nohover">
    ...
    <tfoot>
        <tr class="tfoot">
          <td colspan="2" ><a href="index.php?gct=web_config&gp=web_html&web_id=<?php echo $_GET['web_id'];?>" class="btn" id="submitBtn"><span><?php echo $lang['web_config_web_html'];?></span></a></td>
        </tr>
      </tfoot>
  </table>
</div>
...
<div id="upload_tit_dialog" style="display:none;">
  ...
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?gct=web_api&gp=upload_pic" target="upload_pic">
...
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  ...
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?gct=web_api&gp=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    ...
    <input type="hidden" name="gct[pic]" value="<?php echo $output['code_act']['code_info']['pic'];?>">
    <input type="hidden" name="gct[type]" value="pic">
    <table class="table tb-type2" id="upload_act_type_pic" <?php if($output['code_act']['code_info']['type'] == 'adv') { ?>style="display:none;"<?php } ?>>
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
          	<input class="txt" type="text" name="gct[title]" value="<?php echo $output['code_act']['code_info']['title'];?>">
          	</td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input name="gct[url]" value="<?php echo !empty($output['code_act']['code_info']['url']) ? $output['code_act']['code_info']['url']:SHOP_SITE_URL;?>" class="txt" type="text"></td>
                ...
                <ul class="dialog-goodslist-s1 goods-list">
                  <?php if(!empty($val['goods_list']) && is_array($val['goods_list'])) { ?>
                      ...
                      <li id="select_recommend_<?php echo $key;?>_goods_<?php echo $k;?>">
                        ...
                        <div class="goods-name"><a href="<?php echo SHOP_SITE_URL."/index.php?gct=goods&goods_id=".$v['goods_id'];?>" target="_blank"><?php echo $v['goods_name'];?></a></div>
...
<div id="recommend_pic_dialog" style="display:none;">
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?gct=web_api&gp=recommend_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
...
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
  <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?gct=web_api&gp=slide_adv" target="upload_pic">
