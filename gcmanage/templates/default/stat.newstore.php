...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="newstore" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <?php foreach ($output['statlist']['data'] as $k=>$v){?>
      <tr class="hover">
        ...
        <td class="align-center"><a href="index.php?gct=stat_store&gp=showstore&type=newbyday&t=<?php echo $v['seartime'];?>&scid=<?php echo $_REQUEST['search_sclass'];?>">查看</a></td>
      </tr>
    <?php } ?>
    <?php } else { ?>
    <tr class="no_data">
