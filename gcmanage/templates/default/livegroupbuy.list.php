...
function submit_delete(id){
    if(confirm('确认删除该抢购?')) {
        $('#list_form').attr('method','post');
       	$('#list_form').attr('action','index.php?gct=live_groupbuy&gp=del_groupbuy');
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w60 picture">
          	...
          	<a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?gct=show_live_groupbuy&gp=groupbuy_detail&groupbuy_id=".$val['groupbuy_id'];?>"><img src="<?php echo lgthumb($val['groupbuy_pic'], 'small');?>" style=" max-width: 56px; max-height: 56px;"/></a></span></div>
          </td>
          <td class="group">
            <p><a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?gct=show_live_groupbuy&gp=groupbuy_detail&groupbuy_id=".$val['groupbuy_id'];?>"><?php echo $val['groupbuy_name'];?></a></p>
		  ...
		  <td class='align-center'>
		  	<?php if($val['is_audit']==1){?>
		  	<a href="javascript:;" onclick="javascript:groupbuy('pass','index.php?gct=live_groupbuy&gp=audit&groupbuy_id=<?php echo $val['groupbuy_id'];?>&is_audit=2');">通过</a>&nbsp;|&nbsp;
		  	<a href="javascript:;" onclick="javascript:groupbuy('refuse','index.php?gct=live_groupbuy&gp=audit&groupbuy_id=<?php echo $val['groupbuy_id'];?>&is_audit=3');">拒绝</a>
		  	<?php }elseif($val['is_audit']==2){?>
				<?php if($val['is_open']==1){?>
				<a href="javascript:;" onclick="javascript:groupbuy('cancel','index.php?gct=live_groupbuy&gp=cancel&groupbuy_id=<?php echo $val['groupbuy_id'];?>');" >取消</a>
				<?php }?>
		  	<?php }?>
		  </td>
        </tr>
