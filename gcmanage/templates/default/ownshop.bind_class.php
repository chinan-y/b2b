...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>自营店铺</h3>
      <ul class="tab-base">
        <li><a href="index.php?gct=ownshop&gp=list"><span>管理</span></a></li>
...
<form id="form_bd" name="" method="post" action="index.php?gct=ownshop&gp=bind_class&id=<?php echo $_GET['id'];?>">
...
$(function(){
    ...
    // 修改分佣比例
    $('span[nc_type="commis_rate"]').inline_edit({gct: 'ownshop',gp: 'bind_class_update'});
});
