  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=adv&gp=ap_add" ><span><?php echo $lang['ap_add'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" action="index.php?gct=adv&gp=ap_manage" name="formSearch">
    <input type="hidden" name="gct" value="adv" />
    <input type="hidden" name="gp" value="ap_manage" />
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a href="JavaScript:void(0);" onclick=window.location.href='index.php?gct=adv&gp=ap_manage' class="btns " title="<?php echo $lang['adv_all']; ?>"><span><?php echo $lang['adv_all']; ?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <a href="index.php?gct=adv&gp=adv&ap_id=<?php echo $v['ap_id'];?>">管理广告</a> | <a href='index.php?gct=adv&gp=ap_edit&ap_id=<?php echo $v['ap_id'];?>'><?php echo $lang['nc_edit'];?></a> |<a href="javascript:void(0)" onclick="copyToClipBoard('<?php echo $v['ap_id'];?>');"><?php echo $lang['ap_get_js'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
{
   ajax_form('copy_adv', '<?php echo $lang['ap_get_js'];?>', 'index.php?gct=adv&gp=ap_copy&id='+id);
}
</script>
