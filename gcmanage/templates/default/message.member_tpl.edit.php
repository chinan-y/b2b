...
<div class="page">
  ...
  <div class="homepage-focus" nctype="sellerTplContent">
    ...
    <!-- 邮件 E -->
    <!-- 微信模板消息 -->
    <form class="tab-content" method="post" name="wechatmsg_form" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
      <input type="hidden" name="code" value="<?php echo $output['mmtpl_info']['mmt_code'];?>" />
      ...
      <table class="table tb-type2">
        <tbody>
          <tr class="noborder">
            <td colspan="2" class="required"><label>微信模板消息开关:</label></td>
          </tr>
          <tr class="noborder">
            <td class="vatop rowform onoff">
              <label for="wechat_switch1" class="cb-enable <?php if($output['mmtpl_info']['mmt_wechat_switch'] == 1){?>selected<?php }?>"><span><?php echo $lang['open'];?></span></label>
              <label for="wechat_switch0" class="cb-disable <?php if($output['mmtpl_info']['mmt_wechat_switch'] == 0){?>selected<?php }?>"><span><?php echo $lang['close'];?></span></label>
              <input id="wechat_switch1" name="wechat_switch" <?php if($output['mmtpl_info']['mmt_wechat_switch'] == 1){?>checked="checked"<?php }?> value="1" type="radio">
              <input id="wechat_switch0" name="wechat_switch" <?php if($output['mmtpl_info']['mmt_wechat_switch'] == 0){?>checked="checked"<?php }?> value="0" type="radio"></td>
            <td class="vatop tips"></td>
          </tr>
          <tr>
            <td colspan="2" class="required"><label>消息内容:</label></td>
          ...
          <tr class="noborder">
            <td class="vatop rowform">
              <textarea name="wechat_content" rows="6" class="tarea"><?php echo $output['mmtpl_info']['mmt_wechat_content'];?></textarea>
            </td>
            <td class="vatop tips"></td>
          </tr>
        </tbody>
      ...
      <div class="margintop">
        <a href="JavaScript:void(0);" onclick="document.wechatmsg_form.submit();" class="btn"><span><?php echo $lang['nc_submit'];?></span></a>
      </div>
    </form>
    <!-- 微信模板消息 -->
  </div>
