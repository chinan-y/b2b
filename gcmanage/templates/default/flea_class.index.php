  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=flea_class&gp=goods_class_add" ><span>新增</span></a></li>
        <li><a href="index.php?gct=flea_class&gp=goods_class_export" ><span>导出</span></a></li>
        <li><a href="index.php?gct=flea_class&gp=goods_class_import" ><span>导入</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <a class="btn-add-nofloat marginleft" href="index.php?gct=flea_class&gp=goods_class_add&gc_parent_id=<?php echo $v['gc_id'];?>"><span><?php echo $lang['nc_add_sub_class'];?></span></a>
          </td>
          ...
          <td class="align-center power-onoff"><?php if($v['gc_index_show'] == 0){ ?>
            ...
            <?php } ?></td>
          <td class="w84"><a href="index.php?gct=flea_class&gp=goods_class_edit&gc_id=<?php echo $v['gc_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['goods_class_index_ensure_del'];?>'))window.location = 'index.php?gct=flea_class&gp=goods_class_del&gc_id=<?php echo $v['gc_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
