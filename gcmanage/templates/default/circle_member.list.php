...
<div class="page">
  ...
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="circle_member">
    <input type="hidden" name="gp" value="member_list">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit member">
          ...
          <td class="w72"><a href="javascript:void(0);" onclick="delmember('<?php echo $val['member_id']?>|<?php echo $val['circle_id'];?>')"><?php echo $lang['nc_del'];?></a> | <a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=sns_circle&mid=<?php echo $val['member_id'];?>" target="_blank"><?php echo $lang['nc_view'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
function delmember(id){
	_uri = "index.php?gct=circle_member&gp=member_del&param="+id;
