...
<div class="index_block goods-list">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item">
      <div class="goods-pic"><img nctype="goods_image" src="<?php echo cthumb($item_value['goods_image'], 240, $item_value['store_id'], $item_value['goods_commonid']);?>" alt="<?php echo $item_value['goods_name'];?>"></div>
      <div class="goods-name" nctype="goods_name"><?php echo $item_value['goods_name'];?></div>
      <div class="goods-price" nctype="goods_price">￥<?php echo $item_value['goods_promotion_price'];?>
			<span class="goods-item-zi"><del>￥<?php echo $item_value['goods_marketprice'];?><del/><span/>
	  </div>
      <?php if($item_edit_flag) { ?>
