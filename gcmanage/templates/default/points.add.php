  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=points&gp=pointslog"><span><?php echo $lang['admin_points_log_title']?></span></a></li>
      </ul>
    </div>
  </div>
...
function checkmember(){
	...
	$.getJSON("index.php?gct=points&gp=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
