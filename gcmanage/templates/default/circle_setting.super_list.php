  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo urlAdmin('circle_setting', 'superadd');?>"><span><?php echo $lang['circle_setting_supperadmin'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['circle_supperadmin_list'];?></span></a></li>
      </ul>
    </div>
  </div>
