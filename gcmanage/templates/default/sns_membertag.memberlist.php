...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=sns_member"><span><?php echo $lang['sns_member_tag_manage'];?></span></a></li>
      ...
      <tbody>
        <tr class="hover edit">
          ...
          <td class="w120 align-center">
          	<a href="index.php?gct=sns_member&gp=mtag_del&id=<?php echo $v['mtag_id'];?>&mid=<?php echo $v['member_id'];?>"><?php echo $lang['nc_del'];?></a>
          </td>
        </tr>
        <?php } ?>
      </tbody>
