...
<div class="page">
  ...
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="circle_theme">
    <input type="hidden" name="gp" value="theme_list">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit member">
          ...
          <td class="w48 picture"><?php if(isset($val['affix'])){?><span class="thumb size-44x44"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?gct=theme&gp=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>" target="_blank"><img width="44" height="44"  src="<?php echo $val['affix'];?>" /></a></span><?php }?></td>
          <td class="">
            <p><strong><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?gct=theme&gp=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>" target="_blank"><?php echo $val['theme_name'];?></a></strong></p>
            <p class="smallfont"><?php echo $lang['circle_belong_to_circle'];?><a target="_blank" href="<?php echo CIRCLE_SITE_URL;?>/index.php?gct=group&c_id=<?php echo $val['circle_id'];?>"><?php echo $val['circle_name'];?></a></p>
          </td>
          ...
          <td class="w120"><a href="index.php?gct=circle_theme&gp=theme_info&t_id=<?php echo $val['theme_id'];?>"><?php echo $lang['nc_view'];?></a> | <a href="index.php?gct=circle_theme&gp=theme_reply&t_id=<?php echo $val['theme_id'];?>"><?php echo $lang['circle_reply'];?></a> | <a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=circle_theme&gp=theme_del&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
