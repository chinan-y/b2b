...
<div class="index_block goods-list">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item">
      <div class="goods-pic"><img nctype="goods_image" src="<?php echo cthumb($item_value['goods_image']);?>" alt="<?php echo $item_value['goods_name'];?>"></div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_mb_special_goods_search').on('click', function() {
            var url = '<?php echo urlAdmin('mb_special', 'promotion_xianshi_list');?>';
