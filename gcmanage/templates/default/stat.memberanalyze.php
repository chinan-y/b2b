...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="stat_member" />
    <input type="hidden" name="gp" value="analyze" />
...
$(function () {
	...
	$("[name='searchweek_month']").change(function(){
		...
		$.getJSON('index.php?gct=common&gp=getweekofmonth',{y:year,m:month},function(data){
	        if(data != null){
	...
	//加载详细列表
	$("#list_ordernum").load('index.php?gct=stat_member&gp=analyzeinfo&type=ordernum&t=<?php echo $output['searchtime'];?>');
	$("#list_orderamount").load('index.php?gct=stat_member&gp=analyzeinfo&type=orderamount&t=<?php echo $output['searchtime'];?>');
	$("#list_goodsnum").load('index.php?gct=stat_member&gp=analyzeinfo&type=goodsnum&t=<?php echo $output['searchtime'];?>');
