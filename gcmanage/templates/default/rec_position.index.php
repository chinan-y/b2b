  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=rec_position&gp=rec_add"><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
  <input type="hidden" value="rec_position" name="gct">
  <input type="hidden" value="rec_list" name="gp">
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w180 align-center"><a href="index.php?gct=rec_position&gp=rec_edit&rec_id=<?php echo $v['rec_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){return true;}else{return false;}" href="index.php?gct=rec_position&gp=rec_del&rec_id=<?php echo $v['rec_id'];?>"><?php echo $lang['nc_del'];?></a> | <a nctype="jscode" rec_id="<?php echo $v['rec_id'];?>" href="javascript:void(0)"><?php echo $lang['rec_ps_code']?></a> | <a target="_blank" href="index.php?gct=rec_position&gp=rec_view&rec_id=<?php echo $v['rec_id'];?>"><?php echo $lang['rec_ps_view'];?></a>
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
...
$(function(){
	...
	function copyToClipBoard(id){
	    ...
	    {
	        ajax_form('copy_rec', '<?php echo $lang['rec_ps_code'];?>', 'index.php?gct=rec_position&gp=rec_code&rec_id='+id);
	    }
	}
});
</script>
