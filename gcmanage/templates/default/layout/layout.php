...
<script type="text/javascript" src="<?php echo SHOP_SITE_URL;?>/ectap/wechat/login/resource/js/wechat.nav.js"></script>
<script type="text/javascript" src="<?php echo SHOP_SITE_URL;?>/ectap/wechat/login/resource/js/wechatpc.nav.js"></script>
...
<div id="think_page_trace" class="trace">
  <fieldset id="querybox">
    ...
    <div>
      <?php print_r(\gcwebshop\Tpl::showTrace());?>
    </div>
  </fieldset>
</div>
<?php }?>
