...
$(document).ready(function(){
    //行内ajax编辑
    $('span[nc_type="navigation_sort"]').inline_edit({gct: 'cms_navigation',gp: 'update_navigation_sort'});
    $('span[nc_type="navigation_title"]').inline_edit({gct: 'cms_navigation',gp: 'update_navigation_title'});
    $('span[nc_type="navigation_link"]').inline_edit({gct: 'cms_navigation',gp: 'update_navigation_link'});
});
...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=cms_navigation&gp=cms_navigation_drop');
