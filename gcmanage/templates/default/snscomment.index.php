...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=snstrace&gp=tracelist"><span><?php echo $lang['admin_snstrace_tracelist'];?></span></a></li>
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" name="gp" value="commentlist">
...
function submit_form(type){
	if(type=='del'){
		...
		$('#form_comment').attr('action','index.php?gct=snstrace&gp=commentdel');
	}else if(type=='hide'){
		$('#form_comment').attr('action','index.php?gct=snstrace&gp=commentedit&type=hide');
	}else{
		$('#form_comment').attr('action','index.php?gct=snstrace&gp=commentedit&type=show');
	}
	$('#form_comment').submit();
}
</script>