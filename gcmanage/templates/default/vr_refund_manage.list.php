...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=vr_refund&gp=refund_all"><span><?php echo '所有记录';?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="refund_manage" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><a href="index.php?gct=vr_refund&gp=edit&refund_id=<?php echo $val['refund_id']; ?>"> 审核 </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
