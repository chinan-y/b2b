...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=type&gp=type"><span><?php echo $lang['nc_list'];?></span></a></li>
    ...
    <table class="table tb-type2">
      ...
      <tbody id="tr_model">
        ...
        <tr class="hover edit">
          ...
          <td class="w60 align-center"><a href="index.php?gct=type&gp=attr_edit&attr_id=<?php echo $aval['attr_id'];?>"><?php echo $lang['nc_edit'];?></a></td>
        </tr>
        <?php }?>
        <?php }?>
      </tbody>
