...
<div class="page">
  ...
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="promotion_mansong">
...
<?php } ?>
            ...
            <td class="nowrap align-center">
                <!-- 详细按钮 -->
                <a href="index.php?gct=promotion_mansong&gp=mansong_detail&mansong_id=<?php echo $val['mansong_id'];?>"><?php echo $lang['nc_detail'];?></a>
                <?php if($val['editable']) { ?>
