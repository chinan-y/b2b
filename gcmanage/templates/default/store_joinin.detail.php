  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=store&gp=reopen_list" ><span>续签申请</span></a></li>
        <li><a href="index.php?gct=store&gp=store_bind_class_applay_list" ><span>经营类目申请</span></a></li>
...
电子版：</th>
  ...
  <form id="form_store_verify" action="index.php?gct=store&gp=store_joinin_verify" method="post">
