...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=spec&gp=spec_add"><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form id="form_spec" method="get">
    <input type="hidden" name="gct" value="spec" />
    <input type="hidden" name="gp" value="spec_del" />
    <div style="text-align: right;"><a class="btns" href="index.php?gct=spec&gp=export_step1"><span><?php echo $lang['nc_export'];?>Excel</span></a></div>
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w96 align-center"><a href="index.php?gct=spec&gp=spec_edit&sp_id=<?php echo $val['sp_id'];?>"><?php echo $lang['nc_edit'];?></a> <?php if($val['sp_id'] != '1'){?>| <a onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=spec&gp=spec_del&del_id=<?php echo $val['sp_id'];?>';}else{return false;}" href="javascript:void(0)"><?php echo $lang['nc_del'];?></a><?php }?> </td>
        </tr>
        <?php }?>
        <?php }else{ ?>
        <tr class="no_data">
