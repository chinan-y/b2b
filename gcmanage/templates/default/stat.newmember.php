...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="newmember" />
    ...
    <?php if(!empty($output['statlist']['data'])){ ?>
      ...
      <tr class="hover">
        ...
        <td class="align-center">
        	<a href="index.php?gct=stat_member&gp=showmember&type=newbyday&t=<?php echo $v['seartime'];?>">查看</a>
        </td>
      </tr>
      <?php } ?>
      <tr class="hover">
        ...
        <td class="align-center">
        	<a href="index.php?gct=stat_member&gp=showmember&type=newbyday&t=<?php echo $output['count_arr']['seartime'];?>">查看</a>
        </td>
      </tr>
    <?php } else { ?>
      <tr class="no_data">
