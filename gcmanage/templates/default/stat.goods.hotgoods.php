...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="hotgoods" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?gct=stat_goods&gp=hotgoods_list&type='+type+'&choose_gcid='+choose_gcid+'&t=<?php echo $output['searchtime'];?>');
}
