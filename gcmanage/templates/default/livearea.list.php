  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
		...
		<li><a href="index.php?gct=live_area&gp=area_add&area_id"><span><?php echo $lang['nc_add'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
  	<input type="hidden" name="gct" value="live_area">
  	<input type="hidden" name="gp" value="live_area">
  ...
  <form id="list_form" method='post'>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td><?php echo $val['live_area_name']?>&nbsp;<a class="btn-add-nofloat marginleft" href="index.php?gct=live_area&gp=area_add&live_area_id=<?php echo $val['live_area_id'];?>"><span><?php echo $lang['nc_store_add_new_class'];?></span></a></td>
		  ...
		  <td class='align-center'>
		  	<a href="index.php?gct=live_area&gp=view_area&parent_area_id=<?php echo $val['live_area_id'];?>"><?php echo $lang['live_area_manage_view_area'];?></a>
		  	|<a href="index.php?gct=live_area&gp=area_edit&live_area_id=<?php echo $val['live_area_id'];?>"><?php echo $lang['nc_edit'];?></a> | 
