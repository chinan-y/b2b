  ...
  <form id="post_form" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
		...
		<?php } elseif ($output['payment']['payment_code'] == 'bocomm') { ?>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_bocomm_MerCertID'];?>:
            </th></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="hidden" name="config_name" value="bocomm_MerCertID,bocomm_ChannelApi" />
            <input name="bocomm_MerCertID" id="bocomm_MerCertID" value="<?php echo $output['config_array']['bocomm_MerCertID'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_bocomm_ChannelApi'];?>: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="bocomm_ChannelApi" id="bocomm_ChannelApi" value="<?php echo $output['config_array']['bocomm_ChannelApi'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
...
$(document).ready(function(){
	$('#post_form').validate({
        ...
        messages : {
            bocomm_MerCertID  : {
                required  : '<?php echo $lang['payment_bocomm_MerCertID'];?><?php echo $lang['payment_edit_not_null']; ?>'
            },
            bocomm_ChannelApi  : {
                required   : '<?php echo $lang['payment_bocomm_ChannelApi'];?><?php echo $lang['payment_edit_not_null']; ?>'
            }
        }		
		<?php } elseif ($output['payment']['payment_code'] == 'tenpay') { ?>
        rules : {
