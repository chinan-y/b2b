...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=sns_strace&gp=stracelist"><span><?php echo $lang['admin_snstrace_tracelist'];?></span></a></li>
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" name="gp" value="scomm_list">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w150 align-center"><a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=sns_strace&gp=scomm_del&sc_id=<?php echo $v['scomm_id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
function submit_form(type){
	if(type=='del'){
		...
		$('#form_comment').attr('action','index.php?gct=sns_strace&gp=scomm_del');
	}else if(type=='hide'){
		$('#form_comment').attr('action','index.php?gct=sns_strace&gp=scomm_edit&type=hide');
	}else if(type=='show'){
		$('#form_comment').attr('action','index.php?gct=sns_strace&gp=scomm_edit&type=show');
	}
	$('#form_comment').submit();
}
</script>