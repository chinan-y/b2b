...
<div class="page">
  ...
  <form method="get" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="goods">
    <input type="hidden" name="gp" value="goods">
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <th><label for="search_goods_serial">商品货号</label></th>
          <td><input type="text" value="<?php echo $output['search']['search_goods_serial']?>" name="search_goods_serial" id="search_goods_serial" class="txt" /></td>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          <th class="w24"></th>
          <th class="w24"></th>
          <th class="w60 align-center">商品ID</th>
		  <th class="w60 align-center">平台货号</th>
          <th class="w60 align-center">自定义排序</th>
          ...
          <th class="w72 align-center">商品返利率</th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center"><?php echo $output['storage_array'][$v['goods_commonid']]['goods_id']; ?></td>
          <td class="align-center"><?php echo $v['goods_commonid'];?></td>
          <td class="align-center">
              <form name="from1">
                  <input type="text" name="goods_sorts" id="goods_sorts" value="<?php echo $v['goods_sorts'];?>" ONBLUR="getVal(this.value,<?php echo $v['goods_commonid'];?>)" /  maxlength="9" size="10">
              </form>
          </td>
		  <td class="align-center"><?php echo $v['goods_serial'];?></td>
          ...
          <dd class="goods-type">
            ...
            <dd class="goods-store"><?php echo $output['ownShopIds'][$v['store_id']] ? '自营' : '非自营'; ?>店铺：<?php echo $v['store_name'];?></dd></dl>
            </td>
          <td>
          ...
          <td class="align-center"><?php echo $v['goods_rebate_rate']*100;?>%</td>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
        $('input[name="gp"]').val('goods');$('#formSearch').submit();
    });
