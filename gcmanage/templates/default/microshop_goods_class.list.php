...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //行内ajax编辑
        $('span[nc_type="class_sort"]').inline_edit({gct: 'microshop',gp: 'goodsclass_sort_update'});
        $('span[nc_type="class_name"]').inline_edit({gct: 'microshop',gp: 'goodsclass_name_update'});
...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=microshop&gp=goodsclass_drop');
        $('#class_id').val(id);
        $('#list_form').submit();
    }
}
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="name"><span nc_type="class_name" column_id="<?php echo $val['class_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $val['class_name'];?></span> <a class="btn-add-nofloat marginleft" href="index.php?gct=microshop&gp=goodsclass_add&class_parent_id=<?php echo $val['class_id'];?>"><span><?php echo $lang['nc_add_sub_class'];?></span></a></td>
		  <td><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MICROSHOP.DS.$val['class_image'] ?>"></td>
          ...
          <td class="align-center"><a href="index.php?gct=microshop&gp=goodsclass_edit&class_id=<?php echo $val['class_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:submit_delete(<?php echo $val['class_id'];?>)"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        ...
        <tr class="hover edit <?php echo 'class_id'.$val['class_id'];?>" style="display:none;">
          ...
          <td><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MICROSHOP.DS.$val1['class_image'] ?>"></td>
          <td></td>
          <td class="w200 align-center">
              <?php if(empty($val1['class_default'])) { ?>
              <a href="index.php?gct=microshop&gp=goodsclass_default&class_id=<?php echo $val1['class_id'];?>"><?php echo $lang['microshop_goods_class_default'];?></a> | 
              <?php } ?>
              <a href="index.php?gct=microshop&gp=goodsclass_binding&class_id=<?php echo $val1['class_id'];?>"><?php echo $lang['microshop_goods_class_binding'];?></a> | 
              <a href="index.php?gct=microshop&gp=goodsclass_edit&class_id=<?php echo $val1['class_id'];?>"><?php echo $lang['nc_edit'];?></a> | 
