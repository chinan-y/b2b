...
<div class="page">
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" name="gp" value="templatelist">
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
            ...
            <?php } ?></td>
            <td class="nowrap align-center"><a href="index.php?gct=voucher&gp=templateedit&tid=<?php echo $val['voucher_t_id'];?>"><?php echo $lang['nc_edit'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
