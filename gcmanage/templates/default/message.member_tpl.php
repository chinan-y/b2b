    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center"><?php echo ($val['mmt_type']) ? '营销' : '默认';?></td>
          ...
          <td class="align-center"><?php echo ($val['mmt_wechat_switch']) ? '开启' : '关闭';?></td>
...
function go(){
	var url="index.php?gct=message&gp=email_tpl_ajax";
