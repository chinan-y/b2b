...
<div class="page">
  ...
  <!-- <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?gct=voucher&gp=setting"> -->
  <form id="add_form" method="post" action="index.php?gct=voucher&gp=setting">
