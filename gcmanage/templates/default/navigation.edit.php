...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=navigation&gp=navigation" ><span><?php echo $lang['nc_manage'];?></span></a></li>
        ...
        <tr class="noborder">
          <td class="vatop rowform "><ul>
              ...
              <li>
                ...
                <label for="nav_location4"><?php echo $lang['navigation_index_wechat'];?> </label>
              </li>              
              <li>
