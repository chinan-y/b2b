...
$(document).ready(function(){
    //行内ajax编辑
    $('span[nc_type="class_sort"]').inline_edit({gct: 'cms_article_class',gp: 'update_class_sort'});
    $('span[nc_type="class_name"]').inline_edit({gct: 'cms_article_class',gp: 'update_class_name'});
});
...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=cms_article_class&gp=cms_article_class_drop');
        $('#class_id').val(id);
        $('#list_form').submit();
    }
}
