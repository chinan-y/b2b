...
<div class="page">
  ...
  <form method="post" name="form_index" action="index.php?gct=setting&gp=seo_update">
  ...
  <form method="post" name="form_group" action="index.php?gct=setting&gp=seo_update">
    <input type="hidden" name="form_submit" value="ok" />
  ...
  <form method="post" name="form_brand" action="index.php?gct=setting&gp=seo_update">
    <input type="hidden" name="form_submit" value="ok" />
    <span style="display:none" nctype="hide_tag"><a>{sitename}</a><a>{name}</a></span>
    <table class="table tb-type2">
      <tbody>
  ...
  <form method="post" name="form_point" action="index.php?gct=setting&gp=seo_update">
    <input type="hidden" name="form_submit" value="ok" />
  ...
  <form method="post" name="form_article" action="index.php?gct=setting&gp=seo_update">
    <input type="hidden" name="form_submit" value="ok" />
  ...
  <form method="post" name="form_shop" action="index.php?gct=setting&gp=seo_update">
    <input type="hidden" name="form_submit" value="ok" />
  ...
  <form method="post" name="form_product" action="index.php?gct=setting&gp=seo_update">
    <input type="hidden" name="form_submit" value="ok" />
    <span style="display:none" nctype="hide_tag"><a>{sitename}</a><a>{name}</a><a>{key}</a><a>{description}</a></span>
    <table class="table tb-type2">
      <tbody>
  ...
  <form method="post" name="form_category" action="index.php?gct=setting&gp=seo_category">
    <input type="hidden" name="form_submit" value="ok" />
    <span style="display:none" nctype="hide_tag"><a>{sitename}</a><a>{name}</a></span>
    <table class="table tb-type2">
      <tbody>
  ...
  <form method="post" name="form_sns" action="index.php?gct=setting&gp=seo_update">
    <input type="hidden" name="form_submit" value="ok" />
    <span style="display:none" nctype="hide_tag"><a>{sitename}</a><a>{name}</a></span>
    <table class="table tb-type2">
      <tbody>
...
$(function(){
	...
	$('#category').bind('change',function(){
		$.getJSON('index.php?gct=setting&gp=ajax_category&id='+$(this).val(), function(data){
			if(data){
