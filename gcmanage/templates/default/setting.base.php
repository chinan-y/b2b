...
<div class="page">
  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <table class="table tb-type2">
	 ...
	 <!-- 商城底部微信二维码 -->
	 	<tr>
          <td colspan="2" class="required"><label for="gcweb_copyright">版权主体：</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input id="gcweb_copyright" name="gcweb_copyright" value="<?php echo $output['list_setting']['gcweb_copyright'];?>" class="txt" type="text" /></td>
          <td class="vatop tips"><span class="vatop rowform"><?php echo $lang['gcweb_copyright'];?></span></td>
        </tr>
        <tr>
		...
		<tr>
          <td colspan="2" class="required"><label for="statistics_code_baidu"><?php echo $lang['flow_static_code'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="statistics_code_baidu" rows="6" class="tarea" id="statistics_code_baidu"><?php echo $output['list_setting']['statistics_code_baidu'];?></textarea></td>
          <td class="vatop tips"><span class="vatop rowform"><?php echo $lang['flow_static_code_notice'];?></span></td>
        </tr> 
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="site_buy1" class="cb-enable <?php if($output['list_setting']['site_buy'] == '1'){ ?>selected<?php } ?>" ><span><?php echo $lang['open'];?></span></label>
            <label for="site_buy0" class="cb-disable <?php if($output['list_setting']['site_buy'] == '0'){ ?>selected<?php } ?>" ><span><?php echo $lang['close'];?></span></label>
            <input id="site_buy1" name="site_buy" <?php if($output['list_setting']['site_buy'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
        ...
        <tr>
          <td colspan="2" class="required"><label for="site_notice"><?php echo $lang['site_notice'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="site_notice[content]" rows="6" class="tarea" id="site_notice_content" ><?php echo $output['list_setting']['site_notice']['content'];?></textarea></td>
          <td class="vatop tips">
			<input class="txt date" type="text" value="<?php echo $output['list_setting']['site_notice']['start_time'];?>" id="site_notice_start_time" name="site_notice[start_time]">
			<label for="query_start_time">~</label>
			<input class="txt date" type="text" value="<?php echo $output['list_setting']['site_notice']['end_time'];?>" id="site_notice_end_time" name="site_notice[end_time]"/>
			<span class="vatop rowform"><?php echo $lang['site_notice_notice'];?></span>
		  </td>
        </tr>
      </tbody>
