...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="buying" />
  ...
  <table class="table tb-type2">
	<thead class="thead">
		<tr class="space">
			<th colspan="15">客单价分布（<a href="index.php?gct=stat_general&gp=orderprange" style="font-size:12px; font-weight:normal;">设置价格区间</a>）</th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td>
				...
				<?php } else { ?>
				<div class="w100pre close_float align-center h36 mt10">查看客单价分布情况前，请先设置价格区间。<a href="index.php?gct=stat_general&gp=orderprange" style="font-size:12px; font-weight:normal;">马上设置</a></div>
				<?php }?>
			</td>
		</tr>
	</tbody>
