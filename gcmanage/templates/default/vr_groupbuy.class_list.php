      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="name">
            ...
            <a class="btn-add-nofloat marginleft" href="index.php?gct=vr_groupbuy&gp=class_add&parent_class_id=<?php echo $val['class_id'];?>"><span>新增下级</span></a>
          </td>
          <td>
            <a href="index.php?gct=vr_groupbuy&gp=class_edit&class_id=<?php echo $val['class_id'];?>"><?php echo $lang['nc_edit'];?></a> |
        ...
        <tr class="hover edit <?php echo 'class_id'.$val['class_id'];?>" style="display:none;">
          ...
          <td class="w200">
              <a href="index.php?gct=vr_groupbuy&gp=class_edit&class_id=<?php echo $val1['class_id'];?>"><?php echo $lang['nc_edit'];?></a> |
...
function submit_delete(id){
    if (confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=vr_groupbuy&gp=class_del');
        $('#class_id').val(id);
        $('#list_form').submit();
    }
}
