...
<div class="page">
  ...
  <form method="get" action="index.php" target="" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="bill_list" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center">
        <a href="index.php?gct=bill&gp=show_store_month_order&bill_id=<?php echo $order['ob_no'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php }?>
      <?php }else{?>
...
$(function(){
    ...
    $('#ncexport').click(function(){
    	$('input[name="gp"]').val('export');
    	$('#formSearch').attr('target','_blank');
    	$('#formSearch').submit();
    });
    $('#ncsubmit').click(function(){
    	$('#formSearch').attr('target','_self');
    	$('input[name="gp"]').val('bill_list');$('#formSearch').submit();
    });
});
</script> 
