<?php defined('GcWebShop') or exit('Access Invalid!');?>
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="show_bill" />
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        ...
        <th><label for="add_time_from">订单类型</label></th>
          ...
          <a class="btns" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&gp=export_refund_order"><span><?php echo $lang['nc_exposrt'];?>导出退单明细</span></a>
            </td>
        </tr>
      </tbody>
    </table>
...
<table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <a href="index.php?gct=refund&gp=view&refund_id=<?php echo $refund_info['refund_id'];?>"><?php echo $lang['nc_view'];?></a>
        <?php } else {?>
        <a href="index.php?gct=return&gp=view&return_id=<?php echo $refund_info['refund_id'];?>"><?php echo $lang['nc_view'];?></a>
        <?php } ?>
        </td>
      </tr>
      <?php }?>
