...
<div class="page">
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" name="gct" value="consulting" />
    <input type="hidden" name="gp" value="consulting" />
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns " href="index.php?gct=consulting&gp=consulting" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?>
          </td>
        </tr>
      </tbody>
  ...
  <form method="post" action="index.php?gct=consulting&gp=delete" onsubmit="return checkForm() && confirm('<?php echo $lang['nc_ensure_del'];?>');" name="form1">
      ...
      <tbody>
        ...
        <tr class="space">
          ...
          <th>
          	...
          	<span><a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?gct=goods&goods_id=".$consult['goods_id'].'&id='.$consult['store_id'];?>"><?php echo $consult['goods_name'];?></a></span>
          </th>
          ...
          <th><strong><?php echo $lang['nc_handle'];?>:</strong>&nbsp;<a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='<?php echo urlencode('index.php?gct=consulting&gp=delete&consult_id='.$consult['consult_id']);?>';}" class="normal" ><?php echo $lang['nc_del'];?></a></th>
        </tr>
        <tr>
