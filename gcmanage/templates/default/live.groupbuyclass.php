  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=live_class&gp=add_class" ><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="name">
          	...
          	<a class="btn-add-nofloat marginleft" href="index.php?gct=live_class&gp=add_class&parent_class_id=<?php echo $val['live_class_id'];?>"><span><?php echo $lang['live_groupbuy_class_add_new_class'];?></span></a>
          </td>
          <td>
          	<a href="index.php?gct=live_class&gp=edit_class&live_class_id=<?php echo $val['live_class_id'];?>"><?php echo $lang['nc_edit'];?></a> | 
        ...
        <tr class="hover edit <?php echo 'live_class_id'.$val['live_class_id'];?>" style="display:none;">
          ...
          <td class="w200">
              <a href="index.php?gct=live_class&gp=edit_class&live_class_id=<?php echo $val1['live_class_id'];?>"><?php echo $lang['nc_edit'];?></a> | 
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //行内ajax编辑
        $('span[nc_type="live_class_sort"]').inline_edit({gct: 'live_class',gp: 'update_class_sort'});
        $('span[nc_type="live_class_name"]').inline_edit({gct: 'live_class',gp: 'update_class_name'});
...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=live_class&gp=del_class');
