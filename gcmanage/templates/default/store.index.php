...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=store&gp=store_joinin" ><span><?php echo $lang['pending'];?></span></a></li>
        <li><a href="index.php?gct=store&gp=reopen_list" ><span><?php echo $lang['renew_application'];?></span></a></li>
        <li><a href="index.php?gct=store&gp=store_bind_class_applay_list" ><span><?php echo $lang['sale_class_application'];?></span></a></li>
        <li><a href="index.php?gct=store&gp=newshop_add" ><span><?php echo $lang['add_store'];?></span></a></li>
        <li><a href="index.php?gct=store&gp=store_import" ><span><?php echo $lang['csv_import_store'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch" id="formSearch">
  <input type="hidden" value="store" name="gct">
  <input type="hidden" value="store" name="gp">
  ...
  <tbody>
    <tr><th><label><?php echo $lang['belongs_level'];?></label></th>
      ...
      <td><input type="text" value="<?php echo $output['owner_and_name'];?>" name="owner_and_name" id="owner_and_name" class="txt"></td><td></td><th><label><?php echo $lang['store_type'];?></label></th>
        <td>
      ...
      <td><input type="text" value="<?php echo $output['store_name'];?>" name="store_name" id="store_name" class="txt"></td>
        ...
        <a href="index.php?gct=store&gp=store" class="btns " title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
        <?php }?></td>
    </tr></tbody>
  </table>
  </form>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <td class="align-center w200">
            <a href="index.php?gct=store&gp=store_joinin_detail&member_id=<?php echo $v['member_id'];?>">查看</a>&nbsp;&nbsp;<a href="index.php?gct=store&gp=store_edit&store_id=<?php echo $v['store_id']?>"><?php echo $lang['nc_edit'];?></a>&nbsp;&nbsp;
                <a href="index.php?gct=store&gp=store_bind_class&store_id=<?php echo $v['store_id']?>">经营类目</a>
            <?php if (getStoreStateClassName($v) != 'open' && cookie('remindRenewal'.$v['store_id']) == null) {?><a href="<?php echo urlAdmin('store', 'remind_renewal', array('store_id'=>$v['store_id']));?>">提醒续费</a><?php }?>&nbsp;&nbsp; <a href="index.php?gct=store&gp=del&id=<?php echo $v['store_id']?>&member_id=<?php echo $v['member_id']?>" onclick="return confirm('您确认要删除此店铺吗？');">删除</a>
            </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
...
$(function(){
    $('#ncsubmit').click(function(){
    	$('input[name="gp"]').val('store');$('#formSearch').submit();
    });
});
</script>
