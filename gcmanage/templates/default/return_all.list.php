...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=return&gp=return_manage"><span><?php echo '待处理';?></span></a></li>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="return" />
    <input type="hidden" name="gp" value="return_all" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><a href="index.php?gct=return&gp=view&return_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
