...
<div class="page">
  ...
  <form method="get" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="goods_class">
    <input type="hidden" name="gp" value="tag">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td><a href="javascript:if(confirm('<?php echo $lang['goods_class_tag_del_confirm'];?>'))window.location = 'index.php?gct=goods_class&gp=tag_del&tag_id=<?php echo $v['gc_tag_id']?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
      ...
      <tfoot>
        <tr class="tfoot">
          ...
          <td colspan="18"><span class="all_checkbox">
            ...
            </span>&nbsp;&nbsp; <a href="JavaScript:void(0);" class="btn" onclick="submit_form('del')"><span><?php echo $lang['nc_del'];?></span></a> <a href="JavaScript:void(0);" class="btn" onclick="$('#dialog').show();location.href='index.php?gct=goods_class&gp=tag_update'"><span><?php echo $lang['goods_class_tag_update'];?></span></a> <a class="btn" href="JavaScript:void(0);" onclick="if(confirm('<?php echo $lang['goods_class_tag_reset_confirm'];?>')){location.href='index.php?gct=goods_class&gp=tag_reset'}"> <span><?php echo $lang['goods_class_tag_reset'];?></span> </a>
            <?php if(!empty($output['tag_list']) && is_array($output['tag_list'])){ ?>
