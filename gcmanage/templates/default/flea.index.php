...
<div class="page">
  ...
  <form method="get" name="formSearch">
	<input type="hidden" name="gct" value="flea">
	<input type="hidden" name="gp" value="flea">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w48 align-center"><a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=flea_goods&goods_id=<?php echo $v['goods_id'];?>" target="_blank"><?php echo $lang['nc_view'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
