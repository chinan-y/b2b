...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="stat_trade" />
    <input type="hidden" name="gp" value="income" />
  ...
  <div style="text-align:right;">
    <input type="hidden" id="export_type" name="export_type" data-param='{"url":"index.php?gct=stat_trade&gp=income&search_year=<?php echo intval($_GET['search_year']); ?>&search_month=<?php echo trim($_GET['search_month']); ?>&exporttype=excel"}' value="excel"/>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody id="datatable">
      ...
      <tr class="hover">
        <td class="align-center"><a href="<?php echo SHOP_SITE_URL; ?>/index.php?gct=show_store&store_id=<?php echo $v['ob_store_id']; ?>" target="_blank"><?php echo $v['ob_store_name']; ?></a></td>
        ...
        <td class="align-center"><a href="index.php?gct=stat_trade&gp=sale&search_type=month&search_time_month=<?php echo intval($_GET['search_month']); ?>&search_time_year=<?php echo intval($_GET['search_year']); ?>&store_name=<?php echo $v['ob_store_name']; ?>">详细</a></td>
      </tr>
      <?php } ?>
      <?php }else { ?>
      <tr class="no_data">
