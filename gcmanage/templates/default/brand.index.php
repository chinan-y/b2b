  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=brand&gp=brand_add"><span><?php echo $lang['nc_new'];?></span></a></li>
        <li><a href="index.php?gct=brand&gp=brand_apply"><span><?php echo $lang['brand_index_to_audit'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="brand">
    <input type="hidden" name="gp" value="brand">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:void(0);" id="ncsubmit" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns " href="index.php?gct=brand&gp=brand" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center yes-onoff"><?php if($v['brand_recommend'] == '0'){ ?>
            ...
            <?php } ?></td>
          <td class="align-center"><a href="index.php?gct=brand&gp=brand_edit&brand_id=<?php echo $v['brand_id'];?>"><?php echo $lang['nc_edit'];?></a>&nbsp;|&nbsp;<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=brand&gp=brand_del&del_brand_id=<?php echo $v['brand_id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="gp"]').val('brand');$('#formSearch').submit();
    });	
});
</script>