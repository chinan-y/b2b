...
<div class="page">
  ...
  <form method="post" action='index.php?gct=cache&gp=clear_groupbuy'>
    <table class="table nobdb">
	  <tbody>
		<tr>
		  <td class="required">清理网站天天特价redis缓存，请点击下面的清理特价按钮</td>
		</tr>
	  </tbody>
      <tfoot>
        <tr class="tfoot">
          <td colspan="2"><input  value="清理特价" type="submit">
		  </td>
        </tr>
      </tfoot>
    </table>
  ...
  <form method="post" action='index.php?gct=cache&gp=clear_xianshi'>
    <table class="table nobdb">
	  <tbody>
		<tr>
		  <td class="required">清理网站超低折扣redis缓存，请点击下面的清理超低按钮</td>
		</tr>
	  </tbody>
      <tfoot>
        <tr class="tfoot">
          <td colspan="2"><input  value="清理超低" type="submit">
		  </td>
        </tr>
      </tfoot>
    </table>
  ...
  <form method="post" action='index.php?gct=cache&gp=clear_mansong'>
    <table class="table nobdb">
	  <tbody>
		<tr>
		  <td class="required">清理网站满及送redis缓存，请点击下面的清理满送按钮</td>
		</tr>
	  </tbody>
      <tfoot>
        <tr class="tfoot">
          <td colspan="2"><input  value="清理满送" type="submit">
		  </td>
        </tr>
      </tfoot>
    </table>
  ...
  <form method="post" action='index.php?gct=cache&gp=clear_special'>
    <table class="table nobdb">
	  <tbody>
		<tr>
		  <td class="required"><input type="text" name="spe_num" style="width:54px;" >  清理网站手机专题redis缓存，请输入专题编号点击下面的清理专题按钮</td>
		</tr>
	  </tbody>
      <tfoot>
        <tr class="tfoot">
          <td colspan="2"><input  value="清理专题" type="submit">
		  </td>
        </tr>
      </tfoot>
    </table>
