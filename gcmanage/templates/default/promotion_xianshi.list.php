...
<div class="page">
  ...
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="promotion_xianshi">
...
<?php } ?>
            ...
            <td class="nowrap align-center">
                <a href="index.php?gct=promotion_xianshi&gp=xianshi_detail&xianshi_id=<?php echo $val['xianshi_id'];?>"><?php echo $lang['nc_detail'];?></a>
                <?php if($val['editable']) { ?>
