...
<div class="page">
  ...
  <form id="search_form" method="get" name="formSearch">
    <input type="hidden" id="gct" name="gct" value="complain" />
    <input type="hidden" id="gp" name="gp" value="<?php echo $output['gp'];?>" />
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns " href="index.php?gct=complain&gp=<?php echo $output['gp'];?>" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center"><a href="index.php?gct=complain&gp=complain_progress&complain_id=<?php echo $v['complain_id'];?>"><?php echo $lang['complain_text_detail'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
