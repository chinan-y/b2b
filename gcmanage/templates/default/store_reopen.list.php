...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current" ><span><?php echo $lang['renew_application'];?></span></a></li>
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" value="reopen_list" name="gp">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <a href="javascript:if(confirm('审核后，系统会自动将店铺的到期时间向后延续\n店铺等级不会自动变更，如果新签约的店铺等级发生变更，请手动更改店铺等级\n确认审核吗？'))window.location = 'index.php?gct=store&gp=reopen_check&re_id=<?php echo $val['re_id'];?>';">审核</a>
          <?php } ?>
          <?php echo $val['re_state'] == '1' ? ' | ' : null;?>
         <?php if ($val['re_state'] != '2') {?>
         <a href="javascript:if(confirm('确认删除吗？'))window.location = 'index.php?gct=store&gp=reopen_del&re_id=<?php echo $val['re_id'];?>&re_store_id=<?php echo $val['re_store_id'];?>';"><?php echo $lang['nc_del'];?></a>
          <?php } ?>
          </td>
        </tr>
        <?php } ?>
