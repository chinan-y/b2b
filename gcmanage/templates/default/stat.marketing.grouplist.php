...
<div style="border:1px #D9D9D9 solid; padding:10px; width:98%;">
    <div style="text-align:right;">
    	...
    	<a href="index.php?gct=stat_marketing&gp=grouplist&t=<?php echo $output['searchtime'];?>" id="glistsearchbtn" class="btn-search tooltip" title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
    </div>
    <table class="table tb-type2 nobdb">
        ...
        <?php foreach ((array)$output['grouplist'] as $k=>$v){?>
          ...
          <tr nc_type="ginfo" class="hover ginfo" style="<?php echo $k==1?'':'display:none;'; ?>">
            <td colspan="3">
            	<div class="size-106x106 left img"><span class="thumb size-106x106"><i></i><a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?gct=show_groupbuy&gp=groupbuy_detail&group_id=".$v['groupbuy_id'];?>"><img src="<?php echo gthumb($v['groupbuy_image'], 'small');?>" style=" max-width: 106px; max-height: 106px;"/></a></span></div>
            	<div class="left">
...
$(function () {
	...
	$("#glistsearchbtn").mouseover(function(){
		var gname = $("#gname").val();
		$(this).attr('href','index.php?gct=stat_marketing&gp=grouplist&t=<?php echo $output['searchtime'];?>&gname='+gname);
