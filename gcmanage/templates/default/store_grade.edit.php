...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=store_grade&gp=store_grade" ><span><?php echo $lang['manage'];?></span></a></li>
	...
	$('#grade_form').validate({
        ...
        rules : {
            sg_name : {
                required : true,
                remote   : {
                url :'index.php?gct=store_grade&gp=ajax&branch=check_grade_name',
                type:'get',
                data:{
                        sg_name : function(){
                        	return $('#sg_name').val();
            ...
            sg_sort : {
                ...
                digits  : true,
                remote   : {
	                url :'index.php?gct=store_grade&gp=ajax&branch=check_grade_sort',
	                type:'get',
	                data:{
	                        sg_sort : function(){
	                        	return $('#sg_sort').val();
