...
<div class="page">
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" name="gct" value="rechargecard" />
...
<div style="text-align: right;"><a class="btns" href="index.php?<?php echo http_build_query($_GET); ?>&gp=export_step1" target="_blank"><span>导出Excel</span></a></div>
