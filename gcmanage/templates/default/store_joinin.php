...
<div class="page">
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" value="store_joinin" name="gp">
        ...
        <tr>
          ...
          <td><select name="grade_id">
            ...
            <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
                ...
                <a href="index.php?gct=store&gp=store_joinin" class="btns " title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
                <?php }?></td>
        </tr>
        </tbody>
    </table>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w72 align-center">
              ...
              <a href="index.php?gct=store&gp=store_joinin_detail&member_id=<?php echo $v['member_id'];?>">审核</a>
              <?php } else { ?>
              <a href="index.php?gct=store&gp=store_joinin_detail&member_id=<?php echo $v['member_id'];?>">查看</a>
              <?php } ?>
               <?php if(intval($v['joinin_state'])<40) { ?>
              &nbsp;&nbsp; <a href="index.php?gct=store&gp=del_join&id=<?php echo $v['member_id']?>">删除</a>
               <?php } ?>
          </td>
        </tr>
        <?php } ?>
