...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=type&gp=type_add"><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form id="form_spec" method="get">
    <input type="hidden" name="gct" value="type" />
    <input type="hidden" name="gp" value="type_del" />
    <div style="text-align: right;"><a class="btns" href="index.php?gct=type&gp=export_step1"><span><?php echo $lang['nc_export'];?>Excel</span></a></div>
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w96 align-center"><a href="index.php?gct=type&gp=type_edit&t_id=<?php echo $val['type_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=type&gp=type_del&del_id=<?php echo $val['type_id'];?>';}else{return false;}" href="javascript:void(0)"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php }?>
        <?php }else{ ?>
        <tr class="no_data">
