    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody id="datatable">
        ...
        <tr class="hover member">
          ...
          <td><p class="name"><strong><a href="http://qr.liantu.com/api.php?w=500&text=http://www.qqbsmall.com/wap/index.html?ref=<?php echo $v['member_id'] ?>" target=_blank /><?php echo $v['member_name']; ?></a></strong>(<?php echo $lang['member_index_true_name']?>: <?php echo $v['member_truename']; ?>)</p>
              <div class="im"><span class="email" >
                ...
                <em class="is_manager">区域经理</em>
                <?php } ?>
              </div></td>
          <td class="align-center"><?php echo $v['member_id']; ?></td>
          <td class="align-center"><?php echo $v['member_rebate_rate'] * 100; ?>%</td>
          ...
          <td class="align-center"><p><?php echo $lang['member_index_available'];?>:&nbsp;<strong class="red"><?php echo $v['available_predeposit']; ?></strong>&nbsp;<?php echo $lang['currency_zh']; ?></p>
            ...
            <td class="align-center" style="width:180px;"><span><a href="index.php?gct=sales_area&gp=achievement&mname=<?php echo $v['member_name'];?>">业绩查询</a>  </span></td>
