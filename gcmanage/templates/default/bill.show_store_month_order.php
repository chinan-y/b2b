  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <?php //echo $output['top_link'];?>
		<ul class="tab-base">
		<li><a href="index.php?gct=bill&gp=bill_list"><span>结算管理</span></a></li>
...
<div class="fixed-empty"></div>
    <table class="table tb-type2 noborder search">
      ...
      <a class="btns" onclick="if (confirm('审核后将无法撤销，进入下一步付款环节，确认审核吗?')){return true;}else{return false;}" href="index.php?gct=bill&gp=bill_check&bill_id=<?php echo $_GET['bill_id'];?>"><span><?php echo $lang['nc_exdport'];?>审核</span></a>
       <?php }elseif ($output['bill_info']['ob_state'] == 3){?>
		<a class="btns" href="index.php?gct=bill&gp=bill_pay&bill_id=<?php echo $_GET['bill_id'];?>"><span><?php echo $lang['nc_exdport'];?>付款完成</span></a>
       <?php }elseif ($output['bill_info']['ob_state'] == 4){?>
      <a class="btns" target="_blank" href="index.php?gct=bill&gp=bill_print&bill_id=<?php echo $_GET['bill_id'];?>"><span><?php echo $lang['nc_exposrt'];?>打印</span></a>
      <?php }?>
      <a class="btns" target="_blank" href="index.php?gct=bill&gp=export_step1&bill_id=<?php echo $_GET['bill_id'];?>"><span><?php echo $lang['nc_exposrt'];?>导出结算明细</span></a>
      </td></tr>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="bill" />
    <input type="hidden" name="gp" value="show_store_month_order" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td>
        <a href="index.php?gct=order&gp=show_order&order_id=<?php echo $order['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php }?>
      <?php }else{?>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="gp"]').val('show_store_month_order');$('#formSearch').submit();
    });
});
</script>
