  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=circle_setting&gp=seo"><span><?php echo $lang['circle_setting_seo'];?></span></a></li>
        <li><a href="index.php?gct=circle_setting&gp=sec"><span><?php echo $lang['circle_setting_sec'];?></span></a></li>
        <li><a href="index.php?gct=circle_setting&gp=exp"><span><?php echo $lang['circle_setting_exp'];?></span></a></li>
        <li><a href="index.php?gct=circle_setting&gp=superadd"><span><?php echo $lang['circle_setting_supperadmin'];?></span></a></li>
        <li><a href="index.php?gct=circle_setting&gp=super_list"><span><?php echo $lang['circle_supperadmin_list'];?></span></a></li>
      </ul>
    </div>
  </div>
