...
<div class="page">
  ...
  <form id="search_form" method="get" name="formSearch">
    <input type="hidden" id="gct" name="gct" value="inform" />
    <input type="hidden" id="gp" name="gp" value="inform_list" />
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a href="index.php?gct=inform&gp=inform_list" class="btns " title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php } ?></td>
        </tr>
      </tbody>
    </table>
  ...
  <form method='post' id="list_form" action="index.php?gct=voucher_price&gp=voucher_price_drop">
        ...
        <tr class="line">
          ...
          <td><?php 
                        if(empty($v['inform_pic1'])&&empty($v['inform_pic2'])&&empty($v['inform_pic3'])) {
                            ...
                            $pic_link = 'index.php?gct=show_pics&type=inform&pics=';
          ...
          <td><a href="JavaScript:void(0);" class="show_detail"><?php echo $lang['nc_detail'];?></a> <a href="index.php?gct=inform&gp=show_handle_page&inform_id=<?php echo $v['inform_id'];?>&inform_goods_name=<?php echo $v['inform_goods_name'];?>"><?php echo $lang['inform_text_handle'];?></a></td>
        </tr>
