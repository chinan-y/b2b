  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=circle_class&gp=class_add" ><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="circle_class">
    <input type="hidden" name="gp" value="class_list">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center power-onoff"><?php if($v['class_status'] == 0){ ?>
            ...
            <?php } ?></td>
          <td class="w84"><a href="index.php?gct=circle_class&gp=class_edit&classid=<?php echo $v['class_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?gct=circle_class&gp=class_del&classid=<?php echo $v['class_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
