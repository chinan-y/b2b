...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=live_order&gp=del_order');
        $('#order_id').val(id);
        $('#list_form').submit();
    }
}
...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="live_order" />
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
		  ...
		  <td class='align-center'><a href="index.php?gct=live_order&gp=order_detail&order_id=<?php echo $val['order_id'];?>">查看</a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
