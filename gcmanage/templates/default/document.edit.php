...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=document&gp=document"><span><?php echo $lang['nc_manage'];?></span></a></li>
      </ul>
    </div>
  </div>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?gct=document&gp=document_pic_upload&item_id=<?php echo $output['doc']['doc_id'];?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('index.php?gct=document&gp=ajax&branch=del_file_upload&file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
