...
$(document).ready(function(){
    //行内ajax编辑
    $('span[nc_type="adv_sort"]').inline_edit({gct: 'microshop',gp: 'adv_sort_update'});
});
...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?gct=microshop&gp=adv_drop');
        $('#adv_id').val(id);
        $('#list_form').submit();
    }
}
...
<div class="page">
  ...
  <div class="fixed-empty"></div>
    <form method="get" name="formSearch">
        ...
        <input type="hidden" value="adv_manage" name="gp">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center">
              <a href="index.php?gct=microshop&gp=adv_edit&adv_id=<?php echo $val['adv_id'];?>"><?php echo $lang['nc_edit'];?></a> 
