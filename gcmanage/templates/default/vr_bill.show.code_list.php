...
<h4>兑换码列表</h4>
<ul class="tab-menu">
<li class="<?php echo $_GET['query_type'] == 'timeout' ? '' : 'current';?>"><a href="index.php?gct=vr_bill&gp=show_bill&ob_no=<?php echo $_GET['ob_no'];?>&query_type=">已使用</a></li>
<li class="<?php echo $_GET['query_type'] == 'timeout' ? 'current' : '';?>"><a href="index.php?gct=vr_bill&gp=show_bill&ob_no=<?php echo $_GET['ob_no'];?>&query_type=timeout">已过期</a></li>
</ul>
</div>

<div style="text-align:right;">
<a class="btns" href="index.php?gct=vr_bill&gp=show_bill&ob_no=<?php echo $_GET['ob_no'];?>&query_type=<?php echo $_GET['query_type'];?>&gp=export_order" target="_blank">
<span>导出CSV</span>
</a>
</div>
...
<table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td>
        <a href="index.php?gct=vr_order&gp=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php }?>
      <?php }else{?>
