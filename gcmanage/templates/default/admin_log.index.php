...
<div class="page">
  ...
  <form method="get" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="admin_log">
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
		  ...
		  <th><?php echo '行为内容';?></th>
          <td><input class="txt" name="admin_content" value="<?php echo $_GET['admin_content'];?>" type="text"></td>
  ...
  <form method="post" id='form_list' action="index.php?gct=admin_log&gp=list_del">
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="gp"]').val('list');
    	$('#formSearch').submit();
    });
    $('#ncdelete').click(function(){
        $('#delago').val($('#delago1').val());
    	$('input[name="gp"]').val('list_del');$('#formSearch').submit();
    });
});
</script>
