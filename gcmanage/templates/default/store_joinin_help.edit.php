...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>店铺帮助</h3>
      <ul class="tab-base">
        <li><a href="index.php?gct=store_joinin&gp=edit_info"><span><?php echo '图片及提示';?></span></a></li>
        <li><a href="index.php?gct=store_joinin&gp=help_list"><span><?php echo '入驻指南';?></span></a></li>
...
$(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?gct=store_joinin&gp=upload_pic&item_id=<?php echo $output['help']['help_id']?>',
...
function del_file_upload(file_id){
    ...
    $.getJSON('index.php?gct=store_joinin&gp=del_pic&file_id=' + file_id, function(result){
        if(result){
            $('#pic_' + file_id).remove();
        }
    });
