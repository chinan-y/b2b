...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="gp" value="promotion" />
...
function getLineLabels(stattype){
	...
	if(!$("#"+stattype+'_div').html()){
		$("#"+stattype+'_div').load('index.php?gct=stat_marketing&gp=promotiontrend&search_type='+search_type+'&stattype='+stattype+'&t=<?php echo $output['searchtime'];?>');
	}
}
</script>