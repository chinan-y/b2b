...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var update_item_sort = function() {
            ...
            $.post("index.php?gct=mb_special&gp=update_item_sort", {special_id: special_id, item_id_string: item_id_string}, function(data) {
                if(typeof data.error != 'undefined') {
        ...
        $('#item_list').on('click', '[nctype="btn_usable"]', function() {
            ...
            $.post("index.php?gct=mb_special&gp=update_item_usable", {item_id: item_id, usable: usable, special_id: special_id}, function(data) {
                if(typeof data.error != 'undefined') {
                    showError(data.message);
                }
            }, 'json');
