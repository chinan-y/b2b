...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
      <li><a href="index.php?gct=points&gp=addpoints"><span><?php echo $lang['nc_manage']?></span></a></li>
  ...
  <form method="get" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="points">
    <input type="hidden" name="gp" value="pointslog">
        ...
        <tr>
          ...
          <td><input type="text" id="stime" name="stime" class="txt date" value="<?php echo $_GET['stime'];?>" >
            ...
            <input type="text" id="etime" name="etime" class="txt date" value="<?php echo $_GET['etime'];?>" ></td><td><select name="stage">
			  ...
			  <option value="sign" <?php if ($_GET['stage'] == 'sign'){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage_sign']; ?></option>
        ...
        <td class="align-center"><?php 
				switch ($v['pl_stage']){
              		case 'regist':
              			...
              			break;
					case 'sign':
              			echo $lang['admin_points_stage_sign'];
              			break;
					case 'browse':
						echo $lang['admin_points_browse_goods'];
						break;	
              		case 'login':
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="gp"]').val('pointslog');$('#formSearch').submit();
    });
});
</script>
