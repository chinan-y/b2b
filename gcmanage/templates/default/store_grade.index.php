  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=store_grade&gp=store_grade_add" ><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query']; ?>">&nbsp;</a>
            ...
            <a class="btns " href="index.php?gct=store_grade&gp=store_grade" title="<?php echo $lang['cancel_search'];?>"><span><?php echo $lang['cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w270"><a href="index.php?gct=store_grade&gp=store_grade_edit&sg_id=<?php echo $v['sg_id'];?>"><?php echo $lang['nc_edit'];?></a> |
            <?php if($v['sg_id'] == '1'){ ?>
            <?php echo $lang['default_store_grade_no_del'];?> |
            <?php }else { ?>
            <a href="javascript:if(confirm('<?php echo $lang['problem_del'];?>'))window.location = 'index.php?gct=store_grade&gp=store_grade_del&sg_id=<?php echo $v['sg_id'];?>';"><?php echo $lang['nc_del'];?></a> |
            <?php } ?>
            <a href="index.php?gct=store_grade&gp=store_grade_templates&sg_id=<?php echo $v['sg_id'];?>"><?php echo $lang['set_template'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
