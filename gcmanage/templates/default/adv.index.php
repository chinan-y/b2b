...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=adv&gp=ap_manage"><span><?php echo $lang['ap_manage'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['adv_manage'];?></span></a></li>
        <li><a href="index.php?gct=adv&gp=adv_add&ap_id=<?php echo $_GET['ap_id'];?>"><span><?php echo $lang['adv_add'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w72 align-center"><a href="index.php?gct=adv&gp=adv_edit&adv_id=<?php echo $v['adv_id'];?>"><?php echo $lang['adv_edit'];?></a>&nbsp;|&nbsp;<a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?gct=adv&gp=adv_del&adv_id=<?php echo $v['adv_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
