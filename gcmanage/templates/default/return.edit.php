...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=return&gp=return_manage"><span><?php echo '待审核';?></span></a></li>
        <li><a href="index.php?gct=return&gp=return_all"><span><?php echo '所有记录';?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo '审核';?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="post_form" method="post" action="index.php?gct=return&gp=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
