  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=sns_member&gp=tag_add"><span><?php echo $lang['nc_new'];?></span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        <tr class="hover edit">
          ...
          <td class="align-center yes-onoff"><?php if($v['mtag_recommend'] == 0){ ?>
            ...
            <?php } ?></td>
          <td class="w132 align-center"><a href="index.php?gct=sns_member&gp=tag_edit&id=<?php echo $v['mtag_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="index.php?gct=sns_member&gp=tag_del&id=<?php echo $v['mtag_id'];?>"><?php echo $lang['nc_del'];?></a> | <a href="index.php?gct=sns_member&gp=tag_member&id=<?php echo $v['mtag_id'];?>"><?php echo $lang['sns_member_view_member'];?></a></td>
        </tr>
        <?php } ?>
      </tbody>
      <tfoot>
