...
<div class="page">
  ...
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="groupbuy">
    <input type="hidden" name="gp" value="groupbuy_list">
  ...
  <form id="list_form" method="post">
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
          <td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?gct=show_groupbuy&gp=groupbuy_detail&group_id=".$val['groupbuy_id'];?>"><img src="<?php if(C(OSS_IS_STORAGE) == 0){echo gthumb($val['groupbuy_image'], 'small');} if(C(OSS_IS_STORAGE) == 1){echo gthumb($val['groupbuy_image'], '32');}?>" style=" max-width: 56px; max-height: 56px;"/></a></span></div></td>
          <td class="group"><p><a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?gct=show_groupbuy&gp=groupbuy_detail&group_id=".$val['groupbuy_id'];?>"><?php echo $val['groupbuy_name'];?></a></p>
            <p class="goods"><?php echo $lang['groupbuy_index_goods_name'];?>:<a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?gct=goods&goods_id=".$val['goods_id'];?>" title="<?php echo $val['goods_name'];?>"><?php echo $val['goods_name'];?></a></p>
