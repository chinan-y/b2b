    ...
    <table class="tb-type1 noborder search">
      <tbody>
        ...
        <th><label for="add_time_from">订单类型</label></th>
          ...
          <a class="btns" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&gp=export_order"><span><?php echo $lang['nc_exposrt'];?>导出订单明细</span></a>
            </td>
        </tr>
      </tbody>
    </table>
...
<table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td>
        <a href="index.php?gct=order&gp=show_order&order_id=<?php echo $order_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php }?>
      <?php }else{?>
