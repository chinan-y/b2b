  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=web_config&gp=code_edit&web_id=<?php echo $_GET["web_id"];?>"><span><?php echo $lang['web_config_code_edit'];?></span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform" style=" height:48px;">
			  ...
			  <li class="white"><em></em><i class="icon-ok"></i><?php echo $lang['web_config_style_white'];?></li><!--add-->
