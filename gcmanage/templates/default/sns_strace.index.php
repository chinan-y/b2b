  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=sns_strace&gp=scomm_list"><span><?php echo $lang['admin_snstrace_commentlist'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
    <input type="hidden" name="gct" value="sns_strace">
    <input type="hidden" name="gp" value="stracelist">
            ...
            <li>
              <div class="fd-aside">
              	<span class="thumb size60">
					<a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=store_snshome&sid=<?php echo $v['strace_storeid'];?>" target="_blank">
              ...
              <dl class="fd-wrap">
                <dt>
					<h3><a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=store_snshome&sid=<?php echo $v['strace_storeid'];?>" target="_blank"><?php echo $v['strace_storename'];?></a><?php echo $lang['nc_colon'];?></h3>
...
function submit_form(type){
	if(type=='del'){
		...
		$('#form_trace').attr('action','index.php?gct=sns_strace&gp=strace_del');
	}else if(type=='hide'){
		$('#form_trace').attr('action','index.php?gct=sns_strace&gp=strace_edit&type=hide');
	}else{
		$('#form_trace').attr('action','index.php?gct=sns_strace&gp=strace_edit&type=show');
	}
	$('#form_trace').submit();
}
</script>