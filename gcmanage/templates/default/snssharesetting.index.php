    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="w156 align-center">
        	<?php if($v['isuse'] == '1'){ ?>
        		<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['shareset_list_closeprompt'];?>')){location.href='index.php?gct=sns_sharesetting&gp=set&state=0&key=<?php echo $k;?>'}"> <?php echo $lang['nc_close'];?></a>
        	<?php }else { ?>
        		<a href="index.php?gct=sns_sharesetting&gp=set&state=1&key=<?php echo $k;?>"><?php echo $lang['nc_open'];?></a>
        	<?php } ?>
        	| <a href="index.php?gct=sns_sharesetting&gp=edit&state=1&key=<?php echo $k; ?>"><?php echo $lang['nc_edit']?></a></td>
      </tr>
      <?php } } ?>
    </tbody>
    <tfoot>
