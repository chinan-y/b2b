...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?gct=db&gp=db" ><span><?php echo $lang['db_index_backup'];?></span></a></li>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w72 align-center"><span> <a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=db&gp=db_del&dir_name=<?php echo $v['name'];?>'};"><?php echo $lang['nc_del'];?></a>&nbsp;|&nbsp; <a href="javascript:if(confirm('<?php echo $lang['db_index_backup_tip'];?>?')){location.href='index.php?gct=db&gp=db_import&dir_name=<?php echo $v['name'];?>&step=1'};"><?php echo $lang['db_restore_import'];?></a> </span></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
