  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?gct=goods_address&gp=pic_list" ><span><?php echo $lang['g_album_pic_list'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method='post' id="picForm" name="picForm">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td><input value="<?php echo $v['id']?>" class="checkitem" type="checkbox" name="aclass_id[]"></td>
          <td><?php echo $v['address_name']?></td>
          <td class="align-center">&nbsp;<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?gct=goods_address&gp=aclass_del&aclass_id=<?php echo $v['id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
