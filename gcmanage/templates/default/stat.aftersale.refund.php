...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="gct" value="stat_aftersale" />
    <input type="hidden" name="gp" value="refund" />
...
$(function () {
	...
	$('#statlist').load('index.php?gct=stat_aftersale&gp=refundlist&t=<?php echo $output['searchtime'];?>');
