  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['region_index_import_tip'];?>?')){location.href='index.php?gct=flea_region&gp=flea_import_default_area';}"><span>导入全国地区数据[三级]</span></a></li>
      </ul>
    </div>
  </div>
...
function refreshdistrict(parent_id,type){
	...
	location.href='index.php?gct=flea_region&gp=flea_region&flea_area_parent_id='+parent_id+url;
}
