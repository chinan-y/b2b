  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['add_store'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    $('#store_form').validate({
        ...
        rules : {
            ...
            member_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : 'index.php?gct=ownshop&gp=check_member_name',
                    type: 'get',
                    data:{
            ...
            seller_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : 'index.php?gct=ownshop&gp=check_seller_name',
                    type: 'get',
                    data:{
