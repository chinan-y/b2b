...
$lang['aliyun_oss_set'] = 'OSS设置';
$lang['aliyun_other_set']        = '其他设置';
$lang['web_set']        = '站点设置';
...
$lang['pc_buy_switch']    	= 'PC端立即购买开关';
$lang['pc_cart_switch']    	= 'PC端加入购物车开关';
$lang['wap_buy_switch']   	= '手机端立即购买开关';
$lang['wap_cart_switch']    = '手机端加入购物车开关';
$lang['wap_register_way']   = '手机端注册方式开关';
...
$lang['GZ_ZHEKOU'] = '在本平台购买商品，用贵州银行卡支付时的打折活动设置';
$lang['groupbuy_allow'] = '抢购';
$lang['groupbuy_isuse_notice']    = '抢购功能启用后，商家通过活动发布抢购商品，进行促销';
$lang['tuangou_allow'] = '团购';
$lang['tuangou_isuse_notice']    = '团购功能启用后，商家通过活动发布团购商品，进行促销';
...
$lang['site_state']                         = '站点状态(全站)';
$lang['site_state_notice']                  = '可暂时将站点关闭，其他人无法访问，但不影响管理员访问后台';
$lang['site_state1']                        = '站点状态(购买板块)';
$lang['site_state_notice1']                 = '可暂时将商品购物车板块和购买功能关闭，其他人无法访问，但不影响管理员访问后台';
$lang['closed_reason']                      = '关闭原因';
$lang['closed_reason_notice']               = '当网站处于关闭状态时，关闭原因将显示在前台';
$lang['site_notice']                      	= '站点通告';
$lang['site_notice_notice']               	= '当网站系统时间处于开始和结束时间范围内时，站点公告将显示在前台';
...
$lang['points_number_browse']    			= '浏览商品';
$lang['points_number_browse_goods']    		= '浏览商品加积分';
$lang['points_number_browse_goods_one']    	= '浏览一次商品详情给用户加的积分';
$lang['points_number_browse_goods_day']    	= '每天浏览商品加积分上限';
$lang['points_number_browse_goods_up']   	= '每天浏览商品详情给用户加积分的上限';
...
//运营基本设置
$lang['operate_sell_rebate']			= '销售返利';
$lang['operate_consume_rebate']			= '消费返利';
$lang['operate_sell_rebate_memo']		= '销售返利功能开启后，拥有专属二维码的会员才能获得销售返利，后面的消费返利是设置销售员本身购买商品的返利率';
$lang['operate_onerank_rebate']			= '一级返利';
$lang['operate_tworank_rebate']			= '二级返利';
$lang['operate_threerank_rebate']		= '三级返利';
$lang['operate_onerank_rebate_memo']	= '一级返利开启后，会员的上一级用户才能获得销售返利，后面设置的是返利率';
$lang['operate_tworank_rebate_memo']	= '二级返利开启后，会员的上两级用户都将获得销售返利，后面设置的是返利率';
$lang['operate_threerank_rebate_memo']	= '三级返利开启后，会员的上三级用户都将获得销售返利，后面设置的是返利率';
$lang['operate_rebate_rate']			= '返利率';
