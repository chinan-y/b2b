...
$lang['admin_salescredit_unavailable']	 		= '系统未开启销售提成功能';
...
$lang['admin_salescredit_userrecord_error']		= '会员信息错误';
...
$lang['admin_salescredit_member_error_again']	= '会员信息错误，请重新填写会员名';
$lang['admin_points_points_null_error']		= '请添加积分值';
$lang['admin_points_points_min_error']		= '积分值必须大于0';
$lang['admin_salescredit_points_min_error']		= '数字必须大于0';
$lang['admin_points_points_short_error']	= '积分不足，会员当前积分数为';
$lang['admin_salescredit_points_short_error']	= '业绩不足，会员当前业绩为';
...
$lang['admin_salescredit_stage_regist']				= '注册';
$lang['admin_points_stage_sign']				= '签到';
$lang['admin_points_browse_goods']				= '浏览商品';
$lang['admin_points_stage_login']				= '登录';
$lang['admin_salescredit_stage_login']				= '登录';
$lang['admin_points_stage_comments']				= '商品评论';
$lang['admin_salescredit_stage_comments']				= '商品评论';
$lang['admin_points_stage_order']				= '订单消费';
$lang['admin_salescredit_stage_order']				= '订单消费';
$lang['admin_points_stage_system']				= '积分管理';
$lang['admin_points_cash']						= '积分抵现';
$lang['admin_salescredit_stage_system']				= '业绩管理';
$lang['admin_points_stage_pointorder']		= '礼品兑换';
$lang['admin_salescredit_stage_pointorder']		= '直接消费';
$lang['admin_points_stage_app']		= '积分兑换';
$lang['admin_salescredit_stage_app']		= '业绩兑换';
$lang['admin_points_addtime']				= '添加时间';
$lang['admin_salescredit_addtime']				= '添加时间';
$lang['admin_points_addtime_to']				= '至';
$lang['admin_salescredit_addtime_to']				= '至';
$lang['admin_points_log_help1']				= '积分明细，展示了被操作人员（会员）、操作人员（管理员）、操作积分数（积分值，“-”表示减少，无符号表示增加）、操作时间（添加时间）等信息';
$lang['admin_salescredit_log_help1']		= '业绩明细，展示了被操作人员（会员）、操作人员（管理员）、操作数据（业绩值，“-”表示减少，无符号表示增加）、操作时间（添加时间）等信息';
