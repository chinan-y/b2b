...
define('DS','/');
define('GcWebShop',true);
define('StartTime',microtime(true));
define('TIMESTAMP',time());
define('DIR_SHOP','gcshop');
define('DIR_CMS','cms');
...
//海关2.0系统支持跨境保税和海外直邮
//网购保税进口（跨境）海关2.0计税
define('GOODS_FROM_1', 1);
//直购进口（跨境）海关2.0计税
define('GOODS_FROM_2', 2);
//海外进口，商品已经进过海关相关系统，属于普通商品
define('GOODS_FROM_3', 3);
//海外直邮	行邮直邮
define('GOODS_FROM_4', 4);
//外贸进口	完税商品，不需要再算税
define('GOODS_FROM_5', 5);
//国内贸易	国内商品，如名优特产，不涉及出口
define('GOODS_FROM_6', 6);
//B2B跨境进口
define('GOODS_FROM_8', 8);
//三方保税供货	如悦惠淘，深圳海外供货属于普通商品

/**
 * 运费模版类型
 */
//模版按重量计费
define('TRANSPORT_TYPE_0', 0);
//模版按件数计费
define('TRANSPORT_TYPE_1', 1);
