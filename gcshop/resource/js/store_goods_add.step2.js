$(function(){
	...
	var commonid = getParam('commonid');
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url: SITEURL + '/index.php?gct=store_goods_add&gp=image_upload&upload_type=uploadedfile',
        formData: {name:'goods_image', commonid:commonid},
        add: function (e,data) {
    ...
    $('#add_album').fileupload({
        dataType: 'json',
        url: SITEURL+'/index.php?gct=store_goods_add&gp=image_upload',
        formData: {name:'add_album', commonid:commonid},
        add: function (e,data) {
    ...
    $('#g_deliverdate1').datepicker({dateFormat: 'yy-mm-dd', minDate: new Date()});
    ...
    $('a[nctype="mb_add_img"]').click(function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?gct=store_album&gp=pic_list&commonid='+commonid+'&item=mobile');
    });
    // 关闭 图片选择
    ...
    $('div[nctype="mobile_pannel"]').on('click', 'a[nctype="mp_rpl"]', function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?gct=store_album&gp=pic_list&commonid='+commonid+'&item=mobile&type=replace');
    });
    // 插图图片
