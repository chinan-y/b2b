...
//zmr<<<
$tbconfig =array();
$tbconfig['web_root'] = '../../../data/upload/gcshop/store/goods/';//上传图片的存放位置。默认存放在/data/upload/gcshop/store/goods/ 目录下，如果你未更改，则此处无需修改。默认存放位置在 /global.php文件中定义，由define('DIR_UPLOAD','data/upload'); define('ATTACH_GOODS','gcshop/store/goods');共同决定。
