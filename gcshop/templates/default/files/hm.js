(function() {
	var h = {},
		mt = {},
		c = {
			id: "c9dc11ac0937a0269aea6bb426ce581d",
			dm: ["xgqqg.com"],
	...
	(mt.p.ya = function() {
		...
		(function() {
			if (!f)
				if (f = p, "complete" === document.readyState) a.z = p;
				else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
				k, r), window.addEventListener("load", a, r);
		...
		return function(d) {
			switch (typeof d) {
				...
				default:
					...
					e = mt.l.stringify;
					for (l in d)
						if (Object.prototype.hasOwnProperty.call(d, l)) switch (g =
							d[l], typeof g) {
							case "undefined":
							case "unknown":
							case "function":
	...
	(function() {
		...
		(function() {
			...
			"object" == typeof document.onfocusin ? (k.e(document, "focusin", d), k.e(document, "focusout", d)) : (k.e(window, "focus", d),
				k.e(window, "blur", d))
		})();
		h.F = {
			oa: function() {
					...
					if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
						...
						if (a && a.length)
							for (var b = 0, d = a.length; b < d; b++) f.d(a[b],
								"Array") && "_trackEvent" !== a[b][0] && "_trackRTEvent" !== a[b][0] ? e.K(a[b]) : e.q.push(a[b]);
						window._hmt = e.R
					}
				},
				ia: function() {
					if (0 < e.q.length)
						for (var a = 0, b = e.q.length; a < b; a++) e.K(e.q[a]);
					e.q = q
				},
				K: function(a) {
					if (f.d(a, "Array")) {
				...
				_trackRTEvent: function(b) {
					...
					if (f.d(b, "Object")) {
						...
						if (900 >= l) m.call(this, b);
							...
							for (var l = Math.ceil(l / 900), t = "block|" + Math.round(Math.random() * k.A).toString(16) + "|" + l + "|", s = [], u = 0; u < l; u++) s.push(u), s.push(b.substring(900 * u, 900 * u + 900)), m.call(this, t + s.join("|")),
								s = []
					}
				},
	...
	(function() {
		...
		a.prototype = {
			...
			init: function() {
				try {
					this.Ea(), 0 === this.a.nv ? this.Ca() : this.M(".*"), h.b = this, this.aa(),
						v.r("pv-b"), this.Ba()
				} catch (a) {
					var b = [];
					b.push("si=" + c.id);
			...
			aa: function() {
				...
				a && (d.test(a) && f && k) && (a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", m.protocol + "//" + c.js + e + ".js?" + this.a.rnd), e = document.getElementsByTagName("script")[0], e.parentNode.insertBefore(a,
					e))
			},
			Y: function(a) {
				...
				v = function(b, d) {
					...
					if (a.d(d, "Array") || a.d(d, "NodeList"))
						for (var f = 0, k = d.length; f < k; f++)
							if (g === d[f]) return e(m + b + "/" + (f + 1), d[f]), r
				};
