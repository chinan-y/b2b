  ...
  <div class="content">
    ...
    <div class="ncs-search">
      <form id="" name="searchShop" method="get" action="index.php" >
        <input type="hidden" name="gct" value="show_store" />
        <input type="hidden" name="gp" value="goods_all" />
      ...
      <ol>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-pic"><a href="<?php echo urlShop('goods', 'index', array('goods_id'=>$val['goods_id'],'ref' => $_SESSION['member_id']));?>"><span class="thumb size40"><i></i><img src="<?php echo thumb($val, 240);?>"  onload="javascript:DrawImage(this,160,160);"></span></a>
			...
			<?php }else{ ?>
			   <dt><a href="index.php?gct=goodsdetail&gp=goodsdetail&goods_id=<?php echo $val['goods_id'];?>"><?php echo $val['goods_name']?></a></dt>
               <dd class="goods-pic"><a href="index.php?gct=goodsdetail&gp=goodsdetail&goods_id=<?php echo $val['goods_id'];?>"><span class="thumb size40"><i></i><img src="<?php echo thumb($val, 240);?>"  onload="javascript:DrawImage(this,160,160);"></span></a>
               <!--<p><span class="thumb size100"><i></i><img src="<?php echo thumb($val, 240);?>" onload="javascript:DrawImage(this,100,100);" title="<?php echo $val['goods_name']?>"><big></big><small></small></span></p>-->
               </dd>		
			<?php } ?>
			<?php if($val['store_from']!=6){ ?>
      ...
      <ol>
        ...
        <li>
          <dl>
		    <?php if($val['store_from']!=6){ ?>
            <dt><a href="<?php echo urlShop('goods', 'index', array('goods_id'=>$val['goods_id'],'ref' => $_SESSION['member_id']));?>"><?php echo $val['goods_name']?></a></dt>
            <dd class="goods-pic"><a href="<?php echo urlShop('goods', 'index', array('goods_id'=>$val['goods_id'],'ref' => $_SESSION['member_id']));?>" title=""><span class="thumb size40"><i></i> <img src="<?php echo thumb($val, 240);?>" onload="javascript:DrawImage(this,160,160);"></span></a>
              <!--<p><span class="thumb size100"><i></i><img src="<?php echo thumb($val, 240);?>" onload="javascript:DrawImage(this,100,100);" title="<?php echo $val['goods_name']?>"><big></big><small></small></span></p>-->
            </dd>
			<?php }else{ ?>
				<dt><a href="index.php?gct=goodsdetail&gp=goodsdetail&goods_id=<?php echo $val['goods_id'];?>"><?php echo $val['goods_name']?></a></dt>
				<dd class="goods-pic"><a href="index.php?gct=goodsdetail&gp=goodsdetail&goods_id=<?php echo $val['goods_id'];?>" title=""><span class="thumb size40"><i></i> <img src="<?php echo thumb($val, 240);?>" onload="javascript:DrawImage(this,160,160);"></span></a>
				<!--<p><span class="thumb size100"><i></i><img src="<?php echo thumb($val, 240);?>" onload="javascript:DrawImage(this,100,100);" title="<?php echo $val['goods_name']?>"><big></big><small></small></span></p>-->
				</dd>
			<?php } ?>
			<?php if($val['store_from']!=6){ ?>
