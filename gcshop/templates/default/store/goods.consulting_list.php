...
<div class="wrapper">
  <div class="ncs-goods-layout expanded" >
    <div class="ncs-goods-main">
          ...
          <div class="ncs-cosult-list">
            <dl class="asker">
              ...
              <dd>
                ...
                <?php }else{?>
                <a href="index.php?gct=member_snshome&mid=<?php echo $v['member_id'];?>" target="_blank" data-param="{'id':<?php echo $v['member_id'];?>}" nctype="mcard"><?php echo str_cut($v['member_name'],8);?></a>
                <?php }?>
      ...
      <form method="post" id="message" action="index.php?gct=goods&gp=save_consult">
        ...
        <div class="ncs-consult-form">
          ...
          <dl>
            ...
            <dd>
              ...
              <div class="code">
                <div class="arrow"></div>
                <div class="code-img"><a href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?gct=seccode&gp=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();"><img src="index.php?gct=seccode&gp=makecode&nchash=<?php echo getNchash();?>" name="codeimage" border="0" id="codeimage" onclick="this.src='index.php?gct=seccode&gp=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random()"/></a></div>
                <a href="JavaScript:void(0);" id="hide" class="close" title="关闭"><i></i></a> <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?gct=seccode&gp=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['goods_index_change_checkcode'];?>"><i></i></a> </div>
              <?php } ?>
