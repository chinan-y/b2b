...
<?php } ?>
    ...
    <div class="gcshop-other" id="gcshop-other">
    <ul>
...
$(function(){
	...
	var gct = "<?php echo trim($_GET['gct']); ?>";
	var gp  = "<?php echo trim($_GET['gp']) != ''?trim($_GET['gp']):'index'; ?>";
	$.getJSON("index.php?gct=show_store&gp=ajax_flowstat_record",{store_id:store_id,goods_id:goods_id,act_param:gct,op_param:gp});
});
</script>
