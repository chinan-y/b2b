...
<div class="ncsc-form-default">
    ...
    <form id="add_form" action="index.php?gct=store_promotion_xianshi&gp=xianshi_save" method="post">
    <?php } else { ?>
    <form id="add_form" action="index.php?gct=store_promotion_xianshi&gp=xianshi_edit_save" method="post">
