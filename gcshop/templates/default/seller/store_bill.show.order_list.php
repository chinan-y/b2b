<?php defined('GcWebShop') or exit('Access Invalid!');?>
  <form method="get" id="formSearch">
    <table class="search-form">
      <input type="hidden" id='gct' name='gct' value='store_bill' />
...
<table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
       	<a target="_blank" href="index.php?gct=store_order&gp=show_order&order_id=<?php echo $order_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
