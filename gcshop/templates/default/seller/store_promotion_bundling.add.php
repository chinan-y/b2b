...
<div class="wrap">
  ...
  <div class="ncsc-form-default"> 
    ...
    <form id="add_form" method="post" action="index.php?gct=store_promotion_bundling&gp=bundling_add">
      ...
      <dl>
        ...
        <dd>
          ...
          <a id="bundling_add_goods" href="index.php?gct=store_promotion_bundling&gp=bundling_add_goods" class="ncsc-btn ncsc-btn-acidblue"><?php echo $lang['bundling_goods_add'];?></a>
