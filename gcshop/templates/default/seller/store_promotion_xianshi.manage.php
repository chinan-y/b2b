...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //渲染限时折扣商品列表
        xianshi_goods_array = $.parseJSON('<?php echo addslashes(json_encode($output['xianshi_goods_list']));?>');
...
<div class="bottom">
  <label class="submit-border"><input type="submit" class="submit" id="submit_back" value="<?php echo $lang['nc_back'].$lang['xianshi_index'];?>" onclick="window.location='index.php?gct=store_promotion_xianshi&gp=xianshi_list'"></label>
</div>
...
<tr class="bd-line">
    <td></td>
    <td><div class="pic-thumb"><a href="<%=goods_url%>" target="_blank"><img src="<%=image_url%>" alt="<%=goods_name%>"></a></div></td>
