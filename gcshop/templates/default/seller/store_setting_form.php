...
<div class="ncsc-form-default">
  <form method="post"  action="index.php?gct=store_setting&gp=store_setting" enctype="multipart/form-data" id="my_store_form">
    ...
    <dl>
     ...
     <dl>
      <dt>店铺二维码：</dt>
      <dd>
         <p><img src="<?php echo storeQRCode($output['store_info']['store_id']);?>"  title="店铺原始地址<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id']));?>"></p>
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'index.php?gct=cut&gp=pic_upload&form_submit=ok&uploadpath=<?php echo ATTACH_STORE;?>',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['nc_cut'];?>','index.php?gct=cut&gp=pic_cut&x=100&y=100&resize=1&url='+data.url,680);
					}else{
