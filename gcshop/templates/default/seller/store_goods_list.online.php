...
<div class="tabmenu">
 ...
 <!-- //zmr>v30-->
  <a title="批量生成商品二维码" class="ncsc-btn ncsc-btn-green" href="index.php?gct=store_goods_online&amp;gp=maker_qrcode" target="_blank" style="right:100px" onclick="return confirm('您确定要执行批量生成二维码吗？');">批量生成商品二维码</a>
...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="gct" value="store_goods_online" />
    ...
    <tr>
      ...
      <th> <select name="search_type">
		  <option value="0" <?php if ($_GET['type'] == 0) {?>selected="selected"<?php }?>><?php echo $lang['store_goods_index_goods_no'];?></option>
          <option value="1" <?php if ($_GET['type'] == 1) {?>selected="selected"<?php }?>><?php echo $lang['store_goods_index_goods_name'];?></option>
...
<table class="ncsc-default-table">
  <thead>
    <tr nc_type="table_header">
      ...
      <th class="w100"><?php echo $lang['store_goods_index_delivery_depot'];?></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="goods-time"><?php echo $output['regions'][$output['transports'][$val['transport_id']]['region_id']]['address_name'];?></td>
      <td class="nscs-table-handle"><?php if ($val['goods_lock'] == 0) {?>
        <span><a href="<?php echo urlShop('store_goods_online', 'edit_goods', array('commonid' => $val['goods_commonid'],'goods_id' => $output['storage_array'][$val['goods_commonid']]['goods_id']));?>" class="btn-blue"><i class="icon-edit"></i>
