...
<div class="ncsc-form-default">
  <form method="post" id="tpl_form" name="tpl_form" action="index.php?gct=store_transport&gp=save">
    ...
    <dl>
      <dt>
        <label for="J_TemplateTitle" class="label-like"><?php echo '计费类型'.$lang['nc_colon'];?></label>
      </dt>
      <dd>
        <select class="text" id="transport_type" name="transport_type"><option value="">请选择</option><?php foreach($output['transport_type'] as $k=>$v){if($output['transport']['type']==$v['id']){echo '<option selected="selected" value="'.$v['id'].'">'.$v['name'].'</option>';}else{echo '<option value="'.$v['id'].'">'.$v['name'].'</option>';}}?></select>
      </dd>
    </dl>
    <dl>
      <dt>
        <label for="J_TemplateTitle" class="label-like"><?php echo '保税仓'.$lang['nc_colon'];?></label>
      </dt>
      <dd>
        <select class="text" id="region_id" name="region_id"><option value="">请选择</option><?php foreach($output['regions'] as $k=>$v){if($output['transport']['region_id']==$k){echo '<option selected="selected" value="'.$k.'">'.$v['address_name'].'</option>';}else{echo '<option value="'.$k.'">'.$v['address_name'].'</option>';}}?></select>
      </dd>
    </dl>
    <dl>
