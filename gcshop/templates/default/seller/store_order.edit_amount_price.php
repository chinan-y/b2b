...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?gct=store_order&gp=change_state&state_type=edit_amount_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
