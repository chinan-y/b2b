...
$(document).ready(function() {
    ...
    function change_seccode() {
        $('#codeimage').attr('src', 'index.php?gct=seccode&gp=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random());
        $('#captcha').select();
    }
...
<br/>
  ...
  <div class="ncsc-login-title">
    <h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp商家管理中心</h2>
   </div>
 
<br/>
  <form id="form_login" action="index.php?gct=seller_login&gp=login" method="post" >
    ...
    <div class="input">
      ...
      <div class="code">
        <div class="arrow"></div>
        <div class="code-img"><a href="javascript:void(0)" nctype="btn_change_seccode"><img src="index.php?gct=seccode&gp=makecode&nchash=<?php echo $output['nchash'];?>" name="codeimage" border="0" id="codeimage"></a></div>
