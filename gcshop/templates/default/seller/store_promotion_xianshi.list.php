...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="gct" value="store_promotion_xianshi" />
    <input type="hidden" name="gp" value="xianshi_list" />
    <tr>
      <td>&nbsp;</td>
      <th>状态</th>
  ...
  <tbody id="xianshi_list">
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle tr">
          <?php if($val['editable']) { ?>
          <span>
              <a href="index.php?gct=store_promotion_xianshi&gp=xianshi_edit&xianshi_id=<?php echo $val['xianshi_id'];?>" class="btn-blue">
                  <i class="icon-edit"></i>
          ...
          <?php } ?>
          <span>
              <a href="index.php?gct=store_promotion_xianshi&gp=xianshi_manage&xianshi_id=<?php echo $val['xianshi_id'];?>" class="btn-green">
                  <i class="icon-cog"></i>
