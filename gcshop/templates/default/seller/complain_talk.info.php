...
<?php } ?>
<form action="index.php?gct=store_complain&gp=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?gct=store_complain&gp=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?gct=store_complain&gp=publish_complain_talk',
                cache:false,
