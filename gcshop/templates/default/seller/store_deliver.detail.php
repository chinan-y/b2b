...
<div class="ncsc-flow-layout">
  <div class="ncsc-flow-container">
    ...
    <p>物流信息由&nbsp;&nbsp;<a href="http://www.kuaidi100.com/" target="_blank">快递100</a>&nbsp;&nbsp;提供，请复制物流单号&nbsp;&nbsp;<a onclick="copy_code('<?php echo $output['order_info']['shipping_code']?>');return false;" title="点击复制" href="javascript:;"><?php echo $output['order_info']['shipping_code']?></a>&nbsp;&nbsp;到&nbsp;&nbsp;<a href="http://www.kuaidi100.com/" target="_blank">快递100</a>&nbsp;&nbsp;查询查询物流详情<br/>以上部分信息来自于第三方，仅供参考，如需准确信息可联系卖家或物流公司</p>
  </div>
...
$(function(){
	...
	$.getJSON('index.php?gct=store_deliver&gp=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
		if(data){
			data = var_send+data;
