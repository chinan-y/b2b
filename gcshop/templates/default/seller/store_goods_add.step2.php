...
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
	  ...
	  <dl>
        <dt>自定义分类<?php echo $lang['nc_colon'];?></dt>
        <dd>
		  ...
		  <select name="g_fenlei">
			...
			<option value="母婴">1|母婴</option>
			<option value="保健">2|保健</option>
			<option value="个护">3|个护</option>
			<option value="美食">4|美食</option>
			<option value="家居">5|家居</option>
			<option value="服饰">6|服饰</option>
			<option value="彩妆">7|彩妆</option>
			<option value="箱包">8|箱包</option>
			<option value="新品">9|新品</option>
			<option value="其他">10|其他</option>
          </select>
          <span></span>
		  <p class="hint">分类：1、母婴；2、保健；3、个护；4、美食；5、家居；6、服饰；7、彩妆；8、箱包；9、新品；10、其他</p>
        </dd>
      </dl>
	  <dl>
        <dt>自定义排序<?php echo $lang['nc_colon'];?></dt>
        <dd>
	  ...
	  <dl>
        ...
        <dd>
		  ...
		  请输入关键字搜索:&nbsp;<input id="search_input1" type="text" class="search_input"/>
          <div id="search_box1" class="search_box">
            <ul id="hot_word_list1" class="hot_word_list">
            </ul>
          </div>
          <span></span> 
		  <p class="hint">用于前端页面显示使用</p>
        </dd>
	  </dl>
	  <dl>
      ...
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i>总库存<?php echo $lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
      ...
      <dl>
        <dt>商品有效期<?php echo $lang['nc_colon'];?></dt>
        <dd>
          ...
          <div class="tabs">
            ...
            <div id="panel-1" class="ui-tabs-panel" jquery1239647486215="4">
              ...
              <div class="hr8">
                ...
                <a class="ncsc-btn mt5" nctype="show_desc" href="index.php?gct=store_album&gp=pic_list&item=des"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a> <a href="javascript:void(0);" nctype="del_desc" class="ncsc-btn mt5" style="display: none;"><i class=" icon-circle-arrow-up"></i>关闭相册</a> </div>
              <p id="des_demo"></p>
            </div>
      ...
      <dl>
        ...
        <dd>
          ...
          <span></span>
          <p class="hint">单个商品返利率，填写小数，可保留三位小数，不填写默认为0不返利，如0.20则表示返利给二维码专属销售员20%的商品返利。</p>
        </dd>
      </dl>
      
	  <dl>
        <dt>SEO title关键词<?php echo $lang['nc_colon'];?></dt>
        <dd>
	  ...
	  <dl>
        <dt>SEO keywords关键词<?php echo $lang['nc_colon'];?></dt>
        <dd>
	  ...
	  <dl>
        <dt>SEO description关键词<?php echo $lang['nc_colon'];?></dt>
        <dd>
    ...
    <div class="bottom tc hr32">
      <label class="submit-border">
        <input type="submit" class="submit" id ="submit" value="<?php if ($output['edit_goods_sign']) {echo '提交';} else {?><?php echo $lang['store_goods_add_next'];?>，上传商品图片<?php }?>" />
      </label>
    </div>
  </form>
</div>
