...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name='gct' value='store_complain' />
    <tr>
      <td>&nbsp;</td>
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php
				...
				?></td>
      <td class="nscs-table-handle"><span><a href="index.php?gct=store_complain&gp=complain_show&complain_id=<?php echo $val['complain_id'];?>" class="btn-orange"><i class="icon-eye-open"></i>
