<?php defined('GcWebShop') or exit('Access Invalid!');?>
  <div class="tabmenu">
    ...
    <a class="ncsc-btn ncsc-btn-green" href="index.php?gct=store_livegroup&gp=groupbuy_add" title=""><i class="icon-plus-sign"></i>新增线下抢</a>
  </div>
  ...
  <form method="get">
    <table class="search-form">
      <input type="hidden" id='gct' name='gct' value='store_livegroup' />
      <input type="hidden" id='gp' name='gp' value='store_livegroup' />
      <tr>
        <td>&nbsp;</td>
        <td></td>
        <th>审核状态</th>
    ...
    <tbody>
      ...
      <td><div class="pic-thumb"><a href="<?php echo urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$val['groupbuy_id']));?>" target="_blank"><img src="<?php echo lgthumb($val['groupbuy_pic'], 'small');?>"/></a></div></td>
        ...
        <td>
        	...
        	<a href="index.php?gct=store_livegroup&gp=edit_livegroupbuy&groupbuy_id=<?php echo $val['groupbuy_id'];?>">编辑</a>&nbsp;|&nbsp;
...
function delgroup(group_id){
	if(confirm('确认删除该抢购?')){
		location.href = 'index.php?gct=store_livegroup&gp=delgroup&groupbuy_id='+group_id;
	}	
}
</script>
