      ...
      <div class="ncsc-goodspic-list">
        ...
        <ul nctype="ul<?php echo $value['sp_value_id'];?>">
          ...
          <li class="ncsc-goodspic-upload">
            <div class="upload-thumb"><img src="<?php echo cthumb($output['img'][$value['sp_value_id']][$i]['goods_image'], 240 , $output['store_id'], $output['commonid'] );?>" nctype="file_<?php echo $value['sp_value_id'] . $i;?>">
        ...
        <div class="ncsc-select-album">
          <a class="ncsc-btn" href="index.php?gct=store_album&gp=pic_list&item=goods_image&color_id=<?php echo $value['sp_value_id'];?>" nctype="select-<?php echo $value['sp_value_id'];?>"><i class="icon-picture"></i>从图片空间选择</a>
