...
<div class="ncsc-flow-item">
  ...
  <div class="item-order">
    ...
    <dl class="line">
      ...
      <dd><a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=store_order&gp=show_order&order_id=<?php echo $output['order']['order_id'];?>" target="_blank"> <?php echo $output['order']['order_sn'];?> </a><a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
        ...
        <div class="more"><span class="arrow"></span>
          <ul>
            ...
            <li>联系电话：<span><?php echo $output['order_common']['reciver_info']['phone'];?></span></li>
			 <li>身份证号码：<span><?php echo $output['order_common']['reciver_idnum'];?></span></li>
          </ul>
        </div>
        </a>
