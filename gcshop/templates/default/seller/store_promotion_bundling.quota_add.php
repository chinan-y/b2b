...
<div class="ncsc-form-default">
  ...
  <form id="add_form" action="index.php?gct=store_promotion_bundling&gp=bundling_quota_add" method="post">
  <?php } else {?>
  <form id="add_form" action="index.php?gct=store_promotion_bundling&gp=bundling_renew" method="post">
  <?php }?>
