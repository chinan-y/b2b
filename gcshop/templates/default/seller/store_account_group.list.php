...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="ncsc-btn ncsc-btn-green" onclick="go('index.php?gct=store_account_group&gp=group_add');" title="添加账号"><i class="icon-group"></i>添加组</a> </div>
