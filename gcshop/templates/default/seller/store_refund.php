...
<form method="get" action="index.php">
  <input type="hidden" name="gct" value="store_refund" />
  ...
  <tbody>
    ...
    <tr class="bd-line" >
      ...
      <td class="nscs-table-handle"><?php if ($val['seller_state'] == 1) { ?>
    	<span><a href="index.php?gct=store_refund&gp=edit&refund_id=<?php echo $val['refund_id']; ?>" class="btn-blue"><i class="icon-edit"></i><p>处理</p></a></span>
    	<?php } else { ?>
    	<span><a href="index.php?gct=store_refund&gp=view&refund_id=<?php echo $val['refund_id']; ?>" class="btn-orange"><i class="icon-eye-open"></i><p><?php echo $lang['nc_view'];?></p></a></span><?php } ?>
       </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
