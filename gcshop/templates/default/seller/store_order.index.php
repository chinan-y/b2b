...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="gct" value="store_order" />
...
<span class="fr mr5"> <a href="index.php?gct=store_order_print&order_id=<?php echo $order_id;?>" class="ncsc-btn-mini" target="_blank" title="打印发货单"/><i class="icon-print"></i>打印发货单</a></span>
 </th>
    </tr>
    <?php $i = 0;?>
    ...
    <tr>
      ...
      <td class="tl"><dl class="goods-name">
		  ...
		  <dd>商家货号：<?php echo $goods['goods_serial']; ?></dd>
        </dl></td>
          ...
          <div class="buyer-info"> <em></em>
            <div class="con">
              ...
              <dl>
                ...
                <dd><?php echo $order['extend_order_common']['reciver_name'];?>&nbsp;&nbsp;<?php echo $order['extend_order_common']['reciver_idnum'];?></dd>
              </dl>
              <dl>
      ...
      <td class="bdl bdr" rowspan="<?php echo $order['goods_count'];?>"><p><?php echo $order['state_desc']; ?>
        ...
        <!-- 订单查看 -->
        <p><a href="index.php?gct=store_order&gp=show_order&order_id=<?php echo $order_id;?>" target="_blank"><?php echo $lang['store_order_view_order'];?></a></p>
        
        <!-- 物流跟踪 -->
        <p>
          <?php if ($order['if_deliver']) { ?>
          <a href='index.php?gct=store_deliver&gp=search_deliver&order_sn=<?php echo $order['order_sn']; ?>'><?php echo $lang['store_order_show_deliver'];?></a>
          <?php } ?>
        </p>
