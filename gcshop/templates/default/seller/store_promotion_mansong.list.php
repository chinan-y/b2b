...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="gct" value="store_promotion_mansong" />
    <input type="hidden" name="gp" value="mansong_list" />
    <tr>
      <td>&nbsp;</td>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="index.php?gct=store_promotion_mansong&gp=mansong_detail&mansong_id=<?php echo $val['mansong_id'];?>" class="btn-blue"><i class="icon-th-list"></i>
