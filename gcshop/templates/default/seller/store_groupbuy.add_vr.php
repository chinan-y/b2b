...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?gct=store_groupbuy&gp=groupbuy_save&vr=1" method="post" enctype="multipart/form-data">
    <dl>
...
$("select[name=class]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?gct=store_groupbuy&gp=ajax_vr_class&class_id='+class_id,
...
$("select[name=city]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?gct=store_groupbuy&gp=ajax_vr_area&area_id='+area_id,
        success:function(json){
            var html = '<option value="">'+'请选择...'+'</option>';
