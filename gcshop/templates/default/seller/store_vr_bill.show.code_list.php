<?php defined('GcWebShop') or exit('Access Invalid!');?>
  <form method="get" id="formSearch">
    <table class="search-form">
      <input type="hidden" id='gct' name='gct' value='store_vr_bill' />
      <input type="hidden" id='gp' name='gp' value='show_bill' />
...
<table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
       	<a target="_blank" href="index.php?gct=store_vr_order&gp=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
...
$(function(){
    $('#ncexport').click(function(){
    	$('input[name="gp"]').val('export_order');
    	$('#formSearch').submit();
    });
    $('#ncsubmit').click(function(){
    	$('input[name="gp"]').val('show_bill');
    	$('#formSearch').submit();
    });
});
</script>