...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?gct=store_groupbuy&gp=groupbuy_save" method="post" enctype="multipart/form-data">
    <dl>
...
<?php } ?>
	...
	<dl>
      <dt><i class="required">*</i><?php echo '时间段';?><?php echo $lang['nc_colon'];?></dt>
      <dd>
          <input id="time_num" name="time_num" type="text" class="text w130" />
		  <span></span>
          <p class="red"><?php echo '从 1 开始填写，同一时段的抢购设置为一样，下个时段抢购为2，依次增加，根据时间先后顺序从小到大输入，最多5个时段';?></p>
      </dd>
    </dl>
    <dl>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hr8"><a class="des_demo ncsc-btn" href="index.php?gct=store_album&gp=pic_list&item=groupbuy"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a></p>
...
<?php } ?>
			...
			time_num: {
                required : '<i class="icon-exclamation-sign"></i><?php echo '抢购时间段必须填写';?>',
                number : '<i class="icon-exclamation-sign"></i><?php echo '请填写正确的数字';?>',
                max : '<i class="icon-exclamation-sign"></i><?php echo '最大输入为5';?>'
            },
            groupbuy_goods_id: {
