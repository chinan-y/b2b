...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?gct=store_livegroup&gp=edit_livegroupbuy" method="post" enctype="multipart/form-data">
    <dl>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hr8"><a class="des_demo ncsc-btn" href="index.php?gct=store_album&gp=pic_list&item=groupbuy"><i class="icon-picture"></i>插入相册图片</a></p>
...
$(document).ready(function(){
	$("select[name=s_class]").load("index.php?gct=store_livegroup&gp=ajax&type=class&class_id="+'<?php echo $output['groupbuy']['class_id'];?>','',function(json){
	...
	$("select[name=class]").change(function(){
		...
		$.ajax({
			type:'GET',
			url:'index.php?gct=store_livegroup&gp=ajax&type=class&class_id='+class_id,
	...
	$("select[name=city]").change(function(){
		...
		$.ajax({
			type:'GET',
			url:'index.php?gct=store_livegroup&gp=ajax&type=area&area_id='+area_id,
			success:function(json){
				var html = '<option value="">'+'请选择...'+'</option>'; 
