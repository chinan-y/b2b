  ...
  <div class="tabmenu">
	...
	<div class="ncsc-form-default">
	  <form id="add_form" method="post" enctype="multipart/form-data">
	  	...
	  	<input type="hidden" id="gp" name="gp" value="templateadd"/>
	  	<?php }else {?>
	  	<input type="hidden" id="gp" name="gp" value="templateedit"/>
...
<?php } ?>
		...
		<dl>
	      <dt>商品SKU</dt>
	      <dd>
	        <input type="text" name="txt_template_sku" class="text w100" value="<?php echo $output['t_info']['voucher_t_sku'];?>">
	        <span>填写后为指定商品SKU</span>
	      </dd>
	    </dl>
