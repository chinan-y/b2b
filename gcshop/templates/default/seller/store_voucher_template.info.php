...
<div class="bottom"> <a href="javascript:void(0);" class="submit" onclick="window.location='index.php?gct=store_voucher&gp=templatelist'" > <?php echo $lang['voucher_template_backlist'];?></a> </div>
