...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="gct" value="store_vr_bill" />
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><a href="index.php?gct=store_vr_bill&gp=show_bill&ob_no=<?php echo $bill_info['ob_no'];?>"><?php echo $lang['nc_view'];?></a></td>
    </tr>
    <?php }?>
    <?php } else { ?>
    <tr>
