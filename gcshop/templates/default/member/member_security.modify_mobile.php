...
<div class="wrap">
  ...
  <div class="ncm-default-form">
    <form method="post" id="mobile_form" action="index.php?gct=member_security&gp=modify_mobile">
      ...
      <dl>
        ...
        <p>
          ...
          <a href="javascript:" id="send_auth_code" class="ncm-btn ml5"><span id="sending" style="display:none">正在</span><span class="send_success_tips"><strong id="show_times" class="red mr5"></strong>秒后再次</span>获取短信验证码</a></p>
...
$(function(){
	...
	$('#send_auth_code').on('click',function(){
		...
		ALLOW_SEND = !ALLOW_SEND;
		$('#sending').show();
		$.getJSON('index.php?gct=member_security&gp=send_modify_mobile',{mobile:$('#mobile').val()},function(data){
			if (data.state == 'true') {
				$('#sending').hide();
