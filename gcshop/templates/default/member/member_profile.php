...
<div class="wrap">
  ...
  <div class="ncm-user-profile">
    ...
    <div class="ncm-default-form fr">
      <form method="post" id="profile_form" action="index.php?gct=member_information&gp=member">
        ...
        <dl>
		 ...
		 <dl>
          ...
          <dd><span class="w400"><?php echo $output['member_info']['member_mobile']; ?>&nbsp;&nbsp;
            ...
            <?php } ?></span><span>
            <select name="privacy[mobile]">
              <option value="0" <?php if($output['member_info']['member_privacy']['mobile'] == 0){?>selected="selected"<?php }?>><?php echo $lang['home_member_public'];?></option>
              <option value="1" <?php if($output['member_info']['member_privacy']['mobile'] == 1){?>selected="selected"<?php }?>><?php echo $lang['home_member_friend'];?></option>
              <option value="2" <?php if($output['member_info']['member_privacy']['mobile'] == 2){?>selected="selected"<?php }?>><?php echo $lang['home_member_privary']?></option>
            </select>
            </span>
          </dd>
        </dl>
		...
		<dl>
			<dt><?php echo $lang['home_member_nickname'].$lang['nc_colon'];?></dt>
			<dd><span class="w400">
				<input type="text" class="text" maxlength="20" name="member_nickname" value="<?php echo $output['member_info']['member_nickname']; ?>" />
				</span>
			</dd>
        </dl>
