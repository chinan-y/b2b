...
<div class="eject_con">
  ...
  <form method="post" target="_parent" action="<?php echo urlShop('member_voucher', 'voucher_give_submit', array('voucher_id' => $output['voucher_id']));?>" id="arrival_form">
	...
	<div style="margin: 10px 0 0 48px;color: red;"><span><i class="required"></i>被赠送用户需要绑定了手机号码</span></div>
    <div class="bottom">
