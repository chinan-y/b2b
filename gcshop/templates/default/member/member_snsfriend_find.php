...
<div class="wrap">
  ...
  <div class="ncm-friend-find"> 
    <!-- 搜索好友start -->
    <form id="search_form" method="post" action="index.php?gct=member_snsfriend&gp=findlist">
      <div class="search-form">
        <div class="normal">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="<?php echo BASE_SITE_URL;?>/gcshop/index.php?gct=invite&gp=index" target="_blank">邀请好友注册成为光彩会员</a><br />
        ...
        <dd>
          ...
          <div class="content" nctype="content<?php echo $val['mtag_id'];?>">
            ...
            <div class="friends">
              ...
              <?php }else{?>
              <?php echo $lang['snsfriend_null_members_tips1']?><a href="index.php?gct=member_information&gp=more"><?php echo $lang['snsfriend_null_members_tips2'];?></a>
              <?php }?>
            </div>
          </div>
        </dd>
