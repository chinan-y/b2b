...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncm-btn ncm-btn-orange" title="在线充值" href="index.php?gct=predeposit&gp=recharge_add" style="right: 207px;"><i class="icon-shield"></i>在线充值</a>
	<a class="ncm-btn ncm-btn-green" href="index.php?gct=member_security&gp=auth&type=pd_cash" style="right: 107px;"><i class="icon-money"></i>申请提现</a>
	<a class="ncm-btn ncm-btn-blue" href="index.php?gct=predeposit&gp=rechargecard_add"><i class="icon-shield"></i>充值卡充值</a> </div>
