<div class="eject_con">
  <form id="post_form" method="post" action="index.php?gct=member_return&gp=delay&return_id=<?php echo $output['return']['refund_id']; ?>" onsubmit="ajaxpost('post_form','','','onerror')">
