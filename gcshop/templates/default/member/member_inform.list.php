...
<div class="wrap">
  ...
  <form id="list_form" method="get">
    <table class="ncm-search-table">
      <input type="hidden" id='gct' name='gct' value='member_inform' />
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><span><a href="index.php?gct=member_inform&gp=inform_info&inform_id=<?php echo $val['inform_id']; ?>" class="btn-blue"><i class="icon-eye-open"></i>
          <p><?php echo $lang['nc_view'];?></p>
          </a></span>
          <?php if($val['inform_state']==='1') { ?>
          <span><a class="btn-orange" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['inform_cancel_confirm'];?>', 'index.php?gct=member_inform&gp=inform_cancel&inform_id=<?php echo $val['inform_id']; ?>');"><i class="icon-ban-circle"></i>
