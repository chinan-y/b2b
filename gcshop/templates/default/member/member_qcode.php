...
$(function(){
	...
	$("[nc_type='unbindbtn']").bind('click',function(){
	    ...
	    ajax_get_confirm(confirm_tip,'index.php?gct=member_sharemanage&gp=unbind&type='+data_str.apikey);
	});
