    ...
    <thead>
      <tr nc_type="table_header">
        <td><input type="checkbox" id="all" class="checkall"/>
          ...
          <div class="model-switch-btn"><?php echo $lang['favorite_view_mode'].$lang['nc_colon'] ;?><a href="index.php?gct=member_favorites&gp=fglist&show=list" title="<?php echo $lang['favorite_view_mode_list'];?>"><i class="icon-list"></i></a><a href="index.php?gct=member_favorites&gp=fglist&show=pic" class="current" title="<?php echo $lang['favorite_view_mode_pic'];?>"><i class="icon-picture"></i></a><a href="index.php?gct=member_favorites&gp=fglist&show=store" title="<?php echo $lang['favorite_view_mode_shop'];?>"><i class="icon-home"></i></a></div></td>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        <td colspan="2" class="pic-model"><ul>
            ...
            <li class="favorite-pic-list">
              <div class="favorite-goods-thumb"><a href="index.php?gct=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>" target="_blank"><img src="<?php echo thumb($favorites['goods'], 240);?>" /></a></div>
              <div class="favorite-goods-info">
                <dl>
                  <dt>
                    <input type="checkbox" class="checkitem" value="<?php echo $favorites['goods']['goods_id'];?>"/>
                    <a href="index.php?gct=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>" target="_blank"><?php echo $favorites['goods']['goods_name'];?></a></dt>
