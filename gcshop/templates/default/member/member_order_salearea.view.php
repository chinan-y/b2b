  ...
  <div class="ncm-order-info">
    <div class="ncm-order-details">
      ...
      <div class="content">
	    <dl>
		  <table width="100%">
		  <?php if($output['order_info']['platform_member_id']>0) {?>
		  <tr>
		  <td> <dd><?php echo "团队名称".$lang['nc_colon'];?><span><?php echo $output['partner']['partner_name'];?></span></dd></td>
		  <td><dd>推广提成：<span><?php echo $output['order_info']['platform_rebate'];?></span></dd></td>
		  </tr>
		  <?php } ?>
		  <?php if($output['order_info']['area_member_id']>0) {?>
		  <tr>
		  <td>
		  <dd><?php echo "区域名称".$lang['nc_colon'];?><span><?php echo $output['salearea']['sa_name'];?></span></dd></td>
		  <td><dd>推广提成：<span><?php echo $output['order_info']['area_rebate'];?></span></dd></td>
		  </tr>
		  <?php } ?>
