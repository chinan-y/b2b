...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <table class="ncm-search-table">
      <input type="hidden" name='gct' value='member_complain' />
      <tr>
        <td>&nbsp;</td>
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php
				...
				?></td>
        <td class="ncm-table-handle"><span><a href="index.php?gct=member_complain&gp=complain_show&complain_id=<?php echo $val['complain_id'];?>" class="btn-blue"><i class="icon-eye-open"></i>
          <p><?php echo $lang['complain_text_detail'];?></p></a></span>
            <?php if(intval($val['complain_state'])==10) { ?>
          <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['complain_cancel_confirm'];?>','index.php?gct=member_complain&gp=complain_cancel&complain_id=<?php echo $val['complain_id']; ?>')" class="btn-orange"><i class="icon-ban-circle"></i>
