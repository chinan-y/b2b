<div class="eject_con"><!-- onsubmit="ajaxpost('confirm_order_form','','','onerror')" -->
  ...
  <form action="index.php?gct=member_order&gp=change_state&state_type=order_receive&order_id=<?php echo $output['order_info']['order_id']; ?>" method="post" id="confirm_order_form" onsubmit="ajaxpost('confirm_order_form','','','onerror')" >
    ...
    <h3 class="orange"><?php echo $lang['remind_member_evaluate'];?></h3>
    <div class="bottom">
