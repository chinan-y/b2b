...
<div class="wrap">
  <div class="tabmenu">
    <ul id="listpj" class="tab">
      <li class="active"><a href="index.php?gct=<?php echo $output['pj_act'];?>&gp=list">交易评价/晒单</a></li>
    </ul>
  </div>
  <form id="goodsevalform" method="get" class="tc">
    <input type="hidden" name="gct" value="<?php echo $output['pj_act'];?>"/>
    ...
    <div class="ncm-evaluation-list">
      ...
      <div class="ncm-evaluation-timeline">
        ...
        <div class="goods-thumb"><a target="_blank" href="<?php echo urlShop('goods', 'index', array('goods_id' => $v['geval_goodsid']));?>"> <img src="<?php echo cthumb($v['geval_goodsimage'], 60, $v['geval_storeid'], $v['goods_commonid']);?>"> </a></div>
        <dl class="detail">
