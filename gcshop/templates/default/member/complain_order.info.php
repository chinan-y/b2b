...
<div class="ncm-flow-item">
  ...
  <div class="item-order">
    ...
    <dl class="line">
      ...
      <dd> <a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=member_order&gp=show_order&order_id=<?php echo $output['order']['order_id'];?>"  target="_blank"> <?php echo $output['order']['order_sn'];?> </a> <a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
      ...
      <dl>
        <dt>物流单号：</dt>
        <dd><a target="_blank" href="index.php?gct=member_order&gp=search_deliver&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['shipping_code'];?></a>
    ...
    <dl class="line">
        ...
        <dd><?php echo $output['order']['store_name'];?><a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
          ...
          <div style="display:none;"><span member_id="<?php echo $output['store']['member_id'];?>"></span>
