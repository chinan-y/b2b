...
<div class="ncm-oredr-show">
  <div class="ncm-order-info">
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        <li>1. 您尚未对该订单进行支付，请<a href="index.php?gct=buy&gp=pay&pay_sn=<?php echo $output['order_info']['pay_sn'];?>" class="ncm-btn-mini ncm-btn-orange"><i></i>支付订单</a>以确保商家及时发货。</li>
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td><!-- 退款 -->
            ...
            <p><a href="index.php?gct=member_refund&gp=add_refund&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">退款/退货</a></p>
            <?php }?>
            
            <!-- 投诉 -->
            
            <?php if ($output['order_info']['if_complain']){ ?>
            <p><a href="index.php?gct=member_complain&gp=complain_new&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">交易投诉</a></p>
            <?php } ?></td>
          ...
          <td rowspan="<?php echo $output['order_info']['goods_count'];?>">
            ...
            <p><a href="index.php?gct=member_refund&gp=add_refund_all&order_id=<?php echo $output['order_info']['order_id']; ?>" class="ncm-btn">订单退款</a></p>
            <?php } ?>
            
            <!-- 收货 -->
            
            <?php if ($output['order_info']['if_receive'] && $output['order_info']['refund_state'] == 0) { ?>
            <p><a href="javascript:void(0)" class="ncm-btn" nc_type="dialog" dialog_id="buyer_order_confirm_order" dialog_width="480" dialog_title="<?php echo $lang['member_order_ensure_order'];?>" uri="index.php?gct=member_order&gp=change_state&state_type=order_receive&order_sn=<?php echo $output['order_info']['order_sn']; ?>&order_id=<?php echo $output['order_info']['order_id']; ?>" id="order_action_confirm"><?php echo $lang['member_order_ensure_order'];?></a></p>
            <?php } ?>
            
            <!-- 评价 -->
            
            <?php if ($output['order_info']['if_evaluation'] && $output['order_info']['refund_state'] == 0) { ?>
            <p><a class="ncm-btn ncm-btn-acidblue" href="index.php?gct=member_evaluate&gp=add&order_id=<?php echo $output['order_info']['order_id']; ?>"><?php echo $lang['member_order_want_evaluate'];?></a></p>
            <?php } ?>
