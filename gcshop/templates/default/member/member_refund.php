...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <input type="hidden" name="gct" value="member_refund" />
  ...
  <table class="ncm-default-table order">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="bdr"><a href="index.php?gct=member_refund&gp=view&refund_id=<?php echo $val['refund_id']; ?>" class="ncm-btn"><?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
