  ...
  <div class="ncm-message-send">
    <div class="ncm-message-send-form">
      <div class="ncm-default-form">
        <form method="post" id="send_form" action="index.php?gct=member_message&gp=savemsg">
    ...
    <div class="ncm-message-send-friend">
      <h3><?php echo $lang['home_message_friend'];?></h3>
       <?php if ($output['friend_list'] != '') { ?><ul>
        ...
        <a href="index.php?gct=member_snsfriend&gp=find" class="ncm-btn-mini" target="_blank">添加好友</a>
        </div>
        <?php } ?>
    </div>
  </div>
