  ...
  <ul class="ncm-friend-list">
    ...
    <li id="recordone_<?php echo $v['friend_frommid']; ?>">
      ...
      <dl class="info">
        ...
        <dd><a href="index.php?gct=member_message&gp=sendmsg&member_id=<?php echo $v['friend_frommid']; ?>" target="_blank" title="<?php echo $lang['nc_message'] ;?>"><i class="icon-envelope"></i><?php echo $lang['nc_message'] ;?></a></dd>
      </dl>
