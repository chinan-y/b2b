...
<div class="ncm-flow-layout">
  <div class="ncm-flow-container">
    ...
    <form id="evalform" method="post" action="index.php?gct=member_evaluate&gp=<?php echo $_GET['gp'];?>&order_id=<?php echo $_GET['order_id'];?>">
        ...
        <tbody>
          <tr>
            <th colspan="20" class="tr"><span class="mr10">
              <input type="checkbox" class="checkbox vm" checked name="anony">
          ...
          <tr class="bd-line">
            <td valign="top" class="w40"><div class="pic-thumb"><a href="index.php?gct=goods&goods_id=<?php echo $goods['goods_id']; ?>" target="_blank"><img src="<?php echo $goods['goods_image_url']; ?>"/></a></span></div></td>
            <td valign="top" class="tl w200"><dl class="goods-name">
                <dt style="width: 190px;"><a href="index.php?gct=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a></dt>
            ...
            <td valign="top" class="tr"><textarea maxlength='300' name="goods[<?php echo $goods['goods_id'];?>][comment]" cols="150" style="width: 280px;"></textarea></td>
          </tr>
          <?php }?>
          <?php }?>
        </tbody>
      </table>
      <?php if (!$output['store_info']['is_own_shop'] && $_GET['gp'] != 'add_vr') { ?>
      <div class="tabmenu">
        <ul class="tab">
