...
<div class="wrap">
  ...
  <form method="get" action="index.php" target="_self">
    <table class="ncm-search-table">
      <input type="hidden" name="gct" value="member_live" />
      <tr>
        <td>&nbsp;</td>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="bdl"><p>
          ...
          <p> <a href="index.php?gct=member_live&gp=member_livedetail&order_id=<?php echo $val['order_id'];?>">订单详情</a></p></td>
        <td class="bdl bdr">
		  <?php if($val['state']==1){?>
          <p><a class="ncm-btn ncm-btn-orange" href="index.php?gct=show_live_groupbuy&gp=pay&order_sn=<?php echo $val['order_sn']; ?>"><i class="icon-shield"></i>订单支付</a></p> 		  
		  <!--取消订单-->
          <p class="mt5"><a href="javascript:void(0)" class="ncm-btn ncm-btn-red" nc_type="dialog" dialog_width="480" dialog_title="取消抢购" dialog_id="buyer_order_cancel_order" uri="index.php?gct=member_live&gp=cancel&order_id=<?php echo $val['order_id'];?>"  id="order<?php echo $val['order_id'];?>_action_cancel"><i class="icon-ban-circle"></i>取消抢购</a></p>
		  <?php }?>
		  </td>
      </tr>
      <?php }?>
