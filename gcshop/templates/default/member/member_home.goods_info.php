...
<div id="favoritesGoods" class="double">
  <div class="outline">
    ...
    <div class="ncm-favorites-goods">
      ...
      <div class="more"><a target="_blank" href="index.php?gct=member_favorites&gp=fglist">查看收藏的所有商品</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
  ...
  <div class="outline">
    ...
    <div class="ncm-favorites-store">
      <ul id="favoritesStoreList" class="jcarousel-skin-tango">
        ...
        <li>
          <div class="ncm-store-pic"><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $favorites['store']['store_id']), $favorites['store']['store_domain']);?>" ><img alt="<?php echo $favorites['store']['store_name'];?>" src="<?php echo getStoreLogo($favorites['store']['store_avatar']);?>"></a></div>
          <dl>
      ...
      <div class="more"><a target="_blank" href="index.php?gct=member_favorites&gp=fslist">查看收藏的所有店铺</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
