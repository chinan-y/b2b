...
<div class="wrap">
  ...
  <h4>积分获得规则</h4>
<ul><li>成功注册会员：增加<em><?php echo C('points_reg');?></em>积分；会员每天登录：增加<em><?php echo C('points_login');?></em>积分；会员每天签到：增加<em><?php echo C('points_sign');?></em>积分；评价完成订单：增加<em><?php echo C('points_comments');?></em>积分。</li>
<li>浏览一个商品详情：增加<em><?php echo C('browse_goods');?></em>积分；每天浏览商品增加积分的上限：<em><?php echo C('browse_goods_up');?></em>积分。</li>
...
<li>如订单发生退款、退货等问题时，积分将不予退还。</li></ul>
  ...
  <form method="get" action="index.php">
    <table class="ncm-search-table">
      <input type="hidden" name="gct" value="member_points" />
      <tr><td class="w10">&nbsp;</td>
        ...
        <th class="exchange w70"><a href="<?php echo urlShop('pointvoucher', 'index'); ?>"><?php echo $lang['points_log_pointsvoucher']; ?></a></th>
        <th class="exchange w70"><a href="<?php echo urlShop('pointprod', 'plist');?>"><?php echo $lang['points_log_pointsgift'];?></a></th>
        ...
        <td class="w80"><select name="stage">
            ...
            <option value="sign" <?php if ($_GET['stage'] == 'sign'){echo 'selected=selected';}?>><?php echo $lang['points_stage_sign']; ?></option>
        ...
        <td class="w110"><input type="text" class="text w110" id="description" name="description" value="<?php echo $_GET['description'];?>"></td>
        <td class="w50 tc"><label class="submit-border">
        ...
        <td><?php 
	              	switch ($val['pl_stage']){
	              		case 'regist':
	              			...
	              			break;
						case 'sign':
	              			echo $lang['points_stage_sign'];
	              			break;
						case 'browse':
	              			echo $lang['points_stage_browse_goods'];
	              			break;
	              		case 'login':
