...
<div class="wrap">
  ...
  <form action="index.php?gct=member_information&gp=upload" enctype="multipart/form-data" id="form_avaster" method="post">
    ...
    <div class="ncm-default-form">
      <dl>
        ...
        <dd>
          ...
          <p class="hint mt5">完善个人信息资料，上传头像图片有助于您结识更多的朋友。<br  />头像默认尺寸为120x120像素，上传图像要求为方形,边长小于500px</p>
		  <?php  } ?>
        </dd>
      </dl>
      <dl>
  ...
  <?php }else{?>
  <form action="index.php?gct=member_information&gp=cut" id="form_cut" method="post">
    <input type="hidden" name="form_submit" value="ok" />
