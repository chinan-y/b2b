...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncm-btn ncm-btn-orange" title="在线充值" href="index.php?gct=predeposit&gp=recharge_add"> <i class="icon-shield"></i> 在线充值 </a> </div>
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><?php if (!intval($val['pdr_payment_state'])){?>
          <span><a class="btn-green" href="index.php?gct=buy&gp=pd_pay&pay_sn=<?php echo $val['pdr_sn'];?>"> <i class="icon-shield"></i>
          <p>支付</p>
          </a></span> <span><a class="btn-red" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', 'index.php?gct=predeposit&gp=recharge_del&id=<?php echo $val['pdr_id']; ?>');"><i class="icon-trash"></i>
          <p><?php echo $lang['nc_del'];?></p>
          </a></span>
          <?php }else{?>
          <span><a href="index.php?gct=predeposit&gp=recharge_show&id=<?php echo $val['pdr_id']; ?>" class="btn-blue"><i class="icon-eye-open"></i>
