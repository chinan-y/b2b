...
<?php if ($output['gct'] == 'remote_image') { ?>
...
<body>
<form action="index.php?gct=store_goods&gp=image_upload&upload_type=<?php echo $output['gct']; ?>&instance=<?php echo $output['instance']; ?>&id=<?php echo $output['id']; ?>&belong=<?php echo $output['belong']; ?>" method="post" enctype="multipart/form-data" id="image_form">
<input type="hidden" name="id" value="<?php echo $output['id']; ?>">
<input type="hidden" name="belong" value="<?php echo $output['belong']; ?>">
<?php if ($output['gct']=='uploadedfile') { ?>
...
<?php } ?>
<input id="submit_button" <?php if ($output['gct']=='uploadedfile') { ?>style="display:none"<?php } ?> type="button" value="<?php if ($output['gct']=='uploadedfile') { ?><?php echo $lang['store_goods_upload_upload'];?><?php } ?><?php if ($output['gct']=='remote_image') { ?><?php echo $lang['nc_submit'];?><?php } ?>" onclick="submit_form($(this))">
</form>
</body>
</html>