...
<div id="lazymodule">
  ...
  <div class="sns-norecord ml200"><i class="trace-ico pngFix"></i><span><?php echo $lang['sns_trace_nohave_self_1'];?><a href="index.php?gct=member_snsfriend&gp=find"><?php echo $lang['sns_trace_nohave_self_2'];?></a><?php echo $lang['sns_trace_nohave_self_3'];?></span></div>
  <?php } else { ?>
