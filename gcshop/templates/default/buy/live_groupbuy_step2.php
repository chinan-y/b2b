...
<div class="ncc-main">
  <div class="ncc-title">
    ...
    <h5>订单详情内容可通过查看<a href="index.php?gct=member_live" target="_blank">我的订单</a>进行核对处理。</h5>
  </div>
  <form action="index.php?gct=show_live_groupbuy&gp=payment" method="POST" id="buy_form">
