  ...
  <div class="wrapper">
    ...
    <div class="index-search-container">
        ...
        <div class="sitemap-menu">
          ...
          <div id="quicklink_list" class="content">
            ...
            <dl>
              ...
              <dd <?php if(!empty($output['seller_quicklink'])) {echo in_array($submenu_value['gct'], $output['seller_quicklink'])?'class="selected"':'';}?>><i nctype="btn_add_quicklink" data-quicklink-gct="<?php echo $submenu_value['gct'];?>" class="icon-check" title="添加为常用功能菜单"></i><a href="index.php?gct=<?php echo $submenu_value['gct'];?>&gp=<?php echo $submenu_value['gp'];?>"> <?php echo $submenu_value['name'];?> </a></dd>
              <?php } ?>
              <?php } ?>
            </dl>
            <?php } ?>
      ...
      <div class="search-bar">
        <form method="get" target="_blank">
          <input type="hidden" name="gct" value="search">
    ...
    <nav class="ncsc-nav">
      <dl class="<?php echo $output['current_menu']['model'] == 'index'?'current':'';?>">
        <dt><a href="index.php?gct=seller_center&gp=index">首页</a></dt>
        <dd class="arrow"></dd>
      </dl>
      <?php if(!empty($output['menu']) && is_array($output['menu'])) {?>
      <?php foreach($output['menu'] as $key => $menu_value) {?>
      <dl class="<?php echo $output['current_menu']['model'] == $key?'current':'';?>">
        <dt><a href="index.php?gct=<?php echo $menu_value['child'][key($menu_value['child'])]['gct'];?>&gp=<?php echo $menu_value['child'][key($menu_value['child'])]['gp'];?>"><?php echo $menu_value['name'];?></a></dt>
        <dd>
          <ul>
            <?php if(!empty($menu_value['child']) && is_array($menu_value['child'])) {?>
            <?php foreach($menu_value['child'] as $submenu_value) {?>
            <li> <a href="index.php?gct=<?php echo $submenu_value['gct'];?>&gp=<?php echo $submenu_value['gp'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
            <?php } ?>
            <?php } ?>
          </ul>
        </dd>
    ...
    <div id="sidebar" class="sidebar">
      ...
      <div class="column-menu">
        <ul id="seller_center_left_menu">
          ...
          <li <?php echo $_GET['gct'] == 'seller_center'?"id='quicklink_".$submenu_value['gct']."'":'';?>class="<?php echo $submenu_value['gct'] == $_GET['gct']?'current':'';?>"> <a href="index.php?gct=<?php echo $submenu_value['gct'];?>&gp=<?php echo $submenu_value['gp'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
          <?php } ?>
          <?php } else { ?>
          <?php if ($_GET['gct'] == 'seller_center') { ?>
...
$(document).ready(function(){
    ...
    $('[nctype="btn_add_quicklink"]').on('click', function() {
        ...
        var item = $(this).attr('data-quicklink-gct');
