...
<meta name="copyright" content="gcwebshop Inc. All Rights Reserved">
    ...
    <div class="details" id="details">
      <div id="a1" class="form">
        <form action="index.php" onSubmit="return searchInput();" method="get">
          <input name="gct" id="search_act" value="flea_class" type="hidden">
          <div class="formstyle">
      ...
      <div class="tag">
        ...
        <a href="index.php?gct=flea_class&key_input=<?php echo urlencode($val);?>"><?php echo $val; ?></a>
        <?php } }?>
      </div>
    </div>
  </div>
...
<div id="navBar" class="mb10">
  <ul>
    ...
    <li class="fn-left" <?php echo $output['index_sign'] == 'groupbuy' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=show_groupbuy"><span><?php echo $lang['nc_groupbuy'];?></span><span class="line"></span></a></li>
    <?php }?>  
    <li class="fn-left" <?php echo $output['index_sign'] == 'brand' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=brand"><span><?php echo $lang['nc_brand'];?></span><span class="line"></span></a></li>
      <?php if ($GLOBALS['setting_config']['points_isuse'] == 1 && $GLOBALS['setting_config']['pointprod_isuse'] == 1){ ?>
          <li class="fn-left" <?php echo $output['index_sign'] == 'pointprod' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=pointprod"><span><?php echo $lang['nc_pointprod'];?></span><span class="line"></span></a></li>
  <?php } ?>
    ...
    <li class="fn-left" <?php if($nav['nav_new_open']){?>target="_blank" <?php }?> <?php if($output['index_sign'] == $nav['nav_id']){echo 'class="current"';}else{echo 'class="link"';} ?>><a href="<?php switch($nav['nav_type']){
    	...
    	case '1':echo ncUrl(array('gct'=>'goods_class','nav_id'=>$nav['nav_id'],'cate_id'=>$nav['item_id']));break;
    	case '2':echo ncUrl(array('gct'=>'article','nav_id'=>$nav['nav_id'],'ac_id'=>$nav['item_id']));break;
    	case '3':echo ncUrl(array('gct'=>'activity','activity_id'=>$nav['item_id'],'nav_id'=>$nav['nav_id']), 'activity');break;
