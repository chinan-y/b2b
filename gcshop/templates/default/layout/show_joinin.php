...
<div class="banner">
  <div class="user-box">
		  ...
		  <?php }else{?>
			<div class="user-login">
			  ...
			  <form id="login_form" action="index.php?gct=login" method="post">
				...
				<dl>
				  ...
				  <dd>
					...
					<a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='<?php echo SHOP_SITE_URL?>/index.php?gct=seccode&gp=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="看不清，换一张">
					<img src="<?php echo SHOP_SITE_URL?>/index.php?gct=seccode&gp=makecode&nchash=<?php echo getNchash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
					<label></label>
				  </dd>
				</dl>
				<?php } ?>
				<dl>
				  <dt></dt>
				  <dd>
					<input type="hidden" value="<?php echo SHOP_SITE_URL;?>/index.php?gct=show_joinin" name="ref_url">
  ...
  <ul id="fullScreenSlides" class="full-screen-slides">
                <li style="background-color: #F1A595; background-image: url(<?php echo UPLOAD_SITE_URL;?>/gcshop/common/store_joinin_1.jpg)" ></li>
                <li style="background-color: #F1A595; background-image: url(<?php echo UPLOAD_SITE_URL;?>/gcshop/common/store_joinin_2.jpg)" ></li>
                <li style="background-color: #F1A595; background-image: url(<?php echo UPLOAD_SITE_URL;?>/gcshop/common/store_joinin_3.jpg)" ></li>
              </ul>
</div>
<div class="indextip">
