    ...
    <nav class="nc-gl-sort-bar" id="main-nav">
      <form id="store_list" method="GET" action="index.php">
        ...
        <div class="sort-bar"><!-- 排序方式S -->
          ...
          <div class="sidebox">
            <h5><label for="area_info">所在地<?php echo $lang['nc_colon'];?></label></h5>
            <div class="selectbox">
...
<?php foreach($output['store_list'] as $skey => $store){?>
    <li class="item">
      <dl class="gcshop-info">
        ...
        <dd class="gcshop-pic"><a href="<?php echo urlShop('show_store','', array('store_id'=>$store['store_id']),$store['store_domain']);?>" title="" target="_blank"><span class="size72"><img src="<?php echo getStoreLogo($store['store_label']);?>"  alt="<?php echo $store['store_name'];?>" title="<?php echo $store['store_name'];?>" class="size72" /></span></a></dd>
      ...
      <div class="nc-gcshop-goodslist" nc_type='goods_<?php echo $skey;?>'>
        ...
        <li>
            <dl>
              ...
              <dd class="goods-sales" style="display:none;"><?php echo $lang['store_class_index_deal'];?><?php echo $v['salenum'];?><?php echo $lang['store_class_index_jian'];?></dd>
            </dl>
          </li>
         <?php }?>
        </ul>
