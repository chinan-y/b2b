...
<div class="ncg-topbar">
  <div id="headRelative" class="ncg-topbar-wrapper">
    <div class="title" style="width:210px;">
      ...
      <?php if ($_GET['gp'] == 'index' || strpos($_GET['gp'], 'vr_groupbuy_') === 0) { ?>
      ...
      <div id="list" class="list" style="display:none;"><a id="button_close" class="close" href="javascript:void(0)">&#215;</a>
        <ul>
          <li><a href="<?php echo urlShop('show_groupbuy', 'select_city'); ?>&back_op=<?php echo $_GET['gp']; ?>&city_id=0"><?php echo $lang['text_country'];?></a></li>
          <?php $names = $output['groupbuy_vr_cities']['name']; foreach ($output['groupbuy_vr_cities']['children'][0] as $v) { ?>
          <li><a href="<?php echo urlShop('show_groupbuy', 'select_city'); ?>&back_op=<?php echo $_GET['gp']; ?>&city_id=<?php echo $v; ?>"><?php echo $names[$v]; ?></a></li>
          <?php } ?>
        </ul>
      </div>
      <?php } ?>
    ...
    <ul class="nav-menu">
      <li><a href="<?php echo urlShop('show_groupbuy', 'index',array('be_doing'=>1)); ?>"<?php if (!isset($output['groupbuyMenuIsVr'])) echo ' class="current"'; ?>>天天特价</a></li>
      <li><a href="<?php echo urlShop('show_groupbuy', 'groupbuy_list'); ?>"<?php if (isset($output['groupbuyMenuIsVr']) && !$output['groupbuyMenuIsVr']) echo ' class="current"'; ?>>超低折扣</a></li>
    </ul>
  </div>
</div>
