...
<![endif]-->
<style type="text/css">
body, .header-wrap { background-color: #FFFFFF;}
.wrapper { width: 1000px;}
#faq { display: none;}
.msg { font: 100 36px/48px arial,"microsoft yahei"; color: #555; background-color: #FDFDFD; text-align: center; width: 98%; border: solid 1px #E6E6E6; margin-left: 10px; margin-right: 10px;margin-bottom: 10px; padding: 40px 0;}
...
$(function(){
	...
	var search_act = $("#details").find("li[class='current']").attr("gct");
