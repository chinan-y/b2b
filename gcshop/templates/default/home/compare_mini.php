...
<ul class="goods-list">
  ...
  <li><dl class="goods-info">
    <dt class="goods-pic"> <a href="<?php echo urlShop('goods','index',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>"> <img src="<?php echo cthumb($v['goods_image'], 240,$v['store_id'], $v['goods_commonid']);?>" alt="<?php echo $v['goods_name'];?>" title="<?php echo $v['goods_name'];?>"/> </a> </dt>
...
<div class="btn-box">
  ...
  <span style="background-color: #E74649; color: #FFFFFF; cursor: pointer; padding: 5px 10px;" onclick="javascript:window.open('index.php?gct=compare&gids=<?php echo $output['goodsid_str'];?>');">对比</span>
