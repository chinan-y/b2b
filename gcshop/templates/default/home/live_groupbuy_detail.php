...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="index.php">首页</a> </span> <span class="arrow">></span> <span><a href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list">线下抢</a></span> <span class="arrow">></span> <span><?php echo $output['live_groupbuy']['groupbuy_name'];?></span> </div>
</div>
  ...
  <div class="ncg-layout-l">
    <div class="ncg-main <?php if($output['groupbuy_state']!='2'){ echo 'not-start';}?>">
      <div class="ncg-group">
        ...
        <div class="ncg-item">
          <div class="pic"><img src="<?php echo lgthumb($output['live_groupbuy']['groupbuy_pic'],'max');?>" alt="<?php echo $output['live_groupbuy']['groupbuy_name'];?>"></div>
...
$(function(){
    ...
    $('.buynow').click(function(){
		...
		return false;
		<?php }?>
    	location.href = 'index.php?gct=show_live_groupbuy&gp=livegroupbuyorder&groupbuy_id='+<?php echo $_GET['groupbuy_id'];?>;
		return false;
    	<?php }?>
    });
});
