...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <form method="post" id="porder_form" name="porder_form" action="index.php?gct=pointcart&gp=step2">
      <div class="ncc-receipt-info">
        <div class="ncc-receipt-info-title">
          <h3><?php echo $lang['pointcart_step1_receiver_address'];?><a href="index.php?gct=member_address&gp=address" target="_blank">[管理]</a></h3>
        </div>
        <!-- 已经存在的收获地址start -->        
      ...
      <div class="ncc-bottom">
        <a href="index.php?gct=pointcart" class="ncc-btn"><?php echo $lang['pointcart_step1_return_list'];?></a>
