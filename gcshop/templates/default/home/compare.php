  ...
  <table class="nch-compare-table">
    ...
    <tr id="comparetr_<?php echo $k; ?>" class="goods_tr">
      ...
      <td><dl class="goods-info">
          <dt class="goods-pic"><a href="<?php echo urlShop('goods','index',array('goods_id'=>$v[$i]['goods_id']));?>" target="_blank"><img src="<?php echo cthumb($v[$i]['goods_image'], 240,$v[$i]['store_id'], $v[$i]['goods_commonid']);?>"></a></dt>
