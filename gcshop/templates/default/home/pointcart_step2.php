  ...
  <div class="ncc-main">
    <div class="ncc-title">
      ...
      <div class="ncc-receipt-info mb30">
        ...
        <div class="ncc-finish-b">可通过用户中心<a href="<?php echo SHOP_SITE_URL?>/index.php?gct=member_pointorder&gp=orderlist">积分兑换记录</a>查看兑换单状态。
        ...
        <a class="ncc-btn-mini ncc-btn-acidblue" href="index.php?gct=member_pointorder&gp=order_info&order_id=<?php echo $output['order_info']['point_orderid'];?>"><i class="icon-file-text-alt"></i><?php echo $lang['pointcart_step2_view_order'];?></a></div>
      </div>
  </div>
</div>
