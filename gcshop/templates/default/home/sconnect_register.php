...
<div class="nc-login-layout">
  ...
  <div class="nc-login" id="rotate">
    ...
    <div class="nc-login-content">
      <form name="register_form" id="register_form" method="post" action="index.php?gct=sconnect&gp=register">
        ...
        <dl>
          ...
          <dd>
            ...
            <img src="index.php?gct=seccode&gp=makecode&nchash=<?php echo $output['nchash'];?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" border="0" id="codeimage" onclick="this.src='index.php?gct=seccode&gp=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random()"  class="fl ml5"><a href="javascript:void(0)" class="fl ml5" onclick="javascript:document.getElementById('codeimage').src='index.php?gct=seccode&gp=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
        ...
        <dl>
          ...
          <dd>
            ...
            <a target="_blank" href="index.php?gct=document&amp;code=agreement"><?php echo $lang['home_sconnect_login_useragreement']; ?><!-- 用户服务协议 --></a></span>
            <label></label>
          </dd>
        </dl>
      </form>
      <form name="log_form" id="log_form" method="post" action="index.php?gct=sconnect&gp=login">
        <input type="hidden" value="ok" name="form_submit">
        ...
        <dl>
          ...
          <dd style="min-height:54px;">
            ...
            <img src="index.php?gct=seccode&gp=makecode&nchash=<?php echo $output['nchash'];?>" title="<?php echo $lang['login_index_change_checkcode'];?>" border="0" id="codeimage2" name="codeimage2" onclick="this.src='index.php?gct=seccode&gp=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random()" class="fl ml5"><a href="javascript:void(0)" class="fl ml5" onclick="javascript:document.getElementById('codeimage2').src='index.php?gct=seccode&gp=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
            <input name="nchash" type="hidden" value="<?php echo $output['nchash'];?>" />
            <label></label>
          </dd>
        </dl>
    ...
    $('#register_form').validate({
        ...
        rules : {
            user_name : {
                ...
                lettersonly : true,
                remote   : {
                    url :'index.php?gct=login&gp=check_member&column=ok',
                    type:'get',
                    data:{
                        user_name : function(){
            ...
            captcha : {
                required : true,
                remote   : {
                	url : 'index.php?gct=seccode&gp=check&nchash=<?php echo $output['nchash'];?>',
                    type: 'get',
                    data:{
                        captcha : function(){
                            return $('#captcha').val();
