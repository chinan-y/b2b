...
<div class="ncg-container">
  <div id="ncgCategory" class="ncg-category">
    ...
    <ul>
      ...
      <?php if($i>7) break;?>
      <li><a href="index.php?gct=show_groupbuy&gp=index&groupbuy_class=<?php echo $online['class_id'];?>"><?php echo $online['class_name'];?></a></li>
      <?php $i++;?>
      <?php }?>
      <?php }?>
    </ul>
    ...
    <ul>
      ...
      <?php if($j>7) break;?>
      <li><a href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&class_id=<?php echo $offline['live_class_id'];?>"><?php echo $offline['live_class_name'];?></a></li>
      <?php $j++;?>
      <?php }?>
      <?php }?>
    </ul>
  ...
  <div class="ncg-content">
    ...
    <div class="ncg-screen"> 
      ...
      <dl>
        ...
        <dd <?php if(empty($_GET['class_id'])){ echo 'class="selected"';}?>><a href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&area_id=<?php echo $_GET['area_id'];?>&mall_id=<?php echo $_GET['mall_id'];?>&dis=<?php echo $_GET['dis'];?>&order=<?php echo $_GET['order']?>&sort=<?php echo $_GET['sort'];?>&type=<?php echo $_GET['type'];?>">全部</a></dd>
        <?php if(is_array($output['class_root'])) { ?>
        <?php foreach($output['class_root'] as $groupbuy_class) { ?>
        <dd <?php if($_GET['class_id']==$groupbuy_class['live_class_id']){ echo 'class="selected"';}?>><a href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&class_id=<?php echo $groupbuy_class['live_class_id'];?>&area_id=<?php echo $_GET['area_id'];?>&mall_id=<?php echo $_GET['mall_id'];?>&dis=<?php echo $_GET['dis'];?>&order=<?php echo $_GET['order']?>&sort=<?php echo $_GET['sort'];?>&type=<?php echo $output['type'];?>"><?php echo $groupbuy_class['live_class_name'];?></a> </dd>
        <?php } ?>
        <?php } ?>
      ...
      <dl>
        <dt>区域：</dt>
        <dd <?php if(empty($_GET['area_id'])){ echo 'class="selected"';}?>><a href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&class_id=<?php echo $_GET['class_id'];?>&s_class_id=<?php echo $_GET['s_class_id'];?>&dis=<?php echo $_GET['dis'];?>&order=<?php echo $_GET['order']?>&sort=<?php echo $_GET['sort'];?>">全部</a></dd>
        <?php if(is_array($output['area_list'])){?>
        <?php foreach($output['area_list'] as $area){?>
        <dd <?php if($_GET['area_id']==$area['live_area_id']){ echo 'class="selected"';}?>><a href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&class_id=<?php echo $_GET['class_id'];?>&s_class_id=<?php echo $_GET['s_class_id'];?>&area_id=<?php echo $area['live_area_id'];?>&dis=<?php echo $_GET['dis'];?>&order=<?php echo $_GET['order']?>&sort=<?php echo $_GET['sort'];?>&type=<?php echo $output['type'];?>"><?php echo $area['live_area_name'];?></a></dd>
        <?php }?>
        <?php }?>
      ...
      <dl class="ncg-sortord">
        <dt>排序：</dt>
        <dd <?php if(empty($_GET['order'])){ echo 'class="selected"';}?>><a href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&class_id=<?php echo $_GET['class_id'];?>&s_class_id=<?php echo $_GET['s_class_id'];?>&area_id=<?php echo $_GET['area_id'];?>&mall_id=<?php echo $_GET['mall_id'];?>&dis=<?php echo $_GET['dis'];?>&type=<?php echo $output['type'];?>">默认</a></dd>
        <dd <?php if($_GET['order']=='sales'){ echo 'class="selected"';}?>><a <?php if($output['sort']=='asc'){ echo 'class="desc"';}else{ echo 'class="asc"';}?> href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&class_id=<?php echo $_GET['class_id'];?>&s_class_id=<?php echo $_GET['s_class_id'];?>&area_id=<?php echo $_GET['area_id'];?>&mall_id=<?php echo $_GET['mall_id'];?>&dis=<?php echo $_GET['dis'];?>&order=sales&sort=<?php echo $output['sort'];?>&type=<?php echo $output['type'];?>">销量<i></i></a></dd>
        <dd <?php if($_GET['order']=='price'){ echo 'class="selected"';}?>><a <?php if($output['sort']=='asc'){ echo 'class="desc"';}else{ echo 'class="asc"';}?> href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&class_id=<?php echo $_GET['class_id'];?>&s_class_id=<?php echo $_GET['s_class_id'];?>&area_id=<?php echo $_GET['area_id'];?>&mall_id=<?php echo $_GET['mall_id'];?>&dis=<?php echo $_GET['dis'];?>&order=price&sort=<?php echo $output['sort'];?>&type=<?php echo $output['type'];?>">价格<i></i></a></dd>
        <dd <?php if($_GET['order']=='time'){ echo 'class="selected"';}?>><a <?php if($output['sort']=='asc'){ echo 'class="desc"';}else{ echo 'class="asc"';}?> href="index.php?gct=show_live_groupbuy&gp=live_groupbuy_list&class_id=<?php echo $_GET['class_id'];?>&s_class_id=<?php echo $_GET['s_class_id'];?>&area_id=<?php echo $_GET['area_id'];?>&mall_id=<?php echo $_GET['mall_id'];?>&dis=<?php echo $_GET['dis'];?>&order=time&sort=<?php echo $output['sort'];?>&type=<?php echo $output['type'];?>">发布时间<i></i></a></dd>
      </dl>
    </div>
    ...
    <div class="group-list">
      <ul>
        ...
        <li class="<?php echo $output['current'];?>">
          ...
          <a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" class="pic-thumb" target="_blank"><img src="<?php echo lgthumb($groupbuy['groupbuy_pic'],'mid');?>" alt="<?php echo $groupbuy['groupbuy_name'];?>"></a>
