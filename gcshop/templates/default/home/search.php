...
<div style="height:10px; line-height:10px;"></div>
  <div class="left">
    ...
    <div class="nch-module nch-module-style02">
      <div class="title">
        <h3><?php echo $lang['class_select'] ?></h3>
      </div>
      <div class="content">
    ...
    <div class="nch-module nch-module-style03">
      ...
      <div class="content">
        ...
        <a href="<?php echo SHOP_SITE_URL;?>/index.php?gct=member_goodsbrowse&gp=list" class="nch-sidebar-all-viewed"><?php echo $lang['all_viewed_goods_history']; ?></a></div>
    </div>
  ...
  <div class="right">
    ...
    <div class="shop_con_list" id="main-nav-holder">
      ...
      <nav class="sort-bar" id="main-nav">
        ...
        <div class="nch-sortbar-array"> <?php echo $lang['sort_order'] ?>:
          <ul>
            ...
            <li <?php if($_GET['key'] == '1'){?>class="selected"<?php }?>><a href="<?php echo ($_GET['order'] == '2' && $_GET['key'] == '1') ? replaceParam(array('key' => '1', 'order' => '1')):replaceParam(array('key' => '1', 'order' => '2')); ?>" <?php if($_GET['key'] == '1'){?>class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"<?php }?> title="<?php echo ($_GET['order'] == '2' && $_GET['key'] == '1')?$lang['goods_class_index_time_asc']:$lang['goods_class_index_time_desc']; ?>"><?php echo $lang['goods_class_index_time'] ?><i></i></a></li>
			
            <li <?php if($_GET['key'] == '2'){?>class="selected"<?php }?>><a href="<?php echo ($_GET['order'] == '2' && $_GET['key'] == '2') ? replaceParam(array('key' => '2', 'order' => '1')):replaceParam(array('key' => '2', 'order' => '2')); ?>" <?php if($_GET['key'] == '2'){?>class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"<?php }?> title="<?php  echo ($_GET['order'] == '2' && $_GET['key'] == '2')?$lang['goods_class_index_sold_asc']:$lang['goods_class_index_sold_desc']; ?>"><?php echo $lang['goods_class_index_sold']?><i></i></a></li>
			
            <li <?php if($_GET['key'] == '3'){?>class="selected"<?php }?>><a href="<?php echo ($_GET['order'] == '2' && $_GET['key'] == '3') ? replaceParam(array('key' => '3', 'order' => '1')):replaceParam(array('key' => '3', 'order' => '2')); ?>" <?php if($_GET['key'] == '3'){?>class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"<?php }?> title="<?php echo ($_GET['order'] == '2' && $_GET['key'] == '3')?$lang['goods_class_index_click_asc']:$lang['goods_class_index_click_desc']; ?>"><?php echo $lang['goods_class_index_click'];?><i></i></a></li>
			
			<li <?php if($_GET['key'] == '4'){?>class="selected"<?php }?>><a href="<?php echo ($_GET['order'] == '2' && $_GET['key'] == '4') ? replaceParam(array('key' => '4', 'order' => '1')):replaceParam(array('key' => '4', 'order' => '2')); ?>" <?php if($_GET['key'] == '4'){?>class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"<?php }?> title="<?php echo ($_GET['order'] == '2' && $_GET['key'] == '4')?$lang['goods_class_index_price_asc']:$lang['goods_class_index_price_desc']; ?>"><?php echo $lang['goods_class_index_price'];?><i></i></a></li>

          </ul>
        </div>
        <div class="nch-sortbar-owner"><span><a href="<?php if ($_GET['type'] == 1) { echo dropParam(array('type'));} else { echo replaceParam(array('type' => '1'));}?>" <?php if ($_GET['type'] == 1) {?>class="selected"<?php }?>><i></i><?php echo $lang['goods_class_self_sale']?></a></span></div>
        <div class="nch-sortbar-owner"><span><a href="<?php if ($_GET['gift'] == 1) { echo dropParam(array('gift'));} else { echo replaceParam(array('gift' => '1'));}?>" <?php if ($_GET['gift'] == 1) {?>class="selected"<?php }?>><i></i><?php echo $lang['goods_class_gift_sale']?></a></span></div>
        <div class="nch-sortbar-location"><?php echo $lang['goods_class_goods_area']?>：
