  ...
  <div class="ncg-layout-l">
    <div class="ncg-main <?php echo $output['groupbuy_info']['state_flag'];?>">
      <div class="ncg-group">
        ...
        <div class="ncg-item">
          <div class="pic"><img src="<?php if(C(OSS_IS_STORAGE) == 0){echo gthumb($output['groupbuy_info']['groupbuy_image'],'max');} if(C(OSS_IS_STORAGE) == 1){echo gthumb($output['groupbuy_info']['groupbuy_image'],'530');}?>" alt=""></div>
          <div class="button"><span><?php echo $lang['currency'];?><em><?php echo $output['groupbuy_info']['groupbuy_price'];?></em></span>
		  		  
		  	<?php if ($output['groupbuy_info']['goods_storage']==0) { ?>
			<a class="buy-button">已抢光</a>
			<?php } else {?>
			<a href="<?php echo $output['groupbuy_info']['goods_url'];?>" target="_blank"><?php echo $output['groupbuy_info']['button_text'];?></a>
			<?php }?>

		  </div>
          <div class="info info-1" id="main-nav-holder">
            <div class="prices">
              <dl>
      ...
      <div class="content">
        <div class="ncg-group-command">
          ...
          <dl <?php if($hot_groupbuy_count === 1) { echo "style=' border:none'";$hot_groupbuy_count++; }?> >
            ...
            <dd class="pic-thumb"><a href="<?php echo $hot_groupbuy['groupbuy_url'];?>" target="_blank"><img src="<?php if(C(OSS_IS_STORAGE) ==0){echo gthumb($hot_groupbuy['groupbuy_image1'],'max');} if(C(OSS_IS_STORAGE) ==1){echo gthumb($hot_groupbuy['groupbuy_image1'],'530');}?>"></a></dd>
