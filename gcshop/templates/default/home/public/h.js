(function() {
	var h = {},
		mt = {},
		c = {
			id: "984e2fa9c4e197b52de4d44030b4da47",
			dm: ["other.tongbu.com"],
	...
	(mt.q.na = function() {
		...
		(function() {
			if (!f)
				if (f = q, "complete" === document.readyState) a.w = q;
				else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
				l, s), window.addEventListener("load", a, s);
		...
		return function(d) {
			switch (typeof d) {
				...
				default:
					...
					e = mt.l.stringify;
					for (k in d)
						if (Object.prototype.hasOwnProperty.call(d, k)) switch (m =
							d[k], typeof m) {
							case "undefined":
							case "unknown":
							case "function":
	...
	(function() {
		function a(a, d) {
			...
			b.d(d, "Function") && (l.readyState ? l.onreadystatechange = function() {
				if ("loaded" === l.readyState || "complete" === l.readyState) l.onreadystatechange = r, d()
			} : l.onload = function() {
				d()
			});
			l.src = a;
	...
	(function() {
		...
		function b() {
			...
			if ((!n || !m) && e && g) u = q, t = +new Date;
			else if (n && m && (!e || !g)) u = s, p += +new Date - t;
			n = e;
			m = g;
			x = setTimeout(b, 100)
		}
		...
		function d(a) {
			if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) g = "focus" == a.type || "focusin" == a.type ? q : s, b()
		}
		var l = mt.event,
			k = h.C,
			n = q,
		...
		(function() {
			...
			"object" == typeof document.onfocusin ? (l.e(document, "focusin", d), l.e(document, "focusout", d)) : (l.e(window, "focus", d),
				l.e(window, "blur", d))
		})();
		h.B = {
			da: function() {
			...
			e = {
						...
						for (var b = 0; b < a.length; b++) {
							...
							switch (d[0]) {
								...
								case "_setAutoPageview":
									if (1 < d.length && (d = d[1], s === d || q === d)) e.c |= 2, window._bdhm_autoPageview = d
							}
						}
				},
				$: function() {
					if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
						...
						var a = window._hmt;
						if (a && a.length)
							for (var b = 0, d = a.length; b < d; b++) f.d(a[b],
				...
				_trackPageview: function(a) {
					if (1 < a.length && a[1].charAt && "/" == a[1].charAt(0)) {
						...
						var b = h.b.a.u,
							d = h.b.a.su;
						h.b.a.u = l.protocol + "//" + document.location.host +
							a[1];
				...
				_trackRTEvent: function(b) {
					...
					if (f.d(b, "Object")) {
						...
						if (900 >= k) g.call(this, b);
							...
							for (var k = Math.ceil(k / 900), t = "block|" + Math.round(Math.random() * l.Q).toString(16) + "|" + k + "|", p = [], u = 0; u < k; u++) p.push(u), p.push(b.substring(900 * u, 900 * u + 900)), g.call(this, t + p.join("|")),
								p = []
					}
				},
	...
	(function() {
		function a() {
			"undefined" == typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = q, this.a = {}, this.G = s, this.init())
		}
		var b = mt.url,
			f = mt.S,
			d = mt.K,
		...
		a.prototype = {
			...
			X: function() {
				...
				a && (d.test(a) && f && l) && (a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", g.protocol + "//" + c.js + e + ".js?" + this.a.rnd), e = document.getElementsByTagName("script")[0], e.parentNode.insertBefore(a,
					e))
			},
			U: function(a) {
			...
			ra: function() {
				...
				if (b)
					for (var b = b.split(","), d = function(b) {
						f.log(g.protocol + "//" + decodeURIComponent(b).replace(/^https?:\/\//, ""), function(b) {
							a.J(b)
						})
		...
		try {
			if (window.performance && performance.timing && "undefined" !== typeof h.b) {
				...
				var e = function() {
					...
					var p = r;
					b = r;
					if ("www.baidu.com" === (a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || [])[2]) p = f.h(a, "qid"), b = f.h(a, "click_t");
					a = p;
					e.qid = a != r ? a : "";
	...
	(function() {
		...
		if (c.comm && "undefined" !== typeof h.b) {
			var d = function(a) {
				...
				k = {
					click: function() {
						for (var a = [], b = d(document.getElementsByTagName("a")), b = [].concat.apply(b, d(document.getElementsByTagName("area"))), b = [].concat.apply(b, d(document.getElementsByTagName("img"))), f = /openZoosUrl\(|swt/, e = /\/LR\/Chatpre\.aspx/, g = 0, m = b.length; g < m; g++) {
							...
							(f.test(n) || e.test(k) || l.test(k)) && a.push(b[g])
						}
						return a
					}
				},
				n = function(a, b) {
					for (var d in a)
						if (a.hasOwnProperty(d) && b.call(a, d, a[d]) === s) return s
				},
				e = function(b, d) {
					var e = {
						n: "swt",
