...
<div class="ncp-container">
  <div class="ncp-base-layout">
    ...
    <div class="ncp-banner-right"><?php echo loadadv(1081,'html');?></div>
  </div>
      ...
      <li>
        <div class="ncp-voucher">
          ...
          <div class="point">
			...
			<?php if(!empty($v['voucher_t_sku'])&&$v['voucher_t_points']==0) {echo "|面膜专用";} else if(empty($v['voucher_t_sku'])&&$v['voucher_t_points']==0) {echo "|免费领取";} else {}?></p>
