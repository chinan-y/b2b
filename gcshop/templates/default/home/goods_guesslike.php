...
<div class="goods-guess-like" style="display:none;">
  ...
  <div class="content">
    ...
    <ul id="mycarousel" class="jcarousel-skin-tango">
      ...
      <li>
        <div class="goods-pic"> <a href="<?php echo urlShop('goods','index',array('goods_id'=>$v['goods_id']));?>" target="_blank"><img alt="<?php echo $v['goods_name'];?>" src="<?php echo cthumb($v['goods_image'], 240);?>"></a> </div>
