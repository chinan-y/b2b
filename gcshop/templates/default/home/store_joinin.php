      ...
      <form id="login_form" action="index.php?gct=login" method="post">
        ...
        <dl>
          ...
          <dd>
            ...
            <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?gct=seccode&gp=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['login_index_change_checkcode'];?>">
            <img src="index.php?gct=seccode&gp=makecode&nchash=<?php echo getNchash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
        <dl>
          ...
          <dd>
            ...
            <a href="index.php?gct=login&gp=forget_password" target="_blank"><?php echo $lang['login_index_forget_password'];?></a></dd>
        </dl>
      </form>
      <div class="register">还没有成为我们的合作伙伴？ <a href="index.php?gct=login&gp=register" target="_blank">快速注册</a></div>
    </div>
    <?php } ?>
  </div>
