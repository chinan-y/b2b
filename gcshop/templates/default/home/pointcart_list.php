...
<div class="wrapper pr">
  ...
  <div class="ncc-main">
    ...
    <div class="ncc-bottom"> <a href="index.php?gct=pointcart&gp=step1" class="ncc-btn ncc-btn-acidblue fr"><?php echo $lang['pointcart_cart_submit']; ?></a> </div>
  </div>
  <?php } else { ?>
  <div class="ncc-null-shopping"><i class="ico-gift"></i>
    <h4><?php echo $lang['pointcart_cart_null'];?></h4>
    <p><a href="index.php?gct=pointprod" class="ncc-btn-mini mr10"><i class="icon-reply-all"></i><?php echo $lang['pointcart_cart_exchangenow'];?></a> <a href="index.php?gct=member_pointorder" class="ncc-btn-mini"><i class="icon-file-text"></i><?php echo $lang['pointcart_cart_exchanged_list'];?></a></p>
  </div>
  <?php } ?>
</div>
