...
<div class="nch-container wrapper">
  <div class="nch-all-menu">
    <ul class="tab-bar">
	  ...
	  <li class="current"><a href="javascript:void(0);"><?php echo $lang['all_store']?></a></li>
    </ul>
  </div>
<div class="nc-store-class" style="display:none">
  <?php if(!empty($output['class_list']) && is_array($output['class_list'])){?>
  <dl>
    <dt><?php echo $lang['store_classname']?><?php echo $lang['nc_colon'];?></dt>
    <dd>
      <a href="<?php echo urlShop('store_list','index');?>"><?php echo $lang['all']?></a>
...
<?php foreach($output['store_list'] as $skey => $store){?>
    <li class="item">
      <dl class="gcshop-info">
		<?php if($store['store_id']==8){ ?>
		<dt class="gcshop-name"><a href="index.php?gct=goods_b2b&gp=goods_b2b" target="_blank"><?php echo $store['store_name'];?></a></dt>
        <dd class="gcshop-pic"><a href="index.php?gct=goods_b2b&gp=goods_b2b" title="" target="_blank"><span class="size72"><img src="<?php echo getStoreLogo($store['store_avatar']);?>"  alt="<?php echo $store['store_name'];?>" title="<?php echo $store['store_name'];?>" class="size72" /></span></a></dd>
		<?php }else{ ?>
        <dt class="gcshop-name"><a href="<?php echo urlShop('show_store','', array('store_id'=>$store['store_id']),$store['store_domain']);?>" target="_blank"><?php echo $store['store_name'];?></a></dt>
        <dd class="gcshop-pic"><a href="<?php echo urlShop('show_store','', array('store_id'=>$store['store_id']),$store['store_domain']);?>" title="" target="_blank"><span class="size72"><img src="<?php echo getStoreLogo($store['store_avatar']);?>"  alt="<?php echo $store['store_name'];?>" title="<?php echo $store['store_name'];?>" class="size72" /></span></a></dd>
        <?php } ?>
        ...
        <dd class="shopkeeper" style="display:none;"><?php echo $lang['store_class_index_owner'].$lang['nc_colon'];?><?php echo $store['member_name'];?><a target="_blank" class="message" href="index.php?gct=member_message&gp=sendmsg&member_id=<?php echo $store['member_id'];?>"></a><span>
      ...
      <dl class="w200">
        ...
        <dd style="display:none;"><?php echo ($tmp = $store['num_sales_jq']) ? $lang['store_class_index_deal'].$tmp.$lang['store_class_index_jian'] : $lang['nc_common_sell_null'];?></dd>
      ...
      <dl class="w150">
        ...
        <!-- 店铺动态评分 -->
        <dd class="gcshop-rate" nc_type="gcshop-rate" store_id='<?php echo $store['store_id'];?>'><?php echo $lang['store_class_index_shop_rate'].$lang['nc_colon'];?><span><i></i></span>
          <div class="gcshop-rate-con">
              <div class="arrow"></div>
              <dl class="rate">
      ...
      <div class="nc-gcshop-goodslist" nc_type='goods_<?php echo $skey;?>'>
        <div class="arrow"></div>
        ...
        <li>
            <dl>
              <?php if($v['store_id']!=8){?>
              <dt class="goods-pic"><span class="thumb size160"> <i></i> <a href="index.php?gct=goods&goods_id=<?php echo $v['goods_id'];?>" target="_blank"> <img  onload="javascript:DrawImage(this,160,160);" alt="<?php echo $v['goods_name'];?>" src="<?php echo thumb($v,'small');?>"></a></span></dt>
              ...
              <dd class="goods-sales" style="display:none;"><?php echo $lang['store_class_index_deal'];?><?php echo $v['goods_salenum'];?><?php echo $lang['store_class_index_jian'];?></dd>
			  <?php }else{ ?>
				  <dt class="goods-pic"><span class="thumb size160"> <i></i> <a href="index.php?gct=goodsdetail&gp=goodsdetail&goods_id=<?php echo $v['goods_id'];?>" target="_blank"> <img  onload="javascript:DrawImage(this,160,160);" alt="<?php echo $v['goods_name'];?>" src="<?php echo thumb($v,'small');?>"></a></span></dt>
				  <dd class="goods-name"><a href="index.php?gct=goodsdetail&gp=goodsdetail&goods_id=<?php echo $v['goods_id'];?>"  title="<?php echo $v['goods_name'];?>" target="_blank"><?php echo $v['goods_name'];?></a></dd>
                  <dd class="goods-sales" style="display:none;"><?php echo $lang['store_class_index_deal'];?><?php echo $v['goods_salenum'];?><?php echo $lang['store_class_index_jian'];?></dd>			  
			  <?php } ?>
            </dl>
          </li>
