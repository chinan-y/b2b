...
class member_pointsControl extends BaseMemberControl {
	...
	private function profile_menu($menu_key='',$array=array()) {
		...
		$menu_array		= array();
		$menu_array = array(
			1=>array('menu_key'=>'points',	'menu_name'=>$lang['nc_member_path_points'],	'menu_url'=>'index.php?gct=member_points'),
			//2=>array('menu_key'=>'orderlist','menu_name'=>Language::get('member_pointorder_list_title'),	'menu_url'=>'javascript:void(0);')
