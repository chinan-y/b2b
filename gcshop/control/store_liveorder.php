...
class store_liveorderControl extends BaseSellerControl {
	...
	private function profile_menu($menu_key) {
		$menu_array	= array(
				1=>array('menu_key'=>'store_liveorder','menu_name'=>'线下抢订单','menu_url'=>'index.php?gct=store_liveorder&gp=store_liveorder'),
				2=>array('menu_key'=>'store_liveverifylog','menu_name'=>'操作日志','menu_url'=>'index.php?gct=store_liveorder&gp=store_liveverifylog'),
		);
