...
class brandControl extends BaseHomeControl {
	...
	public function listOp(){
		...
		$seo_param = array();
		$seo_param['title'] = $brand_info['brand_name'].'-光彩全球网';
		$seo_param['keywords'] 	= $brand_info['brand_name'].','. $brand_info['brand_name'].'促销,'.$brand_info['brand_name'].'网购,'.$brand_info['brand_name'].'价格';
		$seo_param['description'] 	= '光彩全球“我的网购，我的生活”网上购物商城。您可以在齐全的'.$brand_info['brand_name'].'---'.$brand_info['brand_name'].'品牌专区选购。也可了解'.$brand_info['brand_name'].'产品的最新价格、优惠促销、网友评论导购、图片等相关信息。';
		
		Model('seo')->type('brand_list')->param($seo_param)->show();
