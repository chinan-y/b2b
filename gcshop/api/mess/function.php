...
function create_sku($SKU, $GOODS_SPEC, $GOODS_PRICE, $GOODS_NUM, $GOODS_AMOUNT, $GOODS_TAX, $region_info=array(),$mess_country_code,$QTY2,$UNIT2)
{
	$mess_country_code = $mess_country_code ? $mess_country_code : '701';	//国家地名不详701
	$detail = "<ORDER_DETAIL>\n";
	$detail .= "<SKU>".$SKU."</SKU>\n";
	$detail .= "<GOODS_SPEC>".$GOODS_SPEC."</GOODS_SPEC>\n";
	$detail .= "<CURRENCY_CODE>142</CURRENCY_CODE>\n";
	$detail .= "<PRICE>".$GOODS_PRICE."</PRICE>\n";
	$detail .= "<QTY>".$GOODS_NUM."</QTY>\n";
	$detail .= "<GOODS_FEE>".$GOODS_AMOUNT."</GOODS_FEE>\n";
	$detail .= "<TAX_FEE>".$GOODS_TAX."</TAX_FEE>\n";
	$detail .= "<COUNTRY>".$mess_country_code."</COUNTRY>\n";
	$detail .= "<QTY2>".$QTY2."</QTY2>\n";
	$detail .= "<UNIT2>".$UNIT2."</UNIT2>\n";
	$detail .= "</ORDER_DETAIL>\n";
	
	return $detail;
}

function create_order($gcqq_code, $ORDER_SN, $RECEIVER_ID_NO, $RECEIVER_NAME, $RECEIVER_ADDRESS, $RECEIVER_TEL, $GOODS_FEE, $TAX_FEE, $region_info=array())
{
	...
	$item .= "<CUSTOMS_CODE>{$region_info['customs_id']}</CUSTOMS_CODE>\n";
    $item .= "<SORTLINE_ID>{$region_info['sortline_id']}</SORTLINE_ID>\n";
    $item .= "<BIZ_TYPE_CODE>I20</BIZ_TYPE_CODE>\n";
    $item .= "<ORIGINAL_ORDER_NO>".$ORDER_SN."</ORIGINAL_ORDER_NO>\n";
	$item .= "<ESHOP_ENT_CODE>".$gcqq_code."</ESHOP_ENT_CODE>\n";
	$item .= "<ESHOP_ENT_NAME>光彩国际重庆电子商务有限公司</ESHOP_ENT_NAME>\n";
	$item .= "<DESP_ARRI_COUNTRY_CODE/>\n";
	$item .= "<SHIP_TOOL_CODE>8</SHIP_TOOL_CODE>\n";
	$item .= "<RECEIVER_ID_NO>".$RECEIVER_ID_NO."</RECEIVER_ID_NO>\n";
	$item .= "<RECEIVER_NAME>".$RECEIVER_NAME."</RECEIVER_NAME>\n";
	$item .= "<RECEIVER_ADDRESS>".$RECEIVER_ADDRESS."</RECEIVER_ADDRESS>\n";
	$item .= "<RECEIVER_TEL>".$RECEIVER_TEL."</RECEIVER_TEL>\n";
	$item .= "<GOODS_FEE>".$GOODS_FEE."</GOODS_FEE>\n";
	$item .= "<TAX_FEE>".$TAX_FEE."</TAX_FEE>\n";
	$item .= "<GROSS_WEIGHT/>\n";
	$item .= "<PROXY_ENT_CODE/>\n";
	$item .= "<PROXY_ENT_NAME/>\n";
...
function create_payment($gcqq_code, $PAY_SN, $ORDER_SN, $ORDER_AMOUNT, $GOODS_FEE, $TAX_FEE, $region_info=array())
{
    $region_info['customs_id'] = isset($region_info['customs_id']) ? $region_info['customs_id'] : '8012';
    $region_info['sortline_id'] = isset($region_info['sortline_id']) ? $region_info['sortline_id'] : 'SORTLINE01';

	$payment .= "<CUSTOMS_CODE>{$region_info['customs_id']}</CUSTOMS_CODE>\n";
	$payment .= "<SORTLINE_ID>{$region_info['sortline_id']}</SORTLINE_ID>\n";
	$payment .= "<BIZ_TYPE_CODE>I20</BIZ_TYPE_CODE>\n";
	$payment .= "<ESHOP_ENT_CODE>".$gcqq_code."</ESHOP_ENT_CODE>\n";
	$payment .= "<ESHOP_ENT_NAME>光彩国际重庆电子商务有限公司</ESHOP_ENT_NAME>\n";
	$payment .= "<PAYMENT_ENT_CODE>".$gcqq_code."</PAYMENT_ENT_CODE>\n";
	$payment .= "<PAYMENT_ENT_NAME>光彩国际重庆电子商务有限公司</PAYMENT_ENT_NAME>\n";
	$payment .= "<PAYMENT_NO>".$PAY_SN."</PAYMENT_NO>\n";
	$payment .= "<ORIGINAL_ORDER_NO>".$ORDER_SN."</ORIGINAL_ORDER_NO>\n";
	$payment .= "<PAY_AMOUNT>".$ORDER_AMOUNT."</PAY_AMOUNT>\n";
	$payment .= "<GOODS_FEE>".$GOODS_FEE."</GOODS_FEE>\n";
	$payment .= "<TAX_FEE>".$TAX_FEE."</TAX_FEE>\n";
	$payment .= "<CURRENCY_CODE>142</CURRENCY_CODE>\n";
	$payment .= "<MEMO />\n";
